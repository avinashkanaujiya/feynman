const Ym=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}};Ym();function Pc(t,e){const n=Object.create(null),s=t.split(",");for(let r=0;r<s.length;r++)n[s[r]]=!0;return e?r=>!!n[r.toLowerCase()]:r=>!!n[r]}const Jm="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zm=Pc(Jm);function Sf(t){return!!t||t===""}function _s(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],r=Ve(s)?ny(s):_s(s);if(r)for(const i in r)e[i]=r[i]}return e}else{if(Ve(t))return t;if(Me(t))return t}}const ey=/;(?![^(]*\))/g,ty=/:(.+)/;function ny(t){const e={};return t.split(ey).forEach(n=>{if(n){const s=n.split(ty);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Mc(t){let e="";if(Ve(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const s=Mc(t[n]);s&&(e+=s+" ")}else if(Me(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Tt=t=>Ve(t)?t:t==null?"":W(t)||Me(t)&&(t.toString===Rf||!Y(t.toString))?JSON.stringify(t,Cf,2):String(t),Cf=(t,e)=>e&&e.__v_isRef?Cf(t,e.value):Es(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,r])=>(n[`${s} =>`]=r,n),{})}:Af(e)?{[`Set(${e.size})`]:[...e.values()]}:Me(e)&&!W(e)&&!Nf(e)?String(e):e,me={},ws=[],At=()=>{},sy=()=>!1,ry=/^on[^a-z]/,Io=t=>ry.test(t),Lc=t=>t.startsWith("onUpdate:"),et=Object.assign,Uc=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},iy=Object.prototype.hasOwnProperty,re=(t,e)=>iy.call(t,e),W=Array.isArray,Es=t=>bo(t)==="[object Map]",Af=t=>bo(t)==="[object Set]",Y=t=>typeof t=="function",Ve=t=>typeof t=="string",Fc=t=>typeof t=="symbol",Me=t=>t!==null&&typeof t=="object",kf=t=>Me(t)&&Y(t.then)&&Y(t.catch),Rf=Object.prototype.toString,bo=t=>Rf.call(t),oy=t=>bo(t).slice(8,-1),Nf=t=>bo(t)==="[object Object]",Vc=t=>Ve(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,xi=Pc(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),To=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},ay=/-(\w)/g,Vt=To(t=>t.replace(ay,(e,n)=>n?n.toUpperCase():"")),cy=/\B([A-Z])/g,Hs=To(t=>t.replace(cy,"-$1").toLowerCase()),So=To(t=>t.charAt(0).toUpperCase()+t.slice(1)),ha=To(t=>t?`on${So(t)}`:""),Tr=(t,e)=>!Object.is(t,e),Pi=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Ki=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Fa=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let yl;const uy=()=>yl||(yl=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let Pt;class ly{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&Pt&&(this.parent=Pt,this.index=(Pt.scopes||(Pt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=Pt;try{return Pt=this,e()}finally{Pt=n}}}on(){Pt=this}off(){Pt=this.parent}stop(e){if(this.active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.active=!1}}}function hy(t,e=Pt){e&&e.active&&e.effects.push(t)}const $c=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Df=t=>(t.w&In)>0,Of=t=>(t.n&In)>0,fy=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=In},dy=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const r=e[s];Df(r)&&!Of(r)?r.delete(t):e[n++]=r,r.w&=~In,r.n&=~In}e.length=n}},Va=new WeakMap;let or=0,In=1;const $a=30;let St;const $n=Symbol(""),Ba=Symbol("");class Bc{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,hy(this,s)}run(){if(!this.active)return this.fn();let e=St,n=mn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=St,St=this,mn=!0,In=1<<++or,or<=$a?fy(this):vl(this),this.fn()}finally{or<=$a&&dy(this),In=1<<--or,St=this.parent,mn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){St===this?this.deferStop=!0:this.active&&(vl(this),this.onStop&&this.onStop(),this.active=!1)}}function vl(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let mn=!0;const xf=[];function qs(){xf.push(mn),mn=!1}function Ks(){const t=xf.pop();mn=t===void 0?!0:t}function dt(t,e,n){if(mn&&St){let s=Va.get(t);s||Va.set(t,s=new Map);let r=s.get(n);r||s.set(n,r=$c()),Pf(r)}}function Pf(t,e){let n=!1;or<=$a?Of(t)||(t.n|=In,n=!Df(t)):n=!t.has(St),n&&(t.add(St),St.deps.push(t))}function Xt(t,e,n,s,r,i){const o=Va.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t))o.forEach((c,u)=>{(u==="length"||u>=s)&&a.push(c)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?Vc(n)&&a.push(o.get("length")):(a.push(o.get($n)),Es(t)&&a.push(o.get(Ba)));break;case"delete":W(t)||(a.push(o.get($n)),Es(t)&&a.push(o.get(Ba)));break;case"set":Es(t)&&a.push(o.get($n));break}if(a.length===1)a[0]&&ja(a[0]);else{const c=[];for(const u of a)u&&c.push(...u);ja($c(c))}}function ja(t,e){const n=W(t)?t:[...t];for(const s of n)s.computed&&_l(s);for(const s of n)s.computed||_l(s)}function _l(t,e){(t!==St||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const py=Pc("__proto__,__v_isRef,__isVue"),Mf=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Fc)),gy=jc(),my=jc(!1,!0),yy=jc(!0),wl=vy();function vy(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=ae(this);for(let i=0,o=this.length;i<o;i++)dt(s,"get",i+"");const r=s[e](...n);return r===-1||r===!1?s[e](...n.map(ae)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){qs();const s=ae(this)[e].apply(this,n);return Ks(),s}}),t}function jc(t=!1,e=!1){return function(s,r,i){if(r==="__v_isReactive")return!t;if(r==="__v_isReadonly")return t;if(r==="__v_isShallow")return e;if(r==="__v_raw"&&i===(t?e?Py:$f:e?Vf:Ff).get(s))return s;const o=W(s);if(!t&&o&&re(wl,r))return Reflect.get(wl,r,i);const a=Reflect.get(s,r,i);return(Fc(r)?Mf.has(r):py(r))||(t||dt(s,"get",r),e)?a:Je(a)?o&&Vc(r)?a:a.value:Me(a)?t?Bf(a):zs(a):a}}const _y=Lf(),wy=Lf(!0);function Lf(t=!1){return function(n,s,r,i){let o=n[s];if(Sr(o)&&Je(o)&&!Je(r))return!1;if(!t&&!Sr(r)&&(Ha(r)||(r=ae(r),o=ae(o)),!W(n)&&Je(o)&&!Je(r)))return o.value=r,!0;const a=W(n)&&Vc(s)?Number(s)<n.length:re(n,s),c=Reflect.set(n,s,r,i);return n===ae(i)&&(a?Tr(r,o)&&Xt(n,"set",s,r):Xt(n,"add",s,r)),c}}function Ey(t,e){const n=re(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&Xt(t,"delete",e,void 0),s}function Iy(t,e){const n=Reflect.has(t,e);return(!Fc(e)||!Mf.has(e))&&dt(t,"has",e),n}function by(t){return dt(t,"iterate",W(t)?"length":$n),Reflect.ownKeys(t)}const Uf={get:gy,set:_y,deleteProperty:Ey,has:Iy,ownKeys:by},Ty={get:yy,set(t,e){return!0},deleteProperty(t,e){return!0}},Sy=et({},Uf,{get:my,set:wy}),Hc=t=>t,Co=t=>Reflect.getPrototypeOf(t);function Ei(t,e,n=!1,s=!1){t=t.__v_raw;const r=ae(t),i=ae(e);n||(e!==i&&dt(r,"get",e),dt(r,"get",i));const{has:o}=Co(r),a=s?Hc:n?zc:Cr;if(o.call(r,e))return a(t.get(e));if(o.call(r,i))return a(t.get(i));t!==r&&t.get(e)}function Ii(t,e=!1){const n=this.__v_raw,s=ae(n),r=ae(t);return e||(t!==r&&dt(s,"has",t),dt(s,"has",r)),t===r?n.has(t):n.has(t)||n.has(r)}function bi(t,e=!1){return t=t.__v_raw,!e&&dt(ae(t),"iterate",$n),Reflect.get(t,"size",t)}function El(t){t=ae(t);const e=ae(this);return Co(e).has.call(e,t)||(e.add(t),Xt(e,"add",t,t)),this}function Il(t,e){e=ae(e);const n=ae(this),{has:s,get:r}=Co(n);let i=s.call(n,t);i||(t=ae(t),i=s.call(n,t));const o=r.call(n,t);return n.set(t,e),i?Tr(e,o)&&Xt(n,"set",t,e):Xt(n,"add",t,e),this}function bl(t){const e=ae(this),{has:n,get:s}=Co(e);let r=n.call(e,t);r||(t=ae(t),r=n.call(e,t)),s&&s.call(e,t);const i=e.delete(t);return r&&Xt(e,"delete",t,void 0),i}function Tl(){const t=ae(this),e=t.size!==0,n=t.clear();return e&&Xt(t,"clear",void 0,void 0),n}function Ti(t,e){return function(s,r){const i=this,o=i.__v_raw,a=ae(o),c=e?Hc:t?zc:Cr;return!t&&dt(a,"iterate",$n),o.forEach((u,l)=>s.call(r,c(u),c(l),i))}}function Si(t,e,n){return function(...s){const r=this.__v_raw,i=ae(r),o=Es(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,u=r[t](...s),l=n?Hc:e?zc:Cr;return!e&&dt(i,"iterate",c?Ba:$n),{next(){const{value:h,done:f}=u.next();return f?{value:h,done:f}:{value:a?[l(h[0]),l(h[1])]:l(h),done:f}},[Symbol.iterator](){return this}}}}function rn(t){return function(...e){return t==="delete"?!1:this}}function Cy(){const t={get(i){return Ei(this,i)},get size(){return bi(this)},has:Ii,add:El,set:Il,delete:bl,clear:Tl,forEach:Ti(!1,!1)},e={get(i){return Ei(this,i,!1,!0)},get size(){return bi(this)},has:Ii,add:El,set:Il,delete:bl,clear:Tl,forEach:Ti(!1,!0)},n={get(i){return Ei(this,i,!0)},get size(){return bi(this,!0)},has(i){return Ii.call(this,i,!0)},add:rn("add"),set:rn("set"),delete:rn("delete"),clear:rn("clear"),forEach:Ti(!0,!1)},s={get(i){return Ei(this,i,!0,!0)},get size(){return bi(this,!0)},has(i){return Ii.call(this,i,!0)},add:rn("add"),set:rn("set"),delete:rn("delete"),clear:rn("clear"),forEach:Ti(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Si(i,!1,!1),n[i]=Si(i,!0,!1),e[i]=Si(i,!1,!0),s[i]=Si(i,!0,!0)}),[t,n,e,s]}const[Ay,ky,Ry,Ny]=Cy();function qc(t,e){const n=e?t?Ny:Ry:t?ky:Ay;return(s,r,i)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?s:Reflect.get(re(n,r)&&r in s?n:s,r,i)}const Dy={get:qc(!1,!1)},Oy={get:qc(!1,!0)},xy={get:qc(!0,!1)},Ff=new WeakMap,Vf=new WeakMap,$f=new WeakMap,Py=new WeakMap;function My(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ly(t){return t.__v_skip||!Object.isExtensible(t)?0:My(oy(t))}function zs(t){return Sr(t)?t:Kc(t,!1,Uf,Dy,Ff)}function Uy(t){return Kc(t,!1,Sy,Oy,Vf)}function Bf(t){return Kc(t,!0,Ty,xy,$f)}function Kc(t,e,n,s,r){if(!Me(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=r.get(t);if(i)return i;const o=Ly(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return r.set(t,a),a}function Is(t){return Sr(t)?Is(t.__v_raw):!!(t&&t.__v_isReactive)}function Sr(t){return!!(t&&t.__v_isReadonly)}function Ha(t){return!!(t&&t.__v_isShallow)}function jf(t){return Is(t)||Sr(t)}function ae(t){const e=t&&t.__v_raw;return e?ae(e):t}function Hf(t){return Ki(t,"__v_skip",!0),t}const Cr=t=>Me(t)?zs(t):t,zc=t=>Me(t)?Bf(t):t;function qf(t){mn&&St&&(t=ae(t),Pf(t.dep||(t.dep=$c())))}function Kf(t,e){t=ae(t),t.dep&&ja(t.dep)}function Je(t){return!!(t&&t.__v_isRef===!0)}function Fy(t){return zf(t,!1)}function Vy(t){return zf(t,!0)}function zf(t,e){return Je(t)?t:new $y(t,e)}class $y{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ae(e),this._value=n?e:Cr(e)}get value(){return qf(this),this._value}set value(e){e=this.__v_isShallow?e:ae(e),Tr(e,this._rawValue)&&(this._rawValue=e,this._value=this.__v_isShallow?e:Cr(e),Kf(this))}}function Bn(t){return Je(t)?t.value:t}const By={get:(t,e,n)=>Bn(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const r=t[e];return Je(r)&&!Je(n)?(r.value=n,!0):Reflect.set(t,e,n,s)}};function Wf(t){return Is(t)?t:new Proxy(t,By)}class jy{constructor(e,n,s,r){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this._dirty=!0,this.effect=new Bc(e,()=>{this._dirty||(this._dirty=!0,Kf(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!r,this.__v_isReadonly=s}get value(){const e=ae(this);return qf(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Hy(t,e,n=!1){let s,r;const i=Y(t);return i?(s=t,r=At):(s=t.get,r=t.set),new jy(s,r,i||!r,n)}function yn(t,e,n,s){let r;try{r=s?t(...s):t()}catch(i){Ao(i,e,n)}return r}function wt(t,e,n,s){if(Y(t)){const i=yn(t,e,n,s);return i&&kf(i)&&i.catch(o=>{Ao(o,e,n)}),i}const r=[];for(let i=0;i<t.length;i++)r.push(wt(t[i],e,n,s));return r}function Ao(t,e,n,s=!0){const r=e?e.vnode:null;if(e){let i=e.parent;const o=e.proxy,a=n;for(;i;){const u=i.ec;if(u){for(let l=0;l<u.length;l++)if(u[l](t,o,a)===!1)return}i=i.parent}const c=e.appContext.config.errorHandler;if(c){yn(c,null,10,[t,o,a]);return}}qy(t,n,r,s)}function qy(t,e,n,s=!0){console.error(t)}let zi=!1,qa=!1;const ft=[];let Ht=0;const fr=[];let ar=null,fs=0;const dr=[];let un=null,ds=0;const Gf=Promise.resolve();let Wc=null,Ka=null;function Qf(t){const e=Wc||Gf;return t?e.then(this?t.bind(this):t):e}function Ky(t){let e=Ht+1,n=ft.length;for(;e<n;){const s=e+n>>>1;Ar(ft[s])<t?e=s+1:n=s}return e}function Xf(t){(!ft.length||!ft.includes(t,zi&&t.allowRecurse?Ht+1:Ht))&&t!==Ka&&(t.id==null?ft.push(t):ft.splice(Ky(t.id),0,t),Yf())}function Yf(){!zi&&!qa&&(qa=!0,Wc=Gf.then(ed))}function zy(t){const e=ft.indexOf(t);e>Ht&&ft.splice(e,1)}function Jf(t,e,n,s){W(t)?n.push(...t):(!e||!e.includes(t,t.allowRecurse?s+1:s))&&n.push(t),Yf()}function Wy(t){Jf(t,ar,fr,fs)}function Gy(t){Jf(t,un,dr,ds)}function ko(t,e=null){if(fr.length){for(Ka=e,ar=[...new Set(fr)],fr.length=0,fs=0;fs<ar.length;fs++)ar[fs]();ar=null,fs=0,Ka=null,ko(t,e)}}function Zf(t){if(ko(),dr.length){const e=[...new Set(dr)];if(dr.length=0,un){un.push(...e);return}for(un=e,un.sort((n,s)=>Ar(n)-Ar(s)),ds=0;ds<un.length;ds++)un[ds]();un=null,ds=0}}const Ar=t=>t.id==null?1/0:t.id;function ed(t){qa=!1,zi=!0,ko(t),ft.sort((n,s)=>Ar(n)-Ar(s));const e=At;try{for(Ht=0;Ht<ft.length;Ht++){const n=ft[Ht];n&&n.active!==!1&&yn(n,null,14)}}finally{Ht=0,ft.length=0,Zf(),zi=!1,Wc=null,(ft.length||fr.length||dr.length)&&ed(t)}}function Qy(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||me;let r=n;const i=e.startsWith("update:"),o=i&&e.slice(7);if(o&&o in s){const l=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:f}=s[l]||me;f&&(r=n.map(g=>g.trim())),h&&(r=n.map(Fa))}let a,c=s[a=ha(e)]||s[a=ha(Vt(e))];!c&&i&&(c=s[a=ha(Hs(e))]),c&&wt(c,t,6,r);const u=s[a+"Once"];if(u){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,wt(u,t,6,r)}}function td(t,e,n=!1){const s=e.emitsCache,r=s.get(t);if(r!==void 0)return r;const i=t.emits;let o={},a=!1;if(!Y(t)){const c=u=>{const l=td(u,e,!0);l&&(a=!0,et(o,l))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!i&&!a?(s.set(t,null),null):(W(i)?i.forEach(c=>o[c]=null):et(o,i),s.set(t,o),o)}function Ro(t,e){return!t||!Io(e)?!1:(e=e.slice(2).replace(/Once$/,""),re(t,e[0].toLowerCase()+e.slice(1))||re(t,Hs(e))||re(t,e))}let _t=null,No=null;function Wi(t){const e=_t;return _t=t,No=t&&t.type.__scopeId||null,e}function nd(t){No=t}function sd(){No=null}function Gc(t,e=_t,n){if(!e||t._n)return t;const s=(...r)=>{s._d&&Ml(-1);const i=Wi(e),o=t(...r);return Wi(i),s._d&&Ml(1),o};return s._n=!0,s._c=!0,s._d=!0,s}function fa(t){const{type:e,vnode:n,proxy:s,withProxy:r,props:i,propsOptions:[o],slots:a,attrs:c,emit:u,render:l,renderCache:h,data:f,setupState:g,ctx:y,inheritAttrs:S}=t;let I,A;const x=Wi(t);try{if(n.shapeFlag&4){const X=r||s;I=Mt(l.call(X,X,h,i,g,f,y)),A=c}else{const X=e;I=Mt(X.length>1?X(i,{attrs:c,slots:a,emit:u}):X(i,null)),A=e.props?c:Xy(c)}}catch(X){pr.length=0,Ao(X,t,1),I=be(Wt)}let K=I;if(A&&S!==!1){const X=Object.keys(A),{shapeFlag:le}=K;X.length&&le&7&&(o&&X.some(Lc)&&(A=Yy(A,o)),K=bn(K,A))}return n.dirs&&(K=bn(K),K.dirs=K.dirs?K.dirs.concat(n.dirs):n.dirs),n.transition&&(K.transition=n.transition),I=K,Wi(x),I}const Xy=t=>{let e;for(const n in t)(n==="class"||n==="style"||Io(n))&&((e||(e={}))[n]=t[n]);return e},Yy=(t,e)=>{const n={};for(const s in t)(!Lc(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function Jy(t,e,n){const{props:s,children:r,component:i}=t,{props:o,children:a,patchFlag:c}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return s?Sl(s,o,u):!!o;if(c&8){const l=e.dynamicProps;for(let h=0;h<l.length;h++){const f=l[h];if(o[f]!==s[f]&&!Ro(u,f))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Sl(s,o,u):!0:!!o;return!1}function Sl(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(e[i]!==t[i]&&!Ro(n,i))return!0}return!1}function Zy({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const ev=t=>t.__isSuspense;function tv(t,e){e&&e.pendingBranch?W(t)?e.effects.push(...t):e.effects.push(t):Gy(t)}function Mi(t,e){if(Fe){let n=Fe.provides;const s=Fe.parent&&Fe.parent.provides;s===n&&(n=Fe.provides=Object.create(s)),n[t]=e}}function vn(t,e,n=!1){const s=Fe||_t;if(s){const r=s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides;if(r&&t in r)return r[t];if(arguments.length>1)return n&&Y(e)?e.call(s.proxy):e}}const Cl={};function bs(t,e,n){return rd(t,e,n)}function rd(t,e,{immediate:n,deep:s,flush:r,onTrack:i,onTrigger:o}=me){const a=Fe;let c,u=!1,l=!1;if(Je(t)?(c=()=>t.value,u=Ha(t)):Is(t)?(c=()=>t,s=!0):W(t)?(l=!0,u=t.some(A=>Is(A)||Ha(A)),c=()=>t.map(A=>{if(Je(A))return A.value;if(Is(A))return Ln(A);if(Y(A))return yn(A,a,2)})):Y(t)?e?c=()=>yn(t,a,2):c=()=>{if(!(a&&a.isUnmounted))return h&&h(),wt(t,a,3,[f])}:c=At,e&&s){const A=c;c=()=>Ln(A())}let h,f=A=>{h=I.onStop=()=>{yn(A,a,4)}};if(Nr)return f=At,e?n&&wt(e,a,3,[c(),l?[]:void 0,f]):c(),At;let g=l?[]:Cl;const y=()=>{if(!!I.active)if(e){const A=I.run();(s||u||(l?A.some((x,K)=>Tr(x,g[K])):Tr(A,g)))&&(h&&h(),wt(e,a,3,[A,g===Cl?void 0:g,f]),g=A)}else I.run()};y.allowRecurse=!!e;let S;r==="sync"?S=y:r==="post"?S=()=>it(y,a&&a.suspense):S=()=>Wy(y);const I=new Bc(c,S);return e?n?y():g=I.run():r==="post"?it(I.run.bind(I),a&&a.suspense):I.run(),()=>{I.stop(),a&&a.scope&&Uc(a.scope.effects,I)}}function nv(t,e,n){const s=this.proxy,r=Ve(t)?t.includes(".")?id(s,t):()=>s[t]:t.bind(s,s);let i;Y(e)?i=e:(i=e.handler,n=e);const o=Fe;Rs(this);const a=rd(r,i.bind(s),n);return o?Rs(o):jn(),a}function id(t,e){const n=e.split(".");return()=>{let s=t;for(let r=0;r<n.length&&s;r++)s=s[n[r]];return s}}function Ln(t,e){if(!Me(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Je(t))Ln(t.value,e);else if(W(t))for(let n=0;n<t.length;n++)Ln(t[n],e);else if(Af(t)||Es(t))t.forEach(n=>{Ln(n,e)});else if(Nf(t))for(const n in t)Ln(t[n],e);return t}function sv(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ld(()=>{t.isMounted=!0}),hd(()=>{t.isUnmounting=!0}),t}const mt=[Function,Array],rv={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:mt,onEnter:mt,onAfterEnter:mt,onEnterCancelled:mt,onBeforeLeave:mt,onLeave:mt,onAfterLeave:mt,onLeaveCancelled:mt,onBeforeAppear:mt,onAppear:mt,onAfterAppear:mt,onAppearCancelled:mt},setup(t,{slots:e}){const n=Hv(),s=sv();let r;return()=>{const i=e.default&&ad(e.default(),!0);if(!i||!i.length)return;let o=i[0];if(i.length>1){for(const S of i)if(S.type!==Wt){o=S;break}}const a=ae(t),{mode:c}=a;if(s.isLeaving)return da(o);const u=Al(o);if(!u)return da(o);const l=za(u,a,s,n);Wa(u,l);const h=n.subTree,f=h&&Al(h);let g=!1;const{getTransitionKey:y}=u.type;if(y){const S=y();r===void 0?r=S:S!==r&&(r=S,g=!0)}if(f&&f.type!==Wt&&(!Pn(u,f)||g)){const S=za(f,a,s,n);if(Wa(f,S),c==="out-in")return s.isLeaving=!0,S.afterLeave=()=>{s.isLeaving=!1,n.update()},da(o);c==="in-out"&&u.type!==Wt&&(S.delayLeave=(I,A,x)=>{const K=od(s,f);K[String(f.key)]=f,I._leaveCb=()=>{A(),I._leaveCb=void 0,delete l.delayedLeave},l.delayedLeave=x})}return o}}},iv=rv;function od(t,e){const{leavingVNodes:n}=t;let s=n.get(e.type);return s||(s=Object.create(null),n.set(e.type,s)),s}function za(t,e,n,s){const{appear:r,mode:i,persisted:o=!1,onBeforeEnter:a,onEnter:c,onAfterEnter:u,onEnterCancelled:l,onBeforeLeave:h,onLeave:f,onAfterLeave:g,onLeaveCancelled:y,onBeforeAppear:S,onAppear:I,onAfterAppear:A,onAppearCancelled:x}=e,K=String(t.key),X=od(n,t),le=(ee,ue)=>{ee&&wt(ee,s,9,ue)},Te=(ee,ue)=>{const we=ue[1];le(ee,ue),W(ee)?ee.every(je=>je.length<=1)&&we():ee.length<=1&&we()},De={mode:i,persisted:o,beforeEnter(ee){let ue=a;if(!n.isMounted)if(r)ue=S||a;else return;ee._leaveCb&&ee._leaveCb(!0);const we=X[K];we&&Pn(t,we)&&we.el._leaveCb&&we.el._leaveCb(),le(ue,[ee])},enter(ee){let ue=c,we=u,je=l;if(!n.isMounted)if(r)ue=I||c,we=A||u,je=x||l;else return;let He=!1;const It=ee._enterCb=sn=>{He||(He=!0,sn?le(je,[ee]):le(we,[ee]),De.delayedLeave&&De.delayedLeave(),ee._enterCb=void 0)};ue?Te(ue,[ee,It]):It()},leave(ee,ue){const we=String(t.key);if(ee._enterCb&&ee._enterCb(!0),n.isUnmounting)return ue();le(h,[ee]);let je=!1;const He=ee._leaveCb=It=>{je||(je=!0,ue(),It?le(y,[ee]):le(g,[ee]),ee._leaveCb=void 0,X[we]===t&&delete X[we])};X[we]=t,f?Te(f,[ee,He]):He()},clone(ee){return za(ee,e,n,s)}};return De}function da(t){if(Do(t))return t=bn(t),t.children=null,t}function Al(t){return Do(t)?t.children?t.children[0]:void 0:t}function Wa(t,e){t.shapeFlag&6&&t.component?Wa(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function ad(t,e=!1,n){let s=[],r=0;for(let i=0;i<t.length;i++){let o=t[i];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:i);o.type===Xe?(o.patchFlag&128&&r++,s=s.concat(ad(o.children,e,a))):(e||o.type!==Wt)&&s.push(a!=null?bn(o,{key:a}):o)}if(r>1)for(let i=0;i<s.length;i++)s[i].patchFlag=-2;return s}function cd(t){return Y(t)?{setup:t,name:t.name}:t}const Li=t=>!!t.type.__asyncLoader,Do=t=>t.type.__isKeepAlive;function ov(t,e){ud(t,"a",e)}function av(t,e){ud(t,"da",e)}function ud(t,e,n=Fe){const s=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return t()});if(Oo(e,s,n),n){let r=n.parent;for(;r&&r.parent;)Do(r.parent.vnode)&&cv(s,e,n,r),r=r.parent}}function cv(t,e,n,s){const r=Oo(e,t,s,!0);fd(()=>{Uc(s[e],r)},n)}function Oo(t,e,n=Fe,s=!1){if(n){const r=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;qs(),Rs(n);const a=wt(e,n,t,o);return jn(),Ks(),a});return s?r.unshift(i):r.push(i),i}}const tn=t=>(e,n=Fe)=>(!Nr||t==="sp")&&Oo(t,e,n),uv=tn("bm"),ld=tn("m"),lv=tn("bu"),hv=tn("u"),hd=tn("bum"),fd=tn("um"),fv=tn("sp"),dv=tn("rtg"),pv=tn("rtc");function gv(t,e=Fe){Oo("ec",t,e)}function kr(t,e){const n=_t;if(n===null)return t;const s=Po(n)||n.proxy,r=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[o,a,c,u=me]=e[i];Y(o)&&(o={mounted:o,updated:o}),o.deep&&Ln(a),r.push({dir:o,instance:s,value:a,oldValue:void 0,arg:c,modifiers:u})}return t}function Nn(t,e,n,s){const r=t.dirs,i=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];i&&(a.oldValue=i[o].value);let c=a.dir[s];c&&(qs(),wt(c,n,8,[t.el,a,t,e]),Ks())}}const dd="components";function Yt(t,e){return yv(dd,t,!0,e)||t}const mv=Symbol();function yv(t,e,n=!0,s=!1){const r=_t||Fe;if(r){const i=r.type;if(t===dd){const a=Gv(i,!1);if(a&&(a===e||a===Vt(e)||a===So(Vt(e))))return i}const o=kl(r[t]||i[t],e)||kl(r.appContext[t],e);return!o&&s?i:o}}function kl(t,e){return t&&(t[e]||t[Vt(e)]||t[So(Vt(e))])}function ks(t,e,n,s){let r;const i=n&&n[s];if(W(t)||Ve(t)){r=new Array(t.length);for(let o=0,a=t.length;o<a;o++)r[o]=e(t[o],o,void 0,i&&i[o])}else if(typeof t=="number"){r=new Array(t);for(let o=0;o<t;o++)r[o]=e(o+1,o,void 0,i&&i[o])}else if(Me(t))if(t[Symbol.iterator])r=Array.from(t,(o,a)=>e(o,a,void 0,i&&i[a]));else{const o=Object.keys(t);r=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const u=o[a];r[a]=e(t[u],u,a,i&&i[a])}}else r=[];return n&&(n[s]=r),r}const Ga=t=>t?Sd(t)?Po(t)||t.proxy:Ga(t.parent):null,Gi=et(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Ga(t.parent),$root:t=>Ga(t.root),$emit:t=>t.emit,$options:t=>gd(t),$forceUpdate:t=>t.f||(t.f=()=>Xf(t.update)),$nextTick:t=>t.n||(t.n=Qf.bind(t.proxy)),$watch:t=>nv.bind(t)}),vv={get({_:t},e){const{ctx:n,setupState:s,data:r,props:i,accessCache:o,type:a,appContext:c}=t;let u;if(e[0]!=="$"){const g=o[e];if(g!==void 0)switch(g){case 1:return s[e];case 2:return r[e];case 4:return n[e];case 3:return i[e]}else{if(s!==me&&re(s,e))return o[e]=1,s[e];if(r!==me&&re(r,e))return o[e]=2,r[e];if((u=t.propsOptions[0])&&re(u,e))return o[e]=3,i[e];if(n!==me&&re(n,e))return o[e]=4,n[e];Qa&&(o[e]=0)}}const l=Gi[e];let h,f;if(l)return e==="$attrs"&&dt(t,"get",e),l(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==me&&re(n,e))return o[e]=4,n[e];if(f=c.config.globalProperties,re(f,e))return f[e]},set({_:t},e,n){const{data:s,setupState:r,ctx:i}=t;return r!==me&&re(r,e)?(r[e]=n,!0):s!==me&&re(s,e)?(s[e]=n,!0):re(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:r,propsOptions:i}},o){let a;return!!n[o]||t!==me&&re(t,o)||e!==me&&re(e,o)||(a=i[0])&&re(a,o)||re(s,o)||re(Gi,o)||re(r.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:re(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let Qa=!0;function _v(t){const e=gd(t),n=t.proxy,s=t.ctx;Qa=!1,e.beforeCreate&&Rl(e.beforeCreate,t,"bc");const{data:r,computed:i,methods:o,watch:a,provide:c,inject:u,created:l,beforeMount:h,mounted:f,beforeUpdate:g,updated:y,activated:S,deactivated:I,beforeDestroy:A,beforeUnmount:x,destroyed:K,unmounted:X,render:le,renderTracked:Te,renderTriggered:De,errorCaptured:ee,serverPrefetch:ue,expose:we,inheritAttrs:je,components:He,directives:It,filters:sn}=e;if(u&&wv(u,s,null,t.appContext.config.unwrapInjectedRef),o)for(const ye in o){const he=o[ye];Y(he)&&(s[ye]=he.bind(n))}if(r){const ye=r.call(n,n);Me(ye)&&(t.data=zs(ye))}if(Qa=!0,i)for(const ye in i){const he=i[ye],lt=Y(he)?he.bind(n,n):Y(he.get)?he.get.bind(n,n):At,os=!Y(he)&&Y(he.set)?he.set.bind(n):At,jt=yt({get:lt,set:os});Object.defineProperty(s,ye,{enumerable:!0,configurable:!0,get:()=>jt.value,set:Dt=>jt.value=Dt})}if(a)for(const ye in a)pd(a[ye],s,n,ye);if(c){const ye=Y(c)?c.call(n):c;Reflect.ownKeys(ye).forEach(he=>{Mi(he,ye[he])})}l&&Rl(l,t,"c");function Oe(ye,he){W(he)?he.forEach(lt=>ye(lt.bind(n))):he&&ye(he.bind(n))}if(Oe(uv,h),Oe(ld,f),Oe(lv,g),Oe(hv,y),Oe(ov,S),Oe(av,I),Oe(gv,ee),Oe(pv,Te),Oe(dv,De),Oe(hd,x),Oe(fd,X),Oe(fv,ue),W(we))if(we.length){const ye=t.exposed||(t.exposed={});we.forEach(he=>{Object.defineProperty(ye,he,{get:()=>n[he],set:lt=>n[he]=lt})})}else t.exposed||(t.exposed={});le&&t.render===At&&(t.render=le),je!=null&&(t.inheritAttrs=je),He&&(t.components=He),It&&(t.directives=It)}function wv(t,e,n=At,s=!1){W(t)&&(t=Xa(t));for(const r in t){const i=t[r];let o;Me(i)?"default"in i?o=vn(i.from||r,i.default,!0):o=vn(i.from||r):o=vn(i),Je(o)&&s?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[r]=o}}function Rl(t,e,n){wt(W(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function pd(t,e,n,s){const r=s.includes(".")?id(n,s):()=>n[s];if(Ve(t)){const i=e[t];Y(i)&&bs(r,i)}else if(Y(t))bs(r,t.bind(n));else if(Me(t))if(W(t))t.forEach(i=>pd(i,e,n,s));else{const i=Y(t.handler)?t.handler.bind(n):e[t.handler];Y(i)&&bs(r,i,t)}}function gd(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:r,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,a=i.get(e);let c;return a?c=a:!r.length&&!n&&!s?c=e:(c={},r.length&&r.forEach(u=>Qi(c,u,o,!0)),Qi(c,e,o)),i.set(e,c),c}function Qi(t,e,n,s=!1){const{mixins:r,extends:i}=e;i&&Qi(t,i,n,!0),r&&r.forEach(o=>Qi(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=Ev[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Ev={data:Nl,props:On,emits:On,methods:On,computed:On,beforeCreate:tt,created:tt,beforeMount:tt,mounted:tt,beforeUpdate:tt,updated:tt,beforeDestroy:tt,beforeUnmount:tt,destroyed:tt,unmounted:tt,activated:tt,deactivated:tt,errorCaptured:tt,serverPrefetch:tt,components:On,directives:On,watch:bv,provide:Nl,inject:Iv};function Nl(t,e){return e?t?function(){return et(Y(t)?t.call(this,this):t,Y(e)?e.call(this,this):e)}:e:t}function Iv(t,e){return On(Xa(t),Xa(e))}function Xa(t){if(W(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function tt(t,e){return t?[...new Set([].concat(t,e))]:e}function On(t,e){return t?et(et(Object.create(null),t),e):e}function bv(t,e){if(!t)return e;if(!e)return t;const n=et(Object.create(null),t);for(const s in e)n[s]=tt(t[s],e[s]);return n}function Tv(t,e,n,s=!1){const r={},i={};Ki(i,xo,1),t.propsDefaults=Object.create(null),md(t,e,r,i);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=s?r:Uy(r):t.type.props?t.props=r:t.props=i,t.attrs=i}function Sv(t,e,n,s){const{props:r,attrs:i,vnode:{patchFlag:o}}=t,a=ae(r),[c]=t.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const l=t.vnode.dynamicProps;for(let h=0;h<l.length;h++){let f=l[h];if(Ro(t.emitsOptions,f))continue;const g=e[f];if(c)if(re(i,f))g!==i[f]&&(i[f]=g,u=!0);else{const y=Vt(f);r[y]=Ya(c,a,y,g,t,!1)}else g!==i[f]&&(i[f]=g,u=!0)}}}else{md(t,e,r,i)&&(u=!0);let l;for(const h in a)(!e||!re(e,h)&&((l=Hs(h))===h||!re(e,l)))&&(c?n&&(n[h]!==void 0||n[l]!==void 0)&&(r[h]=Ya(c,a,h,void 0,t,!0)):delete r[h]);if(i!==a)for(const h in i)(!e||!re(e,h)&&!0)&&(delete i[h],u=!0)}u&&Xt(t,"set","$attrs")}function md(t,e,n,s){const[r,i]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(xi(c))continue;const u=e[c];let l;r&&re(r,l=Vt(c))?!i||!i.includes(l)?n[l]=u:(a||(a={}))[l]=u:Ro(t.emitsOptions,c)||(!(c in s)||u!==s[c])&&(s[c]=u,o=!0)}if(i){const c=ae(n),u=a||me;for(let l=0;l<i.length;l++){const h=i[l];n[h]=Ya(r,c,h,u[h],t,!re(u,h))}}return o}function Ya(t,e,n,s,r,i){const o=t[n];if(o!=null){const a=re(o,"default");if(a&&s===void 0){const c=o.default;if(o.type!==Function&&Y(c)){const{propsDefaults:u}=r;n in u?s=u[n]:(Rs(r),s=u[n]=c.call(null,e),jn())}else s=c}o[0]&&(i&&!a?s=!1:o[1]&&(s===""||s===Hs(n))&&(s=!0))}return s}function yd(t,e,n=!1){const s=e.propsCache,r=s.get(t);if(r)return r;const i=t.props,o={},a=[];let c=!1;if(!Y(t)){const l=h=>{c=!0;const[f,g]=yd(h,e,!0);et(o,f),g&&a.push(...g)};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}if(!i&&!c)return s.set(t,ws),ws;if(W(i))for(let l=0;l<i.length;l++){const h=Vt(i[l]);Dl(h)&&(o[h]=me)}else if(i)for(const l in i){const h=Vt(l);if(Dl(h)){const f=i[l],g=o[h]=W(f)||Y(f)?{type:f}:f;if(g){const y=Pl(Boolean,g.type),S=Pl(String,g.type);g[0]=y>-1,g[1]=S<0||y<S,(y>-1||re(g,"default"))&&a.push(h)}}}const u=[o,a];return s.set(t,u),u}function Dl(t){return t[0]!=="$"}function Ol(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function xl(t,e){return Ol(t)===Ol(e)}function Pl(t,e){return W(e)?e.findIndex(n=>xl(n,t)):Y(e)&&xl(e,t)?0:-1}const vd=t=>t[0]==="_"||t==="$stable",Qc=t=>W(t)?t.map(Mt):[Mt(t)],Cv=(t,e,n)=>{if(e._n)return e;const s=Gc((...r)=>Qc(e(...r)),n);return s._c=!1,s},_d=(t,e,n)=>{const s=t._ctx;for(const r in t){if(vd(r))continue;const i=t[r];if(Y(i))e[r]=Cv(r,i,s);else if(i!=null){const o=Qc(i);e[r]=()=>o}}},wd=(t,e)=>{const n=Qc(e);t.slots.default=()=>n},Av=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ae(e),Ki(e,"_",n)):_d(e,t.slots={})}else t.slots={},e&&wd(t,e);Ki(t.slots,xo,1)},kv=(t,e,n)=>{const{vnode:s,slots:r}=t;let i=!0,o=me;if(s.shapeFlag&32){const a=e._;a?n&&a===1?i=!1:(et(r,e),!n&&a===1&&delete r._):(i=!e.$stable,_d(e,r)),o=e}else e&&(wd(t,e),o={default:1});if(i)for(const a in r)!vd(a)&&!(a in o)&&delete r[a]};function Ed(){return{app:null,config:{isNativeTag:sy,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Rv=0;function Nv(t,e){return function(s,r=null){Y(s)||(s=Object.assign({},s)),r!=null&&!Me(r)&&(r=null);const i=Ed(),o=new Set;let a=!1;const c=i.app={_uid:Rv++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:Xv,get config(){return i.config},set config(u){},use(u,...l){return o.has(u)||(u&&Y(u.install)?(o.add(u),u.install(c,...l)):Y(u)&&(o.add(u),u(c,...l))),c},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),c},component(u,l){return l?(i.components[u]=l,c):i.components[u]},directive(u,l){return l?(i.directives[u]=l,c):i.directives[u]},mount(u,l,h){if(!a){const f=be(s,r);return f.appContext=i,l&&e?e(f,u):t(f,u,h),a=!0,c._container=u,u.__vue_app__=c,Po(f.component)||f.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(u,l){return i.provides[u]=l,c}};return c}}function Ja(t,e,n,s,r=!1){if(W(t)){t.forEach((f,g)=>Ja(f,e&&(W(e)?e[g]:e),n,s,r));return}if(Li(s)&&!r)return;const i=s.shapeFlag&4?Po(s.component)||s.component.proxy:s.el,o=r?null:i,{i:a,r:c}=t,u=e&&e.r,l=a.refs===me?a.refs={}:a.refs,h=a.setupState;if(u!=null&&u!==c&&(Ve(u)?(l[u]=null,re(h,u)&&(h[u]=null)):Je(u)&&(u.value=null)),Y(c))yn(c,a,12,[o,l]);else{const f=Ve(c),g=Je(c);if(f||g){const y=()=>{if(t.f){const S=f?l[c]:c.value;r?W(S)&&Uc(S,i):W(S)?S.includes(i)||S.push(i):f?(l[c]=[i],re(h,c)&&(h[c]=l[c])):(c.value=[i],t.k&&(l[t.k]=c.value))}else f?(l[c]=o,re(h,c)&&(h[c]=o)):g&&(c.value=o,t.k&&(l[t.k]=o))};o?(y.id=-1,it(y,n)):y()}}}const it=tv;function Dv(t){return Ov(t)}function Ov(t,e){const n=uy();n.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:o,createText:a,createComment:c,setText:u,setElementText:l,parentNode:h,nextSibling:f,setScopeId:g=At,cloneNode:y,insertStaticContent:S}=t,I=(d,p,m,w=null,_=null,k=null,D=!1,C=null,R=!!p.dynamicChildren)=>{if(d===p)return;d&&!Pn(d,p)&&(w=L(d),gt(d,_,k,!0),d=null),p.patchFlag===-2&&(R=!1,p.dynamicChildren=null);const{type:E,ref:F,shapeFlag:P}=p;switch(E){case Xc:A(d,p,m,w);break;case Wt:x(d,p,m,w);break;case pa:d==null&&K(p,m,w,D);break;case Xe:It(d,p,m,w,_,k,D,C,R);break;default:P&1?Te(d,p,m,w,_,k,D,C,R):P&6?sn(d,p,m,w,_,k,D,C,R):(P&64||P&128)&&E.process(d,p,m,w,_,k,D,C,R,ve)}F!=null&&_&&Ja(F,d&&d.ref,k,p||d,!p)},A=(d,p,m,w)=>{if(d==null)s(p.el=a(p.children),m,w);else{const _=p.el=d.el;p.children!==d.children&&u(_,p.children)}},x=(d,p,m,w)=>{d==null?s(p.el=c(p.children||""),m,w):p.el=d.el},K=(d,p,m,w)=>{[d.el,d.anchor]=S(d.children,p,m,w,d.el,d.anchor)},X=({el:d,anchor:p},m,w)=>{let _;for(;d&&d!==p;)_=f(d),s(d,m,w),d=_;s(p,m,w)},le=({el:d,anchor:p})=>{let m;for(;d&&d!==p;)m=f(d),r(d),d=m;r(p)},Te=(d,p,m,w,_,k,D,C,R)=>{D=D||p.type==="svg",d==null?De(p,m,w,_,k,D,C,R):we(d,p,_,k,D,C,R)},De=(d,p,m,w,_,k,D,C)=>{let R,E;const{type:F,props:P,shapeFlag:V,transition:z,patchFlag:ie,dirs:de}=d;if(d.el&&y!==void 0&&ie===-1)R=d.el=y(d.el);else{if(R=d.el=o(d.type,k,P&&P.is,P),V&8?l(R,d.children):V&16&&ue(d.children,R,null,w,_,k&&F!=="foreignObject",D,C),de&&Nn(d,null,w,"created"),P){for(const Ee in P)Ee!=="value"&&!xi(Ee)&&i(R,Ee,null,P[Ee],k,d.children,w,_,N);"value"in P&&i(R,"value",null,P.value),(E=P.onVnodeBeforeMount)&&xt(E,w,d)}ee(R,d,d.scopeId,D,w)}de&&Nn(d,null,w,"beforeMount");const pe=(!_||_&&!_.pendingBranch)&&z&&!z.persisted;pe&&z.beforeEnter(R),s(R,p,m),((E=P&&P.onVnodeMounted)||pe||de)&&it(()=>{E&&xt(E,w,d),pe&&z.enter(R),de&&Nn(d,null,w,"mounted")},_)},ee=(d,p,m,w,_)=>{if(m&&g(d,m),w)for(let k=0;k<w.length;k++)g(d,w[k]);if(_){let k=_.subTree;if(p===k){const D=_.vnode;ee(d,D,D.scopeId,D.slotScopeIds,_.parent)}}},ue=(d,p,m,w,_,k,D,C,R=0)=>{for(let E=R;E<d.length;E++){const F=d[E]=C?ln(d[E]):Mt(d[E]);I(null,F,p,m,w,_,k,D,C)}},we=(d,p,m,w,_,k,D)=>{const C=p.el=d.el;let{patchFlag:R,dynamicChildren:E,dirs:F}=p;R|=d.patchFlag&16;const P=d.props||me,V=p.props||me;let z;m&&Dn(m,!1),(z=V.onVnodeBeforeUpdate)&&xt(z,m,p,d),F&&Nn(p,d,m,"beforeUpdate"),m&&Dn(m,!0);const ie=_&&p.type!=="foreignObject";if(E?je(d.dynamicChildren,E,C,m,w,ie,k):D||lt(d,p,C,null,m,w,ie,k,!1),R>0){if(R&16)He(C,p,P,V,m,w,_);else if(R&2&&P.class!==V.class&&i(C,"class",null,V.class,_),R&4&&i(C,"style",P.style,V.style,_),R&8){const de=p.dynamicProps;for(let pe=0;pe<de.length;pe++){const Ee=de[pe],bt=P[Ee],as=V[Ee];(as!==bt||Ee==="value")&&i(C,Ee,bt,as,_,d.children,m,w,N)}}R&1&&d.children!==p.children&&l(C,p.children)}else!D&&E==null&&He(C,p,P,V,m,w,_);((z=V.onVnodeUpdated)||F)&&it(()=>{z&&xt(z,m,p,d),F&&Nn(p,d,m,"updated")},w)},je=(d,p,m,w,_,k,D)=>{for(let C=0;C<p.length;C++){const R=d[C],E=p[C],F=R.el&&(R.type===Xe||!Pn(R,E)||R.shapeFlag&70)?h(R.el):m;I(R,E,F,null,w,_,k,D,!0)}},He=(d,p,m,w,_,k,D)=>{if(m!==w){for(const C in w){if(xi(C))continue;const R=w[C],E=m[C];R!==E&&C!=="value"&&i(d,C,E,R,D,p.children,_,k,N)}if(m!==me)for(const C in m)!xi(C)&&!(C in w)&&i(d,C,m[C],null,D,p.children,_,k,N);"value"in w&&i(d,"value",m.value,w.value)}},It=(d,p,m,w,_,k,D,C,R)=>{const E=p.el=d?d.el:a(""),F=p.anchor=d?d.anchor:a("");let{patchFlag:P,dynamicChildren:V,slotScopeIds:z}=p;z&&(C=C?C.concat(z):z),d==null?(s(E,m,w),s(F,m,w),ue(p.children,m,F,_,k,D,C,R)):P>0&&P&64&&V&&d.dynamicChildren?(je(d.dynamicChildren,V,m,_,k,D,C),(p.key!=null||_&&p===_.subTree)&&Id(d,p,!0)):lt(d,p,m,F,_,k,D,C,R)},sn=(d,p,m,w,_,k,D,C,R)=>{p.slotScopeIds=C,d==null?p.shapeFlag&512?_.ctx.activate(p,m,w,D,R):is(p,m,w,_,k,D,R):Oe(d,p,R)},is=(d,p,m,w,_,k,D)=>{const C=d.component=jv(d,w,_);if(Do(d)&&(C.ctx.renderer=ve),qv(C),C.asyncDep){if(_&&_.registerDep(C,ye),!d.el){const R=C.subTree=be(Wt);x(null,R,p,m)}return}ye(C,d,p,m,_,k,D)},Oe=(d,p,m)=>{const w=p.component=d.component;if(Jy(d,p,m))if(w.asyncDep&&!w.asyncResolved){he(w,p,m);return}else w.next=p,zy(w.update),w.update();else p.el=d.el,w.vnode=p},ye=(d,p,m,w,_,k,D)=>{const C=()=>{if(d.isMounted){let{next:F,bu:P,u:V,parent:z,vnode:ie}=d,de=F,pe;Dn(d,!1),F?(F.el=ie.el,he(d,F,D)):F=ie,P&&Pi(P),(pe=F.props&&F.props.onVnodeBeforeUpdate)&&xt(pe,z,F,ie),Dn(d,!0);const Ee=fa(d),bt=d.subTree;d.subTree=Ee,I(bt,Ee,h(bt.el),L(bt),d,_,k),F.el=Ee.el,de===null&&Zy(d,Ee.el),V&&it(V,_),(pe=F.props&&F.props.onVnodeUpdated)&&it(()=>xt(pe,z,F,ie),_)}else{let F;const{el:P,props:V}=p,{bm:z,m:ie,parent:de}=d,pe=Li(p);if(Dn(d,!1),z&&Pi(z),!pe&&(F=V&&V.onVnodeBeforeMount)&&xt(F,de,p),Dn(d,!0),P&&J){const Ee=()=>{d.subTree=fa(d),J(P,d.subTree,d,_,null)};pe?p.type.__asyncLoader().then(()=>!d.isUnmounted&&Ee()):Ee()}else{const Ee=d.subTree=fa(d);I(null,Ee,m,w,d,_,k),p.el=Ee.el}if(ie&&it(ie,_),!pe&&(F=V&&V.onVnodeMounted)){const Ee=p;it(()=>xt(F,de,Ee),_)}(p.shapeFlag&256||de&&Li(de.vnode)&&de.vnode.shapeFlag&256)&&d.a&&it(d.a,_),d.isMounted=!0,p=m=w=null}},R=d.effect=new Bc(C,()=>Xf(E),d.scope),E=d.update=()=>R.run();E.id=d.uid,Dn(d,!0),E()},he=(d,p,m)=>{p.component=d;const w=d.vnode.props;d.vnode=p,d.next=null,Sv(d,p.props,w,m),kv(d,p.children,m),qs(),ko(void 0,d.update),Ks()},lt=(d,p,m,w,_,k,D,C,R=!1)=>{const E=d&&d.children,F=d?d.shapeFlag:0,P=p.children,{patchFlag:V,shapeFlag:z}=p;if(V>0){if(V&128){jt(E,P,m,w,_,k,D,C,R);return}else if(V&256){os(E,P,m,w,_,k,D,C,R);return}}z&8?(F&16&&N(E,_,k),P!==E&&l(m,P)):F&16?z&16?jt(E,P,m,w,_,k,D,C,R):N(E,_,k,!0):(F&8&&l(m,""),z&16&&ue(P,m,w,_,k,D,C,R))},os=(d,p,m,w,_,k,D,C,R)=>{d=d||ws,p=p||ws;const E=d.length,F=p.length,P=Math.min(E,F);let V;for(V=0;V<P;V++){const z=p[V]=R?ln(p[V]):Mt(p[V]);I(d[V],z,m,null,_,k,D,C,R)}E>F?N(d,_,k,!0,!1,P):ue(p,m,w,_,k,D,C,R,P)},jt=(d,p,m,w,_,k,D,C,R)=>{let E=0;const F=p.length;let P=d.length-1,V=F-1;for(;E<=P&&E<=V;){const z=d[E],ie=p[E]=R?ln(p[E]):Mt(p[E]);if(Pn(z,ie))I(z,ie,m,null,_,k,D,C,R);else break;E++}for(;E<=P&&E<=V;){const z=d[P],ie=p[V]=R?ln(p[V]):Mt(p[V]);if(Pn(z,ie))I(z,ie,m,null,_,k,D,C,R);else break;P--,V--}if(E>P){if(E<=V){const z=V+1,ie=z<F?p[z].el:w;for(;E<=V;)I(null,p[E]=R?ln(p[E]):Mt(p[E]),m,ie,_,k,D,C,R),E++}}else if(E>V)for(;E<=P;)gt(d[E],_,k,!0),E++;else{const z=E,ie=E,de=new Map;for(E=ie;E<=V;E++){const ht=p[E]=R?ln(p[E]):Mt(p[E]);ht.key!=null&&de.set(ht.key,E)}let pe,Ee=0;const bt=V-ie+1;let as=!1,pl=0;const sr=new Array(bt);for(E=0;E<bt;E++)sr[E]=0;for(E=z;E<=P;E++){const ht=d[E];if(Ee>=bt){gt(ht,_,k,!0);continue}let Ot;if(ht.key!=null)Ot=de.get(ht.key);else for(pe=ie;pe<=V;pe++)if(sr[pe-ie]===0&&Pn(ht,p[pe])){Ot=pe;break}Ot===void 0?gt(ht,_,k,!0):(sr[Ot-ie]=E+1,Ot>=pl?pl=Ot:as=!0,I(ht,p[Ot],m,null,_,k,D,C,R),Ee++)}const gl=as?xv(sr):ws;for(pe=gl.length-1,E=bt-1;E>=0;E--){const ht=ie+E,Ot=p[ht],ml=ht+1<F?p[ht+1].el:w;sr[E]===0?I(null,Ot,m,ml,_,k,D,C,R):as&&(pe<0||E!==gl[pe]?Dt(Ot,m,ml,2):pe--)}}},Dt=(d,p,m,w,_=null)=>{const{el:k,type:D,transition:C,children:R,shapeFlag:E}=d;if(E&6){Dt(d.component.subTree,p,m,w);return}if(E&128){d.suspense.move(p,m,w);return}if(E&64){D.move(d,p,m,ve);return}if(D===Xe){s(k,p,m);for(let P=0;P<R.length;P++)Dt(R[P],p,m,w);s(d.anchor,p,m);return}if(D===pa){X(d,p,m);return}if(w!==2&&E&1&&C)if(w===0)C.beforeEnter(k),s(k,p,m),it(()=>C.enter(k),_);else{const{leave:P,delayLeave:V,afterLeave:z}=C,ie=()=>s(k,p,m),de=()=>{P(k,()=>{ie(),z&&z()})};V?V(k,ie,de):de()}else s(k,p,m)},gt=(d,p,m,w=!1,_=!1)=>{const{type:k,props:D,ref:C,children:R,dynamicChildren:E,shapeFlag:F,patchFlag:P,dirs:V}=d;if(C!=null&&Ja(C,null,m,d,!0),F&256){p.ctx.deactivate(d);return}const z=F&1&&V,ie=!Li(d);let de;if(ie&&(de=D&&D.onVnodeBeforeUnmount)&&xt(de,p,d),F&6)M(d.component,m,w);else{if(F&128){d.suspense.unmount(m,w);return}z&&Nn(d,null,p,"beforeUnmount"),F&64?d.type.remove(d,p,m,_,ve,w):E&&(k!==Xe||P>0&&P&64)?N(E,p,m,!1,!0):(k===Xe&&P&384||!_&&F&16)&&N(R,p,m),w&&nr(d)}(ie&&(de=D&&D.onVnodeUnmounted)||z)&&it(()=>{de&&xt(de,p,d),z&&Nn(d,null,p,"unmounted")},m)},nr=d=>{const{type:p,el:m,anchor:w,transition:_}=d;if(p===Xe){v(m,w);return}if(p===pa){le(d);return}const k=()=>{r(m),_&&!_.persisted&&_.afterLeave&&_.afterLeave()};if(d.shapeFlag&1&&_&&!_.persisted){const{leave:D,delayLeave:C}=_,R=()=>D(m,k);C?C(d.el,k,R):R()}else k()},v=(d,p)=>{let m;for(;d!==p;)m=f(d),r(d),d=m;r(p)},M=(d,p,m)=>{const{bum:w,scope:_,update:k,subTree:D,um:C}=d;w&&Pi(w),_.stop(),k&&(k.active=!1,gt(D,d,p,m)),C&&it(C,p),it(()=>{d.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&d.asyncDep&&!d.asyncResolved&&d.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},N=(d,p,m,w=!1,_=!1,k=0)=>{for(let D=k;D<d.length;D++)gt(d[D],p,m,w,_)},L=d=>d.shapeFlag&6?L(d.component.subTree):d.shapeFlag&128?d.suspense.next():f(d.anchor||d.el),fe=(d,p,m)=>{d==null?p._vnode&&gt(p._vnode,null,null,!0):I(p._vnode||null,d,p,null,null,null,m),Zf(),p._vnode=d},ve={p:I,um:gt,m:Dt,r:nr,mt:is,mc:ue,pc:lt,pbc:je,n:L,o:t};let te,J;return e&&([te,J]=e(ve)),{render:fe,hydrate:te,createApp:Nv(fe,te)}}function Dn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Id(t,e,n=!1){const s=t.children,r=e.children;if(W(s)&&W(r))for(let i=0;i<s.length;i++){const o=s[i];let a=r[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[i]=ln(r[i]),a.el=o.el),n||Id(o,a))}}function xv(t){const e=t.slice(),n=[0];let s,r,i,o,a;const c=t.length;for(s=0;s<c;s++){const u=t[s];if(u!==0){if(r=n[n.length-1],t[r]<u){e[s]=r,n.push(s);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,t[n[a]]<u?i=a+1:o=a;u<t[n[i]]&&(i>0&&(e[s]=n[i-1]),n[i]=s)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}const Pv=t=>t.__isTeleport,Xe=Symbol(void 0),Xc=Symbol(void 0),Wt=Symbol(void 0),pa=Symbol(void 0),pr=[];let Ct=null;function Ce(t=!1){pr.push(Ct=t?null:[])}function Mv(){pr.pop(),Ct=pr[pr.length-1]||null}let Rr=1;function Ml(t){Rr+=t}function bd(t){return t.dynamicChildren=Rr>0?Ct||ws:null,Mv(),Rr>0&&Ct&&Ct.push(t),t}function Ae(t,e,n,s,r,i){return bd(j(t,e,n,s,r,i,!0))}function Lv(t,e,n,s,r){return bd(be(t,e,n,s,r,!0))}function Za(t){return t?t.__v_isVNode===!0:!1}function Pn(t,e){return t.type===e.type&&t.key===e.key}const xo="__vInternal",Td=({key:t})=>t!=null?t:null,Ui=({ref:t,ref_key:e,ref_for:n})=>t!=null?Ve(t)||Je(t)||Y(t)?{i:_t,r:t,k:e,f:!!n}:t:null;function j(t,e=null,n=null,s=0,r=null,i=t===Xe?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Td(e),ref:e&&Ui(e),scopeId:No,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null};return a?(Jc(c,n),i&128&&t.normalize(c)):n&&(c.shapeFlag|=Ve(n)?8:16),Rr>0&&!o&&Ct&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Ct.push(c),c}const be=Uv;function Uv(t,e=null,n=null,s=0,r=null,i=!1){if((!t||t===mv)&&(t=Wt),Za(t)){const a=bn(t,e,!0);return n&&Jc(a,n),Rr>0&&!i&&Ct&&(a.shapeFlag&6?Ct[Ct.indexOf(t)]=a:Ct.push(a)),a.patchFlag|=-2,a}if(Qv(t)&&(t=t.__vccOpts),e){e=Fv(e);let{class:a,style:c}=e;a&&!Ve(a)&&(e.class=Mc(a)),Me(c)&&(jf(c)&&!W(c)&&(c=et({},c)),e.style=_s(c))}const o=Ve(t)?1:ev(t)?128:Pv(t)?64:Me(t)?4:Y(t)?2:0;return j(t,e,n,s,r,o,i,!0)}function Fv(t){return t?jf(t)||xo in t?et({},t):t:null}function bn(t,e,n=!1){const{props:s,ref:r,patchFlag:i,children:o}=t,a=e?Vv(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Td(a),ref:e&&e.ref?n&&r?W(r)?r.concat(Ui(e)):[r,Ui(e)]:Ui(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Xe?i===-1?16:i|16:i,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&bn(t.ssContent),ssFallback:t.ssFallback&&bn(t.ssFallback),el:t.el,anchor:t.anchor}}function Yc(t=" ",e=0){return be(Xc,null,t,e)}function Mt(t){return t==null||typeof t=="boolean"?be(Wt):W(t)?be(Xe,null,t.slice()):typeof t=="object"?ln(t):be(Xc,null,String(t))}function ln(t){return t.el===null||t.memo?t:bn(t)}function Jc(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(W(e))n=16;else if(typeof e=="object")if(s&65){const r=e.default;r&&(r._c&&(r._d=!1),Jc(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!(xo in e)?e._ctx=_t:r===3&&_t&&(_t.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else Y(e)?(e={default:e,_ctx:_t},n=32):(e=String(e),s&64?(n=16,e=[Yc(e)]):n=8);t.children=e,t.shapeFlag|=n}function Vv(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const r in s)if(r==="class")e.class!==s.class&&(e.class=Mc([e.class,s.class]));else if(r==="style")e.style=_s([e.style,s.style]);else if(Io(r)){const i=e[r],o=s[r];o&&i!==o&&!(W(i)&&i.includes(o))&&(e[r]=i?[].concat(i,o):o)}else r!==""&&(e[r]=s[r])}return e}function xt(t,e,n,s=null){wt(t,e,7,[n,s])}const $v=Ed();let Bv=0;function jv(t,e,n){const s=t.type,r=(e?e.appContext:t.appContext)||$v,i={uid:Bv++,vnode:t,type:s,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,scope:new ly(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:yd(s,r),emitsOptions:td(s,r),emit:null,emitted:null,propsDefaults:me,inheritAttrs:s.inheritAttrs,ctx:me,data:me,props:me,attrs:me,slots:me,refs:me,setupState:me,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Qy.bind(null,i),t.ce&&t.ce(i),i}let Fe=null;const Hv=()=>Fe||_t,Rs=t=>{Fe=t,t.scope.on()},jn=()=>{Fe&&Fe.scope.off(),Fe=null};function Sd(t){return t.vnode.shapeFlag&4}let Nr=!1;function qv(t,e=!1){Nr=e;const{props:n,children:s}=t.vnode,r=Sd(t);Tv(t,n,r,e),Av(t,s);const i=r?Kv(t,e):void 0;return Nr=!1,i}function Kv(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Hf(new Proxy(t.ctx,vv));const{setup:s}=n;if(s){const r=t.setupContext=s.length>1?Wv(t):null;Rs(t),qs();const i=yn(s,t,0,[t.props,r]);if(Ks(),jn(),kf(i)){if(i.then(jn,jn),e)return i.then(o=>{Ll(t,o,e)}).catch(o=>{Ao(o,t,0)});t.asyncDep=i}else Ll(t,i,e)}else Cd(t,e)}function Ll(t,e,n){Y(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Me(e)&&(t.setupState=Wf(e)),Cd(t,n)}let Ul;function Cd(t,e,n){const s=t.type;if(!t.render){if(!e&&Ul&&!s.render){const r=s.template;if(r){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=s,u=et(et({isCustomElement:i,delimiters:a},o),c);s.render=Ul(r,u)}}t.render=s.render||At}Rs(t),qs(),_v(t),Ks(),jn()}function zv(t){return new Proxy(t.attrs,{get(e,n){return dt(t,"get","$attrs"),e[n]}})}function Wv(t){const e=s=>{t.exposed=s||{}};let n;return{get attrs(){return n||(n=zv(t))},slots:t.slots,emit:t.emit,expose:e}}function Po(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Wf(Hf(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Gi)return Gi[n](t)}}))}function Gv(t,e=!0){return Y(t)?t.displayName||t.name:t.name||e&&t.__name}function Qv(t){return Y(t)&&"__vccOpts"in t}const yt=(t,e)=>Hy(t,e,Nr);function Ad(t,e,n){const s=arguments.length;return s===2?Me(e)&&!W(e)?Za(e)?be(t,null,[e]):be(t,e):be(t,null,e):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&Za(n)&&(n=[n]),be(t,e,n))}const Xv="3.2.37",Yv="http://www.w3.org/2000/svg",Mn=typeof document!="undefined"?document:null,Fl=Mn&&Mn.createElement("template"),Jv={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const r=e?Mn.createElementNS(Yv,t):Mn.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:t=>Mn.createTextNode(t),createComment:t=>Mn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Mn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,s,r,i){const o=n?n.previousSibling:e.lastChild;if(r&&(r===i||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),n),!(r===i||!(r=r.nextSibling)););else{Fl.innerHTML=s?`<svg>${t}</svg>`:t;const a=Fl.content;if(s){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Zv(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function e_(t,e,n){const s=t.style,r=Ve(n);if(n&&!r){for(const i in n)ec(s,i,n[i]);if(e&&!Ve(e))for(const i in e)n[i]==null&&ec(s,i,"")}else{const i=s.display;r?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=i)}}const Vl=/\s*!important$/;function ec(t,e,n){if(W(n))n.forEach(s=>ec(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=t_(t,e);Vl.test(n)?t.setProperty(Hs(s),n.replace(Vl,""),"important"):t[s]=n}}const $l=["Webkit","Moz","ms"],ga={};function t_(t,e){const n=ga[e];if(n)return n;let s=Vt(e);if(s!=="filter"&&s in t)return ga[e]=s;s=So(s);for(let r=0;r<$l.length;r++){const i=$l[r]+s;if(i in t)return ga[e]=i}return e}const Bl="http://www.w3.org/1999/xlink";function n_(t,e,n,s,r){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Bl,e.slice(6,e.length)):t.setAttributeNS(Bl,e,n);else{const i=Zm(e);n==null||i&&!Sf(n)?t.removeAttribute(e):t.setAttribute(e,i?"":n)}}function s_(t,e,n,s,r,i,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,r,i),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const c=n==null?"":n;(t.value!==c||t.tagName==="OPTION")&&(t.value=c),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=Sf(n):n==null&&c==="string"?(n="",a=!0):c==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}const[kd,r_]=(()=>{let t=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let tc=0;const i_=Promise.resolve(),o_=()=>{tc=0},a_=()=>tc||(i_.then(o_),tc=kd());function ps(t,e,n,s){t.addEventListener(e,n,s)}function c_(t,e,n,s){t.removeEventListener(e,n,s)}function u_(t,e,n,s,r=null){const i=t._vei||(t._vei={}),o=i[e];if(s&&o)o.value=s;else{const[a,c]=l_(e);if(s){const u=i[e]=h_(s,r);ps(t,a,u,c)}else o&&(c_(t,a,o,c),i[e]=void 0)}}const jl=/(?:Once|Passive|Capture)$/;function l_(t){let e;if(jl.test(t)){e={};let n;for(;n=t.match(jl);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[Hs(t.slice(2)),e]}function h_(t,e){const n=s=>{const r=s.timeStamp||kd();(r_||r>=n.attached-1)&&wt(f_(s,n.value),e,5,[s])};return n.value=t,n.attached=a_(),n}function f_(t,e){if(W(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>r=>!r._stopped&&s&&s(r))}else return e}const Hl=/^on[a-z]/,d_=(t,e,n,s,r=!1,i,o,a,c)=>{e==="class"?Zv(t,s,r):e==="style"?e_(t,n,s):Io(e)?Lc(e)||u_(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):p_(t,e,s,r))?s_(t,e,s,i,o,a,c):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),n_(t,e,s,r))};function p_(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&Hl.test(e)&&Y(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Hl.test(e)&&Ve(n)?!1:e in t}const g_={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};iv.props;const ql=t=>{const e=t.props["onUpdate:modelValue"]||!1;return W(e)?n=>Pi(e,n):e};function m_(t){t.target.composing=!0}function Kl(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Dr={created(t,{modifiers:{lazy:e,trim:n,number:s}},r){t._assign=ql(r);const i=s||r.props&&r.props.type==="number";ps(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),i&&(a=Fa(a)),t._assign(a)}),n&&ps(t,"change",()=>{t.value=t.value.trim()}),e||(ps(t,"compositionstart",m_),ps(t,"compositionend",Kl),ps(t,"change",Kl))},mounted(t,{value:e}){t.value=e==null?"":e},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:r}},i){if(t._assign=ql(i),t.composing||document.activeElement===t&&t.type!=="range"&&(n||s&&t.value.trim()===e||(r||t.type==="number")&&Fa(t.value)===e))return;const o=e==null?"":e;t.value!==o&&(t.value=o)}},y_=et({patchProp:d_},Jv);let zl;function v_(){return zl||(zl=Dv(y_))}const __=(...t)=>{const e=v_().createApp(...t),{mount:n}=e;return e.mount=s=>{const r=w_(s);if(!r)return;const i=e._component;!Y(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.innerHTML="";const o=n(r,!1,r instanceof SVGElement);return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function w_(t){return Ve(t)?document.querySelector(t):t}function E_(){return Rd().__VUE_DEVTOOLS_GLOBAL_HOOK__}function Rd(){return typeof navigator!="undefined"&&typeof window!="undefined"?window:typeof global!="undefined"?global:{}}const I_=typeof Proxy=="function",b_="devtools-plugin:setup",T_="plugin:settings:set";let cs,nc;function S_(){var t;return cs!==void 0||(typeof window!="undefined"&&window.performance?(cs=!0,nc=window.performance):typeof global!="undefined"&&((t=global.perf_hooks)===null||t===void 0?void 0:t.performance)?(cs=!0,nc=global.perf_hooks.performance):cs=!1),cs}function C_(){return S_()?nc.now():Date.now()}class A_{constructor(e,n){this.target=null,this.targetQueue=[],this.onQueue=[],this.plugin=e,this.hook=n;const s={};if(e.settings)for(const o in e.settings){const a=e.settings[o];s[o]=a.defaultValue}const r=`__vue-devtools-plugin-settings__${e.id}`;let i=Object.assign({},s);try{const o=localStorage.getItem(r),a=JSON.parse(o);Object.assign(i,a)}catch{}this.fallbacks={getSettings(){return i},setSettings(o){try{localStorage.setItem(r,JSON.stringify(o))}catch{}i=o},now(){return C_()}},n&&n.on(T_,(o,a)=>{o===this.plugin.id&&this.fallbacks.setSettings(a)}),this.proxiedOn=new Proxy({},{get:(o,a)=>this.target?this.target.on[a]:(...c)=>{this.onQueue.push({method:a,args:c})}}),this.proxiedTarget=new Proxy({},{get:(o,a)=>this.target?this.target[a]:a==="on"?this.proxiedOn:Object.keys(this.fallbacks).includes(a)?(...c)=>(this.targetQueue.push({method:a,args:c,resolve:()=>{}}),this.fallbacks[a](...c)):(...c)=>new Promise(u=>{this.targetQueue.push({method:a,args:c,resolve:u})})})}async setRealTarget(e){this.target=e;for(const n of this.onQueue)this.target.on[n.method](...n.args);for(const n of this.targetQueue)n.resolve(await this.target[n.method](...n.args))}}function k_(t,e){const n=t,s=Rd(),r=E_(),i=I_&&n.enableEarlyProxy;if(r&&(s.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__||!i))r.emit(b_,t,e);else{const o=i?new A_(n,r):null;(s.__VUE_DEVTOOLS_PLUGINS__=s.__VUE_DEVTOOLS_PLUGINS__||[]).push({pluginDescriptor:n,setupFn:e,proxy:o}),o&&e(o.proxiedTarget)}}/*!
 * vuex v4.0.2
 * (c) 2021 Evan You
 * @license MIT
 */var R_="store";function Ws(t,e){Object.keys(t).forEach(function(n){return e(t[n],n)})}function Nd(t){return t!==null&&typeof t=="object"}function N_(t){return t&&typeof t.then=="function"}function D_(t,e){return function(){return t(e)}}function Dd(t,e,n){return e.indexOf(t)<0&&(n&&n.prepend?e.unshift(t):e.push(t)),function(){var s=e.indexOf(t);s>-1&&e.splice(s,1)}}function Od(t,e){t._actions=Object.create(null),t._mutations=Object.create(null),t._wrappedGetters=Object.create(null),t._modulesNamespaceMap=Object.create(null);var n=t.state;Mo(t,n,[],t._modules.root,!0),Zc(t,n,e)}function Zc(t,e,n){var s=t._state;t.getters={},t._makeLocalGettersCache=Object.create(null);var r=t._wrappedGetters,i={};Ws(r,function(o,a){i[a]=D_(o,t),Object.defineProperty(t.getters,a,{get:function(){return i[a]()},enumerable:!0})}),t._state=zs({data:e}),t.strict&&L_(t),s&&n&&t._withCommit(function(){s.data=null})}function Mo(t,e,n,s,r){var i=!n.length,o=t._modules.getNamespace(n);if(s.namespaced&&(t._modulesNamespaceMap[o],t._modulesNamespaceMap[o]=s),!i&&!r){var a=eu(e,n.slice(0,-1)),c=n[n.length-1];t._withCommit(function(){a[c]=s.state})}var u=s.context=O_(t,o,n);s.forEachMutation(function(l,h){var f=o+h;x_(t,f,l,u)}),s.forEachAction(function(l,h){var f=l.root?h:o+h,g=l.handler||l;P_(t,f,g,u)}),s.forEachGetter(function(l,h){var f=o+h;M_(t,f,l,u)}),s.forEachChild(function(l,h){Mo(t,e,n.concat(h),l,r)})}function O_(t,e,n){var s=e==="",r={dispatch:s?t.dispatch:function(i,o,a){var c=Xi(i,o,a),u=c.payload,l=c.options,h=c.type;return(!l||!l.root)&&(h=e+h),t.dispatch(h,u)},commit:s?t.commit:function(i,o,a){var c=Xi(i,o,a),u=c.payload,l=c.options,h=c.type;(!l||!l.root)&&(h=e+h),t.commit(h,u,l)}};return Object.defineProperties(r,{getters:{get:s?function(){return t.getters}:function(){return xd(t,e)}},state:{get:function(){return eu(t.state,n)}}}),r}function xd(t,e){if(!t._makeLocalGettersCache[e]){var n={},s=e.length;Object.keys(t.getters).forEach(function(r){if(r.slice(0,s)===e){var i=r.slice(s);Object.defineProperty(n,i,{get:function(){return t.getters[r]},enumerable:!0})}}),t._makeLocalGettersCache[e]=n}return t._makeLocalGettersCache[e]}function x_(t,e,n,s){var r=t._mutations[e]||(t._mutations[e]=[]);r.push(function(o){n.call(t,s.state,o)})}function P_(t,e,n,s){var r=t._actions[e]||(t._actions[e]=[]);r.push(function(o){var a=n.call(t,{dispatch:s.dispatch,commit:s.commit,getters:s.getters,state:s.state,rootGetters:t.getters,rootState:t.state},o);return N_(a)||(a=Promise.resolve(a)),t._devtoolHook?a.catch(function(c){throw t._devtoolHook.emit("vuex:error",c),c}):a})}function M_(t,e,n,s){t._wrappedGetters[e]||(t._wrappedGetters[e]=function(i){return n(s.state,s.getters,i.state,i.getters)})}function L_(t){bs(function(){return t._state.data},function(){},{deep:!0,flush:"sync"})}function eu(t,e){return e.reduce(function(n,s){return n[s]},t)}function Xi(t,e,n){return Nd(t)&&t.type&&(n=e,e=t,t=t.type),{type:t,payload:e,options:n}}var U_="vuex bindings",Wl="vuex:mutations",ma="vuex:actions",us="vuex",F_=0;function V_(t,e){k_({id:"org.vuejs.vuex",app:t,label:"Vuex",homepage:"https://next.vuex.vuejs.org/",logo:"https://vuejs.org/images/icons/favicon-96x96.png",packageName:"vuex",componentStateTypes:[U_]},function(n){n.addTimelineLayer({id:Wl,label:"Vuex Mutations",color:Gl}),n.addTimelineLayer({id:ma,label:"Vuex Actions",color:Gl}),n.addInspector({id:us,label:"Vuex",icon:"storage",treeFilterPlaceholder:"Filter stores..."}),n.on.getInspectorTree(function(s){if(s.app===t&&s.inspectorId===us)if(s.filter){var r=[];Ud(r,e._modules.root,s.filter,""),s.rootNodes=r}else s.rootNodes=[Ld(e._modules.root,"")]}),n.on.getInspectorState(function(s){if(s.app===t&&s.inspectorId===us){var r=s.nodeId;xd(e,r),s.state=j_(q_(e._modules,r),r==="root"?e.getters:e._makeLocalGettersCache,r)}}),n.on.editInspectorState(function(s){if(s.app===t&&s.inspectorId===us){var r=s.nodeId,i=s.path;r!=="root"&&(i=r.split("/").filter(Boolean).concat(i)),e._withCommit(function(){s.set(e._state.data,i,s.state.value)})}}),e.subscribe(function(s,r){var i={};s.payload&&(i.payload=s.payload),i.state=r,n.notifyComponentUpdate(),n.sendInspectorTree(us),n.sendInspectorState(us),n.addTimelineEvent({layerId:Wl,event:{time:Date.now(),title:s.type,data:i}})}),e.subscribeAction({before:function(s,r){var i={};s.payload&&(i.payload=s.payload),s._id=F_++,s._time=Date.now(),i.state=r,n.addTimelineEvent({layerId:ma,event:{time:s._time,title:s.type,groupId:s._id,subtitle:"start",data:i}})},after:function(s,r){var i={},o=Date.now()-s._time;i.duration={_custom:{type:"duration",display:o+"ms",tooltip:"Action duration",value:o}},s.payload&&(i.payload=s.payload),i.state=r,n.addTimelineEvent({layerId:ma,event:{time:Date.now(),title:s.type,groupId:s._id,subtitle:"end",data:i}})}})})}var Gl=8702998,$_=6710886,B_=16777215,Pd={label:"namespaced",textColor:B_,backgroundColor:$_};function Md(t){return t&&t!=="root"?t.split("/").slice(-2,-1)[0]:"Root"}function Ld(t,e){return{id:e||"root",label:Md(e),tags:t.namespaced?[Pd]:[],children:Object.keys(t._children).map(function(n){return Ld(t._children[n],e+n+"/")})}}function Ud(t,e,n,s){s.includes(n)&&t.push({id:s||"root",label:s.endsWith("/")?s.slice(0,s.length-1):s||"Root",tags:e.namespaced?[Pd]:[]}),Object.keys(e._children).forEach(function(r){Ud(t,e._children[r],n,s+r+"/")})}function j_(t,e,n){e=n==="root"?e:e[n];var s=Object.keys(e),r={state:Object.keys(t.state).map(function(o){return{key:o,editable:!0,value:t.state[o]}})};if(s.length){var i=H_(e);r.getters=Object.keys(i).map(function(o){return{key:o.endsWith("/")?Md(o):o,editable:!1,value:sc(function(){return i[o]})}})}return r}function H_(t){var e={};return Object.keys(t).forEach(function(n){var s=n.split("/");if(s.length>1){var r=e,i=s.pop();s.forEach(function(o){r[o]||(r[o]={_custom:{value:{},display:o,tooltip:"Module",abstract:!0}}),r=r[o]._custom.value}),r[i]=sc(function(){return t[n]})}else e[n]=sc(function(){return t[n]})}),e}function q_(t,e){var n=e.split("/").filter(function(s){return s});return n.reduce(function(s,r,i){var o=s[r];if(!o)throw new Error('Missing module "'+r+'" for path "'+e+'".');return i===n.length-1?o:o._children},e==="root"?t:t.root._children)}function sc(t){try{return t()}catch(e){return e}}var Nt=function(e,n){this.runtime=n,this._children=Object.create(null),this._rawModule=e;var s=e.state;this.state=(typeof s=="function"?s():s)||{}},Fd={namespaced:{configurable:!0}};Fd.namespaced.get=function(){return!!this._rawModule.namespaced};Nt.prototype.addChild=function(e,n){this._children[e]=n};Nt.prototype.removeChild=function(e){delete this._children[e]};Nt.prototype.getChild=function(e){return this._children[e]};Nt.prototype.hasChild=function(e){return e in this._children};Nt.prototype.update=function(e){this._rawModule.namespaced=e.namespaced,e.actions&&(this._rawModule.actions=e.actions),e.mutations&&(this._rawModule.mutations=e.mutations),e.getters&&(this._rawModule.getters=e.getters)};Nt.prototype.forEachChild=function(e){Ws(this._children,e)};Nt.prototype.forEachGetter=function(e){this._rawModule.getters&&Ws(this._rawModule.getters,e)};Nt.prototype.forEachAction=function(e){this._rawModule.actions&&Ws(this._rawModule.actions,e)};Nt.prototype.forEachMutation=function(e){this._rawModule.mutations&&Ws(this._rawModule.mutations,e)};Object.defineProperties(Nt.prototype,Fd);var es=function(e){this.register([],e,!1)};es.prototype.get=function(e){return e.reduce(function(n,s){return n.getChild(s)},this.root)};es.prototype.getNamespace=function(e){var n=this.root;return e.reduce(function(s,r){return n=n.getChild(r),s+(n.namespaced?r+"/":"")},"")};es.prototype.update=function(e){Vd([],this.root,e)};es.prototype.register=function(e,n,s){var r=this;s===void 0&&(s=!0);var i=new Nt(n,s);if(e.length===0)this.root=i;else{var o=this.get(e.slice(0,-1));o.addChild(e[e.length-1],i)}n.modules&&Ws(n.modules,function(a,c){r.register(e.concat(c),a,s)})};es.prototype.unregister=function(e){var n=this.get(e.slice(0,-1)),s=e[e.length-1],r=n.getChild(s);!r||!r.runtime||n.removeChild(s)};es.prototype.isRegistered=function(e){var n=this.get(e.slice(0,-1)),s=e[e.length-1];return n?n.hasChild(s):!1};function Vd(t,e,n){if(e.update(n),n.modules)for(var s in n.modules){if(!e.getChild(s))return;Vd(t.concat(s),e.getChild(s),n.modules[s])}}function K_(t){return new ut(t)}var ut=function(e){var n=this;e===void 0&&(e={});var s=e.plugins;s===void 0&&(s=[]);var r=e.strict;r===void 0&&(r=!1);var i=e.devtools;this._committing=!1,this._actions=Object.create(null),this._actionSubscribers=[],this._mutations=Object.create(null),this._wrappedGetters=Object.create(null),this._modules=new es(e),this._modulesNamespaceMap=Object.create(null),this._subscribers=[],this._makeLocalGettersCache=Object.create(null),this._devtools=i;var o=this,a=this,c=a.dispatch,u=a.commit;this.dispatch=function(f,g){return c.call(o,f,g)},this.commit=function(f,g,y){return u.call(o,f,g,y)},this.strict=r;var l=this._modules.root.state;Mo(this,l,[],this._modules.root),Zc(this,l),s.forEach(function(h){return h(n)})},tu={state:{configurable:!0}};ut.prototype.install=function(e,n){e.provide(n||R_,this),e.config.globalProperties.$store=this;var s=this._devtools!==void 0?this._devtools:!1;s&&V_(e,this)};tu.state.get=function(){return this._state.data};tu.state.set=function(t){};ut.prototype.commit=function(e,n,s){var r=this,i=Xi(e,n,s),o=i.type,a=i.payload,c={type:o,payload:a},u=this._mutations[o];!u||(this._withCommit(function(){u.forEach(function(h){h(a)})}),this._subscribers.slice().forEach(function(l){return l(c,r.state)}))};ut.prototype.dispatch=function(e,n){var s=this,r=Xi(e,n),i=r.type,o=r.payload,a={type:i,payload:o},c=this._actions[i];if(!!c){try{this._actionSubscribers.slice().filter(function(l){return l.before}).forEach(function(l){return l.before(a,s.state)})}catch{}var u=c.length>1?Promise.all(c.map(function(l){return l(o)})):c[0](o);return new Promise(function(l,h){u.then(function(f){try{s._actionSubscribers.filter(function(g){return g.after}).forEach(function(g){return g.after(a,s.state)})}catch{}l(f)},function(f){try{s._actionSubscribers.filter(function(g){return g.error}).forEach(function(g){return g.error(a,s.state,f)})}catch{}h(f)})})}};ut.prototype.subscribe=function(e,n){return Dd(e,this._subscribers,n)};ut.prototype.subscribeAction=function(e,n){var s=typeof e=="function"?{before:e}:e;return Dd(s,this._actionSubscribers,n)};ut.prototype.watch=function(e,n,s){var r=this;return bs(function(){return e(r.state,r.getters)},n,Object.assign({},s))};ut.prototype.replaceState=function(e){var n=this;this._withCommit(function(){n._state.data=e})};ut.prototype.registerModule=function(e,n,s){s===void 0&&(s={}),typeof e=="string"&&(e=[e]),this._modules.register(e,n),Mo(this,this.state,e,this._modules.get(e),s.preserveState),Zc(this,this.state)};ut.prototype.unregisterModule=function(e){var n=this;typeof e=="string"&&(e=[e]),this._modules.unregister(e),this._withCommit(function(){var s=eu(n.state,e.slice(0,-1));delete s[e[e.length-1]]}),Od(this)};ut.prototype.hasModule=function(e){return typeof e=="string"&&(e=[e]),this._modules.isRegistered(e)};ut.prototype.hotUpdate=function(e){this._modules.update(e),Od(this,!0)};ut.prototype._withCommit=function(e){var n=this._committing;this._committing=!0,e(),this._committing=n};Object.defineProperties(ut.prototype,tu);var Xr=Bd(function(t,e){var n={};return $d(e).forEach(function(s){var r=s.key,i=s.val;n[r]=function(){var a=this.$store.state,c=this.$store.getters;if(t){var u=jd(this.$store,"mapState",t);if(!u)return;a=u.context.state,c=u.context.getters}return typeof i=="function"?i.call(this,a,c):a[i]},n[r].vuex=!0}),n}),Lo=Bd(function(t,e){var n={};return $d(e).forEach(function(s){var r=s.key,i=s.val;n[r]=function(){for(var a=[],c=arguments.length;c--;)a[c]=arguments[c];var u=this.$store.commit;if(t){var l=jd(this.$store,"mapMutations",t);if(!l)return;u=l.context.commit}return typeof i=="function"?i.apply(this,[u].concat(a)):u.apply(this.$store,[i].concat(a))}}),n});function $d(t){return z_(t)?Array.isArray(t)?t.map(function(e){return{key:e,val:e}}):Object.keys(t).map(function(e){return{key:e,val:t[e]}}):[]}function z_(t){return Array.isArray(t)||Nd(t)}function Bd(t){return function(e,n){return typeof e!="string"?(n=e,e=""):e.charAt(e.length-1)!=="/"&&(e+="/"),t(e,n)}}function jd(t,e,n){var s=t._modulesNamespaceMap[n];return s}/*!
  * vue-router v4.1.1
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
  */const gs=typeof window!="undefined";function W_(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const ge=Object.assign;function ya(t,e){const n={};for(const s in e){const r=e[s];n[s]=kt(r)?r.map(t):t(r)}return n}const gr=()=>{},kt=Array.isArray,G_=/\/$/,Q_=t=>t.replace(G_,"");function va(t,e,n="/"){let s,r={},i="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(s=e.slice(0,c),i=e.slice(c+1,a>-1?a:e.length),r=t(i)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=Z_(s!=null?s:e,n),{fullPath:s+(i&&"?")+i+o,path:s,query:r,hash:o}}function X_(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Ql(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Y_(t,e,n){const s=e.matched.length-1,r=n.matched.length-1;return s>-1&&s===r&&Ns(e.matched[s],n.matched[r])&&Hd(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Ns(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Hd(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!J_(t[n],e[n]))return!1;return!0}function J_(t,e){return kt(t)?Xl(t,e):kt(e)?Xl(e,t):t===e}function Xl(t,e){return kt(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function Z_(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/");let r=n.length-1,i,o;for(i=0;i<s.length;i++)if(o=s[i],o!==".")if(o==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(i-(i===s.length?1:0)).join("/")}var Or;(function(t){t.pop="pop",t.push="push"})(Or||(Or={}));var mr;(function(t){t.back="back",t.forward="forward",t.unknown=""})(mr||(mr={}));function ew(t){if(!t)if(gs){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Q_(t)}const tw=/^[^#]+#/;function nw(t,e){return t.replace(tw,"#")+e}function sw(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const Uo=()=>({left:window.pageXOffset,top:window.pageYOffset});function rw(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),r=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!r)return;e=sw(r,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Yl(t,e){return(history.state?history.state.position-e:-1)+t}const rc=new Map;function iw(t,e){rc.set(t,e)}function ow(t){const e=rc.get(t);return rc.delete(t),e}let aw=()=>location.protocol+"//"+location.host;function qd(t,e){const{pathname:n,search:s,hash:r}=e,i=t.indexOf("#");if(i>-1){let a=r.includes(t.slice(i))?t.slice(i).length:1,c=r.slice(a);return c[0]!=="/"&&(c="/"+c),Ql(c,"")}return Ql(n,t)+s+r}function cw(t,e,n,s){let r=[],i=[],o=null;const a=({state:f})=>{const g=qd(t,location),y=n.value,S=e.value;let I=0;if(f){if(n.value=g,e.value=f,o&&o===y){o=null;return}I=S?f.position-S.position:0}else s(g);r.forEach(A=>{A(n.value,y,{delta:I,type:Or.pop,direction:I?I>0?mr.forward:mr.back:mr.unknown})})};function c(){o=n.value}function u(f){r.push(f);const g=()=>{const y=r.indexOf(f);y>-1&&r.splice(y,1)};return i.push(g),g}function l(){const{history:f}=window;!f.state||f.replaceState(ge({},f.state,{scroll:Uo()}),"")}function h(){for(const f of i)f();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",l)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",l),{pauseListeners:c,listen:u,destroy:h}}function Jl(t,e,n,s=!1,r=!1){return{back:t,current:e,forward:n,replaced:s,position:window.history.length,scroll:r?Uo():null}}function uw(t){const{history:e,location:n}=window,s={value:qd(t,n)},r={value:e.state};r.value||i(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,u,l){const h=t.indexOf("#"),f=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+c:aw()+t+c;try{e[l?"replaceState":"pushState"](u,"",f),r.value=u}catch(g){console.error(g),n[l?"replace":"assign"](f)}}function o(c,u){const l=ge({},e.state,Jl(r.value.back,c,r.value.forward,!0),u,{position:r.value.position});i(c,l,!0),s.value=c}function a(c,u){const l=ge({},r.value,e.state,{forward:c,scroll:Uo()});i(l.current,l,!0);const h=ge({},Jl(s.value,c,null),{position:l.position+1},u);i(c,h,!1),s.value=c}return{location:s,state:r,push:a,replace:o}}function lw(t){t=ew(t);const e=uw(t),n=cw(t,e.state,e.location,e.replace);function s(i,o=!0){o||n.pauseListeners(),history.go(i)}const r=ge({location:"",base:t,go:s,createHref:nw.bind(null,t)},e,n);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function hw(t){return typeof t=="string"||t&&typeof t=="object"}function Kd(t){return typeof t=="string"||typeof t=="symbol"}const on={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},zd=Symbol("");var Zl;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Zl||(Zl={}));function Ds(t,e){return ge(new Error,{type:t,[zd]:!0},e)}function an(t,e){return t instanceof Error&&zd in t&&(e==null||!!(t.type&e))}const eh="[^/]+?",fw={sensitive:!1,strict:!1,start:!0,end:!0},dw=/[.+*?^${}()[\]/\\]/g;function pw(t,e){const n=ge({},fw,e),s=[];let r=n.start?"^":"";const i=[];for(const u of t){const l=u.length?[]:[90];n.strict&&!u.length&&(r+="/");for(let h=0;h<u.length;h++){const f=u[h];let g=40+(n.sensitive?.25:0);if(f.type===0)h||(r+="/"),r+=f.value.replace(dw,"\\$&"),g+=40;else if(f.type===1){const{value:y,repeatable:S,optional:I,regexp:A}=f;i.push({name:y,repeatable:S,optional:I});const x=A||eh;if(x!==eh){g+=10;try{new RegExp(`(${x})`)}catch(X){throw new Error(`Invalid custom RegExp for param "${y}" (${x}): `+X.message)}}let K=S?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;h||(K=I&&u.length<2?`(?:/${K})`:"/"+K),I&&(K+="?"),r+=K,g+=20,I&&(g+=-8),S&&(g+=-20),x===".*"&&(g+=-50)}l.push(g)}s.push(l)}if(n.strict&&n.end){const u=s.length-1;s[u][s[u].length-1]+=.7000000000000001}n.strict||(r+="/?"),n.end?r+="$":n.strict&&(r+="(?:/|$)");const o=new RegExp(r,n.sensitive?"":"i");function a(u){const l=u.match(o),h={};if(!l)return null;for(let f=1;f<l.length;f++){const g=l[f]||"",y=i[f-1];h[y.name]=g&&y.repeatable?g.split("/"):g}return h}function c(u){let l="",h=!1;for(const f of t){(!h||!l.endsWith("/"))&&(l+="/"),h=!1;for(const g of f)if(g.type===0)l+=g.value;else if(g.type===1){const{value:y,repeatable:S,optional:I}=g,A=y in u?u[y]:"";if(kt(A)&&!S)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const x=kt(A)?A.join("/"):A;if(!x)if(I)f.length<2&&t.length>1&&(l.endsWith("/")?l=l.slice(0,-1):h=!0);else throw new Error(`Missing required param "${y}"`);l+=x}}return l}return{re:o,score:s,keys:i,parse:a,stringify:c}}function gw(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function mw(t,e){let n=0;const s=t.score,r=e.score;for(;n<s.length&&n<r.length;){const i=gw(s[n],r[n]);if(i)return i;n++}if(Math.abs(r.length-s.length)===1){if(th(s))return 1;if(th(r))return-1}return r.length-s.length}function th(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const yw={type:0,value:""},vw=/[a-zA-Z0-9_]/;function _w(t){if(!t)return[[]];if(t==="/")return[[yw]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(g){throw new Error(`ERR (${n})/"${u}": ${g}`)}let n=0,s=n;const r=[];let i;function o(){i&&r.push(i),i=[]}let a=0,c,u="",l="";function h(){!u||(n===0?i.push({type:0,value:u}):n===1||n===2||n===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:u,regexp:l,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),u="")}function f(){u+=c}for(;a<t.length;){if(c=t[a++],c==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:c==="/"?(u&&h(),o()):c===":"?(h(),n=1):f();break;case 4:f(),n=s;break;case 1:c==="("?n=2:vw.test(c)?f():(h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?l[l.length-1]=="\\"?l=l.slice(0,-1)+c:n=3:l+=c;break;case 3:h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,l="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${u}"`),h(),o(),r}function ww(t,e,n){const s=pw(_w(t.path),n),r=ge(s,{record:t,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function Ew(t,e){const n=[],s=new Map;e=sh({strict:!1,end:!0,sensitive:!1},e);function r(l){return s.get(l)}function i(l,h,f){const g=!f,y=bw(l);y.aliasOf=f&&f.record;const S=sh(e,l),I=[y];if("alias"in l){const K=typeof l.alias=="string"?[l.alias]:l.alias;for(const X of K)I.push(ge({},y,{components:f?f.record.components:y.components,path:X,aliasOf:f?f.record:y}))}let A,x;for(const K of I){const{path:X}=K;if(h&&X[0]!=="/"){const le=h.record.path,Te=le[le.length-1]==="/"?"":"/";K.path=h.record.path+(X&&Te+X)}if(A=ww(K,h,S),f?f.alias.push(A):(x=x||A,x!==A&&x.alias.push(A),g&&l.name&&!nh(A)&&o(l.name)),y.children){const le=y.children;for(let Te=0;Te<le.length;Te++)i(le[Te],A,f&&f.children[Te])}f=f||A,c(A)}return x?()=>{o(x)}:gr}function o(l){if(Kd(l)){const h=s.get(l);h&&(s.delete(l),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(l);h>-1&&(n.splice(h,1),l.record.name&&s.delete(l.record.name),l.children.forEach(o),l.alias.forEach(o))}}function a(){return n}function c(l){let h=0;for(;h<n.length&&mw(l,n[h])>=0&&(l.record.path!==n[h].record.path||!Wd(l,n[h]));)h++;n.splice(h,0,l),l.record.name&&!nh(l)&&s.set(l.record.name,l)}function u(l,h){let f,g={},y,S;if("name"in l&&l.name){if(f=s.get(l.name),!f)throw Ds(1,{location:l});S=f.record.name,g=ge(Iw(h.params,f.keys.filter(x=>!x.optional).map(x=>x.name)),l.params),y=f.stringify(g)}else if("path"in l)y=l.path,f=n.find(x=>x.re.test(y)),f&&(g=f.parse(y),S=f.record.name);else{if(f=h.name?s.get(h.name):n.find(x=>x.re.test(h.path)),!f)throw Ds(1,{location:l,currentLocation:h});S=f.record.name,g=ge({},h.params,l.params),y=f.stringify(g)}const I=[];let A=f;for(;A;)I.unshift(A.record),A=A.parent;return{name:S,path:y,params:g,matched:I,meta:Sw(I)}}return t.forEach(l=>i(l)),{addRoute:i,resolve:u,removeRoute:o,getRoutes:a,getRecordMatcher:r}}function Iw(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function bw(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:Tw(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function Tw(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="boolean"?n:n[s];return e}function nh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Sw(t){return t.reduce((e,n)=>ge(e,n.meta),{})}function sh(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function Wd(t,e){return e.children.some(n=>n===t||Wd(t,n))}const Gd=/#/g,Cw=/&/g,Aw=/\//g,kw=/=/g,Rw=/\?/g,Qd=/\+/g,Nw=/%5B/g,Dw=/%5D/g,Xd=/%5E/g,Ow=/%60/g,Yd=/%7B/g,xw=/%7C/g,Jd=/%7D/g,Pw=/%20/g;function nu(t){return encodeURI(""+t).replace(xw,"|").replace(Nw,"[").replace(Dw,"]")}function Mw(t){return nu(t).replace(Yd,"{").replace(Jd,"}").replace(Xd,"^")}function ic(t){return nu(t).replace(Qd,"%2B").replace(Pw,"+").replace(Gd,"%23").replace(Cw,"%26").replace(Ow,"`").replace(Yd,"{").replace(Jd,"}").replace(Xd,"^")}function Lw(t){return ic(t).replace(kw,"%3D")}function Uw(t){return nu(t).replace(Gd,"%23").replace(Rw,"%3F")}function Fw(t){return t==null?"":Uw(t).replace(Aw,"%2F")}function Yi(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function Vw(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let r=0;r<s.length;++r){const i=s[r].replace(Qd," "),o=i.indexOf("="),a=Yi(o<0?i:i.slice(0,o)),c=o<0?null:Yi(i.slice(o+1));if(a in e){let u=e[a];kt(u)||(u=e[a]=[u]),u.push(c)}else e[a]=c}return e}function rh(t){let e="";for(let n in t){const s=t[n];if(n=Lw(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(kt(s)?s.map(i=>i&&ic(i)):[s&&ic(s)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function $w(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=kt(s)?s.map(r=>r==null?null:""+r):s==null?s:""+s)}return e}const Bw=Symbol(""),ih=Symbol(""),su=Symbol(""),Zd=Symbol(""),oc=Symbol("");function rr(){let t=[];function e(s){return t.push(s),()=>{const r=t.indexOf(s);r>-1&&t.splice(r,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function hn(t,e,n,s,r){const i=s&&(s.enterCallbacks[r]=s.enterCallbacks[r]||[]);return()=>new Promise((o,a)=>{const c=h=>{h===!1?a(Ds(4,{from:n,to:e})):h instanceof Error?a(h):hw(h)?a(Ds(2,{from:e,to:h})):(i&&s.enterCallbacks[r]===i&&typeof h=="function"&&i.push(h),o())},u=t.call(s&&s.instances[r],e,n,c);let l=Promise.resolve(u);t.length<3&&(l=l.then(c)),l.catch(h=>a(h))})}function _a(t,e,n,s){const r=[];for(const i of t)for(const o in i.components){let a=i.components[o];if(!(e!=="beforeRouteEnter"&&!i.instances[o]))if(jw(a)){const u=(a.__vccOpts||a)[e];u&&r.push(hn(u,n,s,i,o))}else{let c=a();r.push(()=>c.then(u=>{if(!u)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${i.path}"`));const l=W_(u)?u.default:u;i.components[o]=l;const f=(l.__vccOpts||l)[e];return f&&hn(f,n,s,i,o)()}))}}return r}function jw(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function oh(t){const e=vn(su),n=vn(Zd),s=yt(()=>e.resolve(Bn(t.to))),r=yt(()=>{const{matched:c}=s.value,{length:u}=c,l=c[u-1],h=n.matched;if(!l||!h.length)return-1;const f=h.findIndex(Ns.bind(null,l));if(f>-1)return f;const g=ah(c[u-2]);return u>1&&ah(l)===g&&h[h.length-1].path!==g?h.findIndex(Ns.bind(null,c[u-2])):f}),i=yt(()=>r.value>-1&&Kw(n.params,s.value.params)),o=yt(()=>r.value>-1&&r.value===n.matched.length-1&&Hd(n.params,s.value.params));function a(c={}){return qw(c)?e[Bn(t.replace)?"replace":"push"](Bn(t.to)).catch(gr):Promise.resolve()}return{route:s,href:yt(()=>s.value.href),isActive:i,isExactActive:o,navigate:a}}const Hw=cd({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:oh,setup(t,{slots:e}){const n=zs(oh(t)),{options:s}=vn(su),r=yt(()=>({[ch(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[ch(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:Ad("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:r.value},i)}}}),ep=Hw;function qw(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function Kw(t,e){for(const n in e){const s=e[n],r=t[n];if(typeof s=="string"){if(s!==r)return!1}else if(!kt(r)||r.length!==s.length||s.some((i,o)=>i!==r[o]))return!1}return!0}function ah(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const ch=(t,e,n)=>t!=null?t:e!=null?e:n,zw=cd({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=vn(oc),r=yt(()=>t.route||s.value),i=vn(ih,0),o=yt(()=>{let u=Bn(i);const{matched:l}=r.value;let h;for(;(h=l[u])&&!h.components;)u++;return u}),a=yt(()=>r.value.matched[o.value]);Mi(ih,yt(()=>o.value+1)),Mi(Bw,a),Mi(oc,r);const c=Fy();return bs(()=>[c.value,a.value,t.name],([u,l,h],[f,g,y])=>{l&&(l.instances[h]=u,g&&g!==l&&u&&u===f&&(l.leaveGuards.size||(l.leaveGuards=g.leaveGuards),l.updateGuards.size||(l.updateGuards=g.updateGuards))),u&&l&&(!g||!Ns(l,g)||!f)&&(l.enterCallbacks[h]||[]).forEach(S=>S(u))},{flush:"post"}),()=>{const u=r.value,l=a.value,h=l&&l.components[t.name],f=t.name;if(!h)return uh(n.default,{Component:h,route:u});const g=l.props[t.name],y=g?g===!0?u.params:typeof g=="function"?g(u):g:null,I=Ad(h,ge({},y,e,{onVnodeUnmounted:A=>{A.component.isUnmounted&&(l.instances[f]=null)},ref:c}));return uh(n.default,{Component:I,route:u})||I}}});function uh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const tp=zw;function Ww(t){const e=Ew(t.routes,t),n=t.parseQuery||Vw,s=t.stringifyQuery||rh,r=t.history,i=rr(),o=rr(),a=rr(),c=Vy(on);let u=on;gs&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const l=ya.bind(null,v=>""+v),h=ya.bind(null,Fw),f=ya.bind(null,Yi);function g(v,M){let N,L;return Kd(v)?(N=e.getRecordMatcher(v),L=M):L=v,e.addRoute(L,N)}function y(v){const M=e.getRecordMatcher(v);M&&e.removeRoute(M)}function S(){return e.getRoutes().map(v=>v.record)}function I(v){return!!e.getRecordMatcher(v)}function A(v,M){if(M=ge({},M||c.value),typeof v=="string"){const J=va(n,v,M.path),d=e.resolve({path:J.path},M),p=r.createHref(J.fullPath);return ge(J,d,{params:f(d.params),hash:Yi(J.hash),redirectedFrom:void 0,href:p})}let N;if("path"in v)N=ge({},v,{path:va(n,v.path,M.path).path});else{const J=ge({},v.params);for(const d in J)J[d]==null&&delete J[d];N=ge({},v,{params:h(v.params)}),M.params=h(M.params)}const L=e.resolve(N,M),fe=v.hash||"";L.params=l(f(L.params));const ve=X_(s,ge({},v,{hash:Mw(fe),path:L.path})),te=r.createHref(ve);return ge({fullPath:ve,hash:fe,query:s===rh?$w(v.query):v.query||{}},L,{redirectedFrom:void 0,href:te})}function x(v){return typeof v=="string"?va(n,v,c.value.path):ge({},v)}function K(v,M){if(u!==v)return Ds(8,{from:M,to:v})}function X(v){return De(v)}function le(v){return X(ge(x(v),{replace:!0}))}function Te(v){const M=v.matched[v.matched.length-1];if(M&&M.redirect){const{redirect:N}=M;let L=typeof N=="function"?N(v):N;return typeof L=="string"&&(L=L.includes("?")||L.includes("#")?L=x(L):{path:L},L.params={}),ge({query:v.query,hash:v.hash,params:"path"in L?{}:v.params},L)}}function De(v,M){const N=u=A(v),L=c.value,fe=v.state,ve=v.force,te=v.replace===!0,J=Te(N);if(J)return De(ge(x(J),{state:fe,force:ve,replace:te}),M||N);const d=N;d.redirectedFrom=M;let p;return!ve&&Y_(s,L,N)&&(p=Ds(16,{to:d,from:L}),os(L,L,!0,!1)),(p?Promise.resolve(p):ue(d,L)).catch(m=>an(m)?an(m,2)?m:lt(m):ye(m,d,L)).then(m=>{if(m){if(an(m,2))return De(ge(x(m.to),{state:fe,force:ve,replace:te}),M||d)}else m=je(d,L,!0,te,fe);return we(d,L,m),m})}function ee(v,M){const N=K(v,M);return N?Promise.reject(N):Promise.resolve()}function ue(v,M){let N;const[L,fe,ve]=Gw(v,M);N=_a(L.reverse(),"beforeRouteLeave",v,M);for(const J of L)J.leaveGuards.forEach(d=>{N.push(hn(d,v,M))});const te=ee.bind(null,v,M);return N.push(te),ls(N).then(()=>{N=[];for(const J of i.list())N.push(hn(J,v,M));return N.push(te),ls(N)}).then(()=>{N=_a(fe,"beforeRouteUpdate",v,M);for(const J of fe)J.updateGuards.forEach(d=>{N.push(hn(d,v,M))});return N.push(te),ls(N)}).then(()=>{N=[];for(const J of v.matched)if(J.beforeEnter&&!M.matched.includes(J))if(kt(J.beforeEnter))for(const d of J.beforeEnter)N.push(hn(d,v,M));else N.push(hn(J.beforeEnter,v,M));return N.push(te),ls(N)}).then(()=>(v.matched.forEach(J=>J.enterCallbacks={}),N=_a(ve,"beforeRouteEnter",v,M),N.push(te),ls(N))).then(()=>{N=[];for(const J of o.list())N.push(hn(J,v,M));return N.push(te),ls(N)}).catch(J=>an(J,8)?J:Promise.reject(J))}function we(v,M,N){for(const L of a.list())L(v,M,N)}function je(v,M,N,L,fe){const ve=K(v,M);if(ve)return ve;const te=M===on,J=gs?history.state:{};N&&(L||te?r.replace(v.fullPath,ge({scroll:te&&J&&J.scroll},fe)):r.push(v.fullPath,fe)),c.value=v,os(v,M,N,te),lt()}let He;function It(){He||(He=r.listen((v,M,N)=>{if(!nr.listening)return;const L=A(v),fe=Te(L);if(fe){De(ge(fe,{replace:!0}),L).catch(gr);return}u=L;const ve=c.value;gs&&iw(Yl(ve.fullPath,N.delta),Uo()),ue(L,ve).catch(te=>an(te,12)?te:an(te,2)?(De(te.to,L).then(J=>{an(J,20)&&!N.delta&&N.type===Or.pop&&r.go(-1,!1)}).catch(gr),Promise.reject()):(N.delta&&r.go(-N.delta,!1),ye(te,L,ve))).then(te=>{te=te||je(L,ve,!1),te&&(N.delta?r.go(-N.delta,!1):N.type===Or.pop&&an(te,20)&&r.go(-1,!1)),we(L,ve,te)}).catch(gr)}))}let sn=rr(),is=rr(),Oe;function ye(v,M,N){lt(v);const L=is.list();return L.length?L.forEach(fe=>fe(v,M,N)):console.error(v),Promise.reject(v)}function he(){return Oe&&c.value!==on?Promise.resolve():new Promise((v,M)=>{sn.add([v,M])})}function lt(v){return Oe||(Oe=!v,It(),sn.list().forEach(([M,N])=>v?N(v):M()),sn.reset()),v}function os(v,M,N,L){const{scrollBehavior:fe}=t;if(!gs||!fe)return Promise.resolve();const ve=!N&&ow(Yl(v.fullPath,0))||(L||!N)&&history.state&&history.state.scroll||null;return Qf().then(()=>fe(v,M,ve)).then(te=>te&&rw(te)).catch(te=>ye(te,v,M))}const jt=v=>r.go(v);let Dt;const gt=new Set,nr={currentRoute:c,listening:!0,addRoute:g,removeRoute:y,hasRoute:I,getRoutes:S,resolve:A,options:t,push:X,replace:le,go:jt,back:()=>jt(-1),forward:()=>jt(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:is.add,isReady:he,install(v){const M=this;v.component("RouterLink",ep),v.component("RouterView",tp),v.config.globalProperties.$router=M,Object.defineProperty(v.config.globalProperties,"$route",{enumerable:!0,get:()=>Bn(c)}),gs&&!Dt&&c.value===on&&(Dt=!0,X(r.location).catch(fe=>{}));const N={};for(const fe in on)N[fe]=yt(()=>c.value[fe]);v.provide(su,M),v.provide(Zd,zs(N)),v.provide(oc,c);const L=v.unmount;gt.add(v),v.unmount=function(){gt.delete(v),gt.size<1&&(u=on,He&&He(),He=null,c.value=on,Dt=!1,Oe=!1),L()}}};return nr}function ls(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function Gw(t,e){const n=[],s=[],r=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(u=>Ns(u,a))?s.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(u=>Ns(u,c))||r.push(c))}return[n,s,r]}const Qw={id:"app",class:"content"},Xw={__name:"App",setup(t){return(e,n)=>(Ce(),Ae("div",Qw,[be(Bn(tp))]))}};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const np=function(t){const e=[];let n=0;for(let s=0;s<t.length;s++){let r=t.charCodeAt(s);r<128?e[n++]=r:r<2048?(e[n++]=r>>6|192,e[n++]=r&63|128):(r&64512)===55296&&s+1<t.length&&(t.charCodeAt(s+1)&64512)===56320?(r=65536+((r&1023)<<10)+(t.charCodeAt(++s)&1023),e[n++]=r>>18|240,e[n++]=r>>12&63|128,e[n++]=r>>6&63|128,e[n++]=r&63|128):(e[n++]=r>>12|224,e[n++]=r>>6&63|128,e[n++]=r&63|128)}return e},Yw=function(t){const e=[];let n=0,s=0;for(;n<t.length;){const r=t[n++];if(r<128)e[s++]=String.fromCharCode(r);else if(r>191&&r<224){const i=t[n++];e[s++]=String.fromCharCode((r&31)<<6|i&63)}else if(r>239&&r<365){const i=t[n++],o=t[n++],a=t[n++],c=((r&7)<<18|(i&63)<<12|(o&63)<<6|a&63)-65536;e[s++]=String.fromCharCode(55296+(c>>10)),e[s++]=String.fromCharCode(56320+(c&1023))}else{const i=t[n++],o=t[n++];e[s++]=String.fromCharCode((r&15)<<12|(i&63)<<6|o&63)}}return e.join("")},sp={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,s=[];for(let r=0;r<t.length;r+=3){const i=t[r],o=r+1<t.length,a=o?t[r+1]:0,c=r+2<t.length,u=c?t[r+2]:0,l=i>>2,h=(i&3)<<4|a>>4;let f=(a&15)<<2|u>>6,g=u&63;c||(g=64,o||(f=64)),s.push(n[l],n[h],n[f],n[g])}return s.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(np(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):Yw(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,s=[];for(let r=0;r<t.length;){const i=n[t.charAt(r++)],a=r<t.length?n[t.charAt(r)]:0;++r;const u=r<t.length?n[t.charAt(r)]:64;++r;const h=r<t.length?n[t.charAt(r)]:64;if(++r,i==null||a==null||u==null||h==null)throw Error();const f=i<<2|a>>4;if(s.push(f),u!==64){const g=a<<4&240|u>>2;if(s.push(g),h!==64){const y=u<<6&192|h;s.push(y)}}}return s},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}},Jw=function(t){const e=np(t);return sp.encodeByteArray(e,!0)},rp=function(t){return Jw(t).replace(/\./g,"")},Zw=function(t){try{return sp.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ip(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test($e())}function op(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function ap(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function tE(){return $e().indexOf("Electron/")>=0}function cp(){const t=$e();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function nE(){return $e().indexOf("MSAppHost/")>=0}function sE(){return typeof indexedDB=="object"}function rE(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(s);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var i;e(((i=r.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iE="FirebaseError";class ts extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=iE,Object.setPrototypeOf(this,ts.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Yr.prototype.create)}}class Yr{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?oE(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new ts(r,a,s)}}function oE(t,e){return t.replace(aE,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const aE=/\{\$([^}]+)}/g;function cE(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Ji(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const i=t[r],o=e[r];if(lh(i)&&lh(o)){if(!Ji(i,o))return!1}else if(i!==o)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function lh(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hp="[DEFAULT]",r0={[uc]:"fire-core",[xE]:"fire-core-compat",[ME]:"fire-analytics",[PE]:"fire-analytics-compat",[UE]:"fire-app-check",[LE]:"fire-app-check-compat",[FE]:"fire-auth",[VE]:"fire-auth-compat",[$E]:"fire-rtdb",[BE]:"fire-rtdb-compat",[jE]:"fire-fn",[HE]:"fire-fn-compat",[qE]:"fire-iid",[KE]:"fire-iid-compat",[zE]:"fire-fcm",[WE]:"fire-fcm-compat",[GE]:"fire-perf",[QE]:"fire-perf-compat",[XE]:"fire-rc",[YE]:"fire-rc-compat",[JE]:"fire-gcs",[ZE]:"fire-gcs-compat",[e0]:"fire-fst",[t0]:"fire-fst-compat","fire-js":"fire-js",[n0]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zi=new Map,lc=new Map;function i0(t,e){try{t.container.addComponent(e)}catch(n){ou.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Os(t){const e=t.name;if(lc.has(e))return ou.debug(`There were multiple attempts to register component ${e}.`),!1;lc.set(e,t);for(const n of Zi.values())i0(n,t);return!0}function au(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zr=s0;function c0(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:hp,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw zn.create("bad-app-name",{appName:String(s)});const r=Zi.get(s);if(r){if(Ji(t,r.options)&&Ji(n,r.config))return r;throw zn.create("duplicate-app",{appName:s})}const i=new gE(s);for(const a of lc.values())i.addComponent(a);const o=new a0(t,n,i);return Zi.set(s,o),o}function fp(t=hp){const e=Zi.get(t);if(!e)throw zn.create("no-app",{appName:t});return e}function wn(t,e,n){var s;let r=(s=r0[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ou.warn(a.join(" "));return}Os(new Kn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u0="firebase-heartbeat-database",l0=1,xr="firebase-heartbeat-store";let Ta=null;function dp(){return Ta||(Ta=kE(u0,l0,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(xr)}}}).catch(t=>{throw zn.create("storage-open",{originalErrorMessage:t.message})})),Ta}async function h0(t){var e;try{return(await dp()).transaction(xr).objectStore(xr).get(pp(t))}catch(n){throw zn.create("storage-get",{originalErrorMessage:(e=n)===null||e===void 0?void 0:e.message})}}async function gh(t,e){var n;try{const r=(await dp()).transaction(xr,"readwrite");return await r.objectStore(xr).put(e,pp(t)),r.done}catch(s){throw zn.create("storage-set",{originalErrorMessage:(n=s)===null||n===void 0?void 0:n.message})}}function pp(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y0(t){Os(new Kn("platform-logger",e=>new DE(e),"PRIVATE")),Os(new Kn("heartbeat",e=>new p0(e),"PRIVATE")),wn(uc,ph,t),wn(uc,ph,"esm2017"),wn("fire-js","")}y0("");function cu(t,e){var n={};for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.indexOf(s)<0&&(n[s]=t[s]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,s=Object.getOwnPropertySymbols(t);r<s.length;r++)e.indexOf(s[r])<0&&Object.prototype.propertyIsEnumerable.call(t,s[r])&&(n[s[r]]=t[s[r]]);return n}function gp(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const v0=gp,mp=new Yr("auth","Firebase",gp());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w0(t,e){const n=au(t,"auth");if(n.isInitialized()){const r=n.getImmediate(),i=n.getOptions();if(Ji(i,e!=null?e:{}))return r;Rt(r,"already-initialized")}return n.initialize({options:e})}function E0(t,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(Kt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b0(){return typeof navigator!="undefined"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(I0()||op()||"connection"in navigator)?navigator.onLine:!0}function T0(){if(typeof navigator=="undefined")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ei{constructor(e,n){this.shortDelay=e,this.longDelay=n,Jt(n>e,"Short delay should be less than long delay!"),this.isMobile=ip()||ap()}get(){return b0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C0=new ei(3e4,6e4);function ti(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function ni(t,e,n,s,r={}){return vp(t,r,async()=>{let i={},o={};s&&(e==="GET"?o=s:i={body:JSON.stringify(s)});const a=Jr(Object.assign({key:t.config.apiKey},o)).slice(1),c=await t._getAdditionalHeaders();return c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode),yp.fetch()(_p(t,t.config.apiHost,n,a),Object.assign({method:e,headers:c,referrerPolicy:"no-referrer"},i))})}async function vp(t,e,n){t._canInitEmulator=!1;const s=Object.assign(Object.assign({},S0),e);try{const r=new A0(t),i=await Promise.race([n(),r.promise]);r.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw Ci(t,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const a=i.ok?o.errorMessage:o.error.message,[c,u]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ci(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Ci(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw Ci(t,"user-disabled",o);const l=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(u)throw _0(t,l,u);Rt(t,l)}}catch(r){if(r instanceof ts)throw r;Rt(t,"network-request-failed")}}async function si(t,e,n,s,r={}){const i=await ni(t,e,n,s,r);return"mfaPendingCredential"in i&&Rt(t,"multi-factor-auth-required",{_serverResponse:i}),i}function _p(t,e,n,s){const r=`${e}${n}?${s}`;return t.config.emulator?lu(t.config,r):`${t.config.apiScheme}://${r}`}class A0{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(Lt(this.auth,"network-request-failed")),C0.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Ci(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const r=Lt(t,e,s);return r.customData._tokenResponse=n,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function k0(t,e){return ni(t,"POST","/v1/accounts:delete",e)}async function R0(t,e){return ni(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function N0(t,e=!1){const n=$t(t),s=await n.getIdToken(e),r=hu(s);H(r&&r.exp&&r.auth_time&&r.iat,n.auth,"internal-error");const i=typeof r.firebase=="object"?r.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:r,token:s,authTime:yr(Sa(r.auth_time)),issuedAtTime:yr(Sa(r.iat)),expirationTime:yr(Sa(r.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Sa(t){return Number(t)*1e3}function hu(t){var e;const[n,s,r]=t.split(".");if(n===void 0||s===void 0||r===void 0)return Fi("JWT malformed, contained fewer than 3 sections"),null;try{const i=Zw(s);return i?JSON.parse(i):(Fi("Failed to decode base64 JWT payload"),null)}catch(i){return Fi("Caught error parsing JWT payload as JSON",(e=i)===null||e===void 0?void 0:e.toString()),null}}function D0(t){const e=hu(t);return H(e,"internal-error"),H(typeof e.exp!="undefined","internal-error"),H(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof ts&&O0(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function O0({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U0(t,e){const n=await vp(t,{},async()=>{const s=Jr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:i}=t.config,o=_p(t,r,"/v1/token",`key=${i}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",yp.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mr{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){H(e.idToken,"internal-error"),H(typeof e.idToken!="undefined","internal-error"),H(typeof e.refreshToken!="undefined","internal-error");const n="expiresIn"in e&&typeof e.expiresIn!="undefined"?Number(e.expiresIn):D0(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return H(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:s,refreshToken:r,expiresIn:i}=await U0(e,n);this.updateTokensAndExpiration(s,r,Number(i))}updateTokensAndExpiration(e,n,s){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,n){const{refreshToken:s,accessToken:r,expirationTime:i}=n,o=new Mr;return s&&(H(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),r&&(H(typeof r=="string","internal-error",{appName:e}),o.accessToken=r),i&&(H(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Mr,this.toJSON())}_performRefresh(){return qt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ep{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ep.type="NONE";const Eh=Ep;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ih(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Tp(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ip(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Cp(e))return"Blackberry";if(Ap(e))return"Webos";if(fu(e))return"Safari";if((e.includes("chrome/")||bp(e))&&!e.includes("edge/"))return"Chrome";if(Sp(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Ip(t=$e()){return/firefox\//i.test(t)}function fu(t=$e()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function bp(t=$e()){return/crios\//i.test(t)}function Tp(t=$e()){return/iemobile/i.test(t)}function Sp(t=$e()){return/android/i.test(t)}function Cp(t=$e()){return/blackberry/i.test(t)}function Ap(t=$e()){return/webos/i.test(t)}function Fo(t=$e()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function F0(t=$e()){var e;return Fo(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function V0(){return cp()&&document.documentMode===10}function kp(t=$e()){return Fo(t)||Sp(t)||Ap(t)||Cp(t)||/windows phone/i.test(t)||Tp(t)}function $0(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rp(t,e=[]){let n;switch(t){case"Browser":n=Ih($e());break;case"Worker":n=`${Ih($e())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Zr}/${s}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q0(t,e){return si(t,"POST","/v1/accounts:signInWithPassword",ti(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function K0(t,e){return si(t,"POST","/v1/accounts:signInWithEmailLink",ti(t,e))}async function z0(t,e){return si(t,"POST","/v1/accounts:signInWithEmailLink",ti(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G0(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Q0(t){const e=cr(ur(t)).link,n=e?cr(ur(e)).deep_link_id:null,s=cr(ur(t)).deep_link_id;return(s?cr(ur(s)).link:null)||s||n||e||t}class pu{constructor(e){var n,s,r,i,o,a;const c=cr(ur(e)),u=(n=c.apiKey)!==null&&n!==void 0?n:null,l=(s=c.oobCode)!==null&&s!==void 0?s:null,h=G0((r=c.mode)!==null&&r!==void 0?r:null);H(u&&l&&h,"argument-error"),this.apiKey=u,this.operation=h,this.code=l,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=Q0(e);try{return new pu(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function X0(t,e){return si(t,"POST","/v1/accounts:signUp",ti(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class to extends ts{constructor(e,n,s,r){var i;super(n.code,n.message),this.operationType=s,this.user=r,Object.setPrototypeOf(this,to.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,r){return new to(e,n,s,r)}}function Dp(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?to._fromErrorAndOperation(t,i,e,s):i})}async function Y0(t,e,n=!1){const s=await Pr(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Gn._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Op(t,e,n=!1){const s="signIn",r=await Dp(t,s,e),i=await Gn._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function Z0(t,e){return Op(Vo(t),e)}async function eI(t,e,n){const s=Vo(t),r=await X0(s,{returnSecureToken:!0,email:e,password:n}),i=await Gn._fromIdTokenResponse(s,"signIn",r);return await s._updateCurrentUser(i.user),i}function tI(t,e,n){return Z0($t(t),Gs.credential(e,n))}function nI(t){return $t(t).signOut()}const no="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xp{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(no,"1"),this.storage.removeItem(no),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mp extends xp{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}Mp.type="SESSION";const Lp=Mp;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function II(t,e){return e?Kt(e):(H(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bp{constructor(e,n,s,r,i=!1){this.auth=e,this.resolver=s,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:r,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:s,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return bI;case"linkViaPopup":case"linkViaRedirect":return SI;case"reauthViaPopup":case"reauthViaRedirect":return TI;default:Rt(this.auth,"internal-error")}}resolve(e){Jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AI="pendingRedirect",$i=new Map;class kI extends Bp{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=$i.get(this.auth._key());if(!e){try{const s=await RI(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}$i.set(this.auth._key(),e)}return this.bypassAuthState||$i.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function RI(t,e){const n=OI(e),s=DI(t);if(!await s._isAvailable())return!1;const r=await s._get(n)==="true";return await s._remove(n),r}function NI(t,e){$i.set(t._key(),e)}function DI(t){return Kt(t._redirectPersistence)}function OI(t){return Vi(AI,t.config.apiKey,t.name)}async function xI(t,e,n=!1){const s=Vo(t),r=II(s,e),o=await new kI(s,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PI=10*60*1e3;class MI{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(s=>{this.isEventForConsumer(e,s)&&(n=!0,this.sendToConsumer(e,s),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!LI(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var s;if(e.error&&!jp(e)){const r=((s=e.error.code)===null||s===void 0?void 0:s.split("auth/")[1])||"internal-error";n.onError(Lt(this.auth,r))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const s=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&s}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=PI&&this.cachedEventUids.clear(),this.cachedEventUids.has(Ah(e))}saveEventToCache(e){this.cachedEventUids.add(Ah(e)),this.lastProcessedEventTime=Date.now()}}function Ah(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function jp({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function LI(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return jp(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UI(t,e={}){return ni(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KI=new ei(5e3,15e3),zI="__/auth/iframe",WI="emulator/auth/iframe",GI={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},QI=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function XI(t){const e=t.config;H(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?lu(e,WI):`https://${t.config.authDomain}/${zI}`,s={apiKey:e.apiKey,appName:t.name,v:Zr},r=QI.get(t.config.apiHost);r&&(s.eid=r);const i=t._getFrameworks();return i.length&&(s.fw=i.join(",")),`${n}?${Jr(s).slice(1)}`}async function YI(t){const e=await qI(t),n=Ut().gapi;return H(n,t,"internal-error"),e.open({where:document.body,url:XI(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:GI,dontclear:!0},s=>new Promise(async(r,i)=>{await s.restyle({setHideOnLeave:!1});const o=Lt(t,"network-request-failed"),a=Ut().setTimeout(()=>{i(o)},KI.get());function c(){Ut().clearTimeout(a),r(s)}s.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JI={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},ZI=500,eb=600,tb="_blank",nb="http://localhost";class Rh{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function sb(t,e,n,s=ZI,r=eb){const i=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const c=Object.assign(Object.assign({},JI),{width:s.toString(),height:r.toString(),top:i,left:o}),u=$e().toLowerCase();n&&(a=bp(u)?tb:n),Ip(u)&&(e=e||nb,c.scrollbars="yes");const l=Object.entries(c).reduce((f,[g,y])=>`${f}${g}=${y},`,"");if(F0(u)&&a!=="_self")return rb(e||"",a),new Rh(null);const h=window.open(e||"",a,l);H(h,t,"popup-blocked");try{h.focus()}catch{}return new Rh(h)}function rb(t,e){const n=document.createElement("a");n.href=t,n.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ib="__/auth/handler",ob="emulator/auth/handler";function Nh(t,e,n,s,r,i){H(t.config.authDomain,t,"auth-domain-config-required"),H(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:s,v:Zr,eventId:r};if(e instanceof Np){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",cE(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[c,u]of Object.entries(i||{}))o[c]=u}if(e instanceof ri){const c=e.getScopes().filter(u=>u!=="");c.length>0&&(o.scopes=c.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const c of Object.keys(a))a[c]===void 0&&delete a[c];return`${ab(t)}?${Jr(a).slice(1)}`}function ab({config:t}){return t.emulator?lu(t,ob):`https://${t.authDomain}/${ib}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hb(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function fb(t){Os(new Kn("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:o}=s.options;return((a,c)=>{H(i&&!i.includes(":"),"invalid-api-key",{appName:a.name}),H(!(o!=null&&o.includes(":")),"argument-error",{appName:a.name});const u={apiKey:i,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Rp(t)},l=new j0(a,c,u);return E0(l,n),l})(s,r)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),Os(new Kn("auth-internal",e=>{const n=Vo(e.getProvider("auth").getImmediate());return(s=>new lb(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),wn(Dh,Oh,hb(t)),wn(Dh,Oh,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function at(t=fp()){const e=au(t,"auth");return e.isInitialized()?e.getImmediate():w0(t,{popupRedirectResolver:ub,persistence:[vI,oI,Lp]})}fb("Browser");var db=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},O,yu=yu||{},q=db||self;function ro(){}function dc(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function oi(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function pb(t){return Object.prototype.hasOwnProperty.call(t,Aa)&&t[Aa]||(t[Aa]=++gb)}var Aa="closure_uid_"+(1e9*Math.random()>>>0),gb=0;function mb(t,e,n){return t.call.apply(t.bind,arguments)}function yb(t,e,n){if(!t)throw Error();if(2<arguments.length){var s=Array.prototype.slice.call(arguments,2);return function(){var r=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(r,s),t.apply(e,r)}}return function(){return t.apply(e,arguments)}}function ze(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?ze=mb:ze=yb,ze.apply(null,arguments)}function Ai(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var s=n.slice();return s.push.apply(s,arguments),t.apply(this,s)}}function Qe(t,e){function n(){}n.prototype=e.prototype,t.Z=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.Vb=function(s,r,i){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[r].apply(s,o)}}function kn(){this.s=this.s,this.o=this.o}var vb=0;kn.prototype.s=!1;kn.prototype.na=function(){!this.s&&(this.s=!0,this.M(),vb!=0)&&pb(this)};kn.prototype.M=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const Hp=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1},qp=Array.prototype.forEach?function(t,e,n){Array.prototype.forEach.call(t,e,n)}:function(t,e,n){const s=t.length,r=typeof t=="string"?t.split(""):t;for(let i=0;i<s;i++)i in r&&e.call(n,r[i],i,t)};function _b(t){e:{var e=lT;const n=t.length,s=typeof t=="string"?t.split(""):t;for(let r=0;r<n;r++)if(r in s&&e.call(void 0,s[r],r,t)){e=r;break e}e=-1}return 0>e?null:typeof t=="string"?t.charAt(e):t[e]}function xh(t){return Array.prototype.concat.apply([],arguments)}function vu(t){const e=t.length;if(0<e){const n=Array(e);for(let s=0;s<e;s++)n[s]=t[s];return n}return[]}function io(t){return/^[\s\xa0]*$/.test(t)}var Ph=String.prototype.trim?function(t){return t.trim()}:function(t){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(t)[1]};function nt(t,e){return t.indexOf(e)!=-1}function ka(t,e){return t<e?-1:t>e?1:0}var st;e:{var Mh=q.navigator;if(Mh){var Lh=Mh.userAgent;if(Lh){st=Lh;break e}}st=""}function _u(t,e,n){for(const s in t)e.call(n,t[s],s,t)}function Kp(t){const e={};for(const n in t)e[n]=t[n];return e}var Uh="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function zp(t,e){let n,s;for(let r=1;r<arguments.length;r++){s=arguments[r];for(n in s)t[n]=s[n];for(let i=0;i<Uh.length;i++)n=Uh[i],Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}}function wu(t){return wu[" "](t),t}wu[" "]=ro;function wb(t){var e=bb;return Object.prototype.hasOwnProperty.call(e,9)?e[9]:e[9]=t(9)}var Eb=nt(st,"Opera"),xs=nt(st,"Trident")||nt(st,"MSIE"),Wp=nt(st,"Edge"),pc=Wp||xs,Gp=nt(st,"Gecko")&&!(nt(st.toLowerCase(),"webkit")&&!nt(st,"Edge"))&&!(nt(st,"Trident")||nt(st,"MSIE"))&&!nt(st,"Edge"),Ib=nt(st.toLowerCase(),"webkit")&&!nt(st,"Edge");function Qp(){var t=q.document;return t?t.documentMode:void 0}var oo;e:{var Ra="",Na=function(){var t=st;if(Gp)return/rv:([^\);]+)(\)|;)/.exec(t);if(Wp)return/Edge\/([\d\.]+)/.exec(t);if(xs)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(Ib)return/WebKit\/(\S+)/.exec(t);if(Eb)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(Na&&(Ra=Na?Na[1]:""),xs){var Da=Qp();if(Da!=null&&Da>parseFloat(Ra)){oo=String(Da);break e}}oo=Ra}var bb={};function Tb(){return wb(function(){let t=0;const e=Ph(String(oo)).split("."),n=Ph("9").split("."),s=Math.max(e.length,n.length);for(let o=0;t==0&&o<s;o++){var r=e[o]||"",i=n[o]||"";do{if(r=/(\d*)(\D*)(.*)/.exec(r)||["","","",""],i=/(\d*)(\D*)(.*)/.exec(i)||["","","",""],r[0].length==0&&i[0].length==0)break;t=ka(r[1].length==0?0:parseInt(r[1],10),i[1].length==0?0:parseInt(i[1],10))||ka(r[2].length==0,i[2].length==0)||ka(r[2],i[2]),r=r[3],i=i[3]}while(t==0)}return 0<=t})}var gc;if(q.document&&xs){var Fh=Qp();gc=Fh||parseInt(oo,10)||void 0}else gc=void 0;var Sb=gc,Cb=function(){if(!q.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{q.addEventListener("test",ro,e),q.removeEventListener("test",ro,e)}catch{}return t}();function Ze(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}Ze.prototype.h=function(){this.defaultPrevented=!0};function Ur(t,e){if(Ze.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,s=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(Gp){e:{try{wu(e.nodeName);var r=!0;break e}catch{}r=!1}r||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,s?(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:Ab[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&Ur.Z.h.call(this)}}Qe(Ur,Ze);var Ab={2:"touch",3:"pen",4:"mouse"};Ur.prototype.h=function(){Ur.Z.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var ai="closure_listenable_"+(1e6*Math.random()|0),kb=0;function Rb(t,e,n,s,r){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!s,this.ia=r,this.key=++kb,this.ca=this.fa=!1}function jo(t){t.ca=!0,t.listener=null,t.proxy=null,t.src=null,t.ia=null}function Ho(t){this.src=t,this.g={},this.h=0}Ho.prototype.add=function(t,e,n,s,r){var i=t.toString();t=this.g[i],t||(t=this.g[i]=[],this.h++);var o=yc(t,e,s,r);return-1<o?(e=t[o],n||(e.fa=!1)):(e=new Rb(e,this.src,i,!!s,r),e.fa=n,t.push(e)),e};function mc(t,e){var n=e.type;if(n in t.g){var s=t.g[n],r=Hp(s,e),i;(i=0<=r)&&Array.prototype.splice.call(s,r,1),i&&(jo(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function yc(t,e,n,s){for(var r=0;r<t.length;++r){var i=t[r];if(!i.ca&&i.listener==e&&i.capture==!!n&&i.ia==s)return r}return-1}var Eu="closure_lm_"+(1e6*Math.random()|0),Oa={};function Xp(t,e,n,s,r){if(s&&s.once)return Jp(t,e,n,s,r);if(Array.isArray(e)){for(var i=0;i<e.length;i++)Xp(t,e[i],n,s,r);return null}return n=Tu(n),t&&t[ai]?t.N(e,n,oi(s)?!!s.capture:!!s,r):Yp(t,e,n,!1,s,r)}function Yp(t,e,n,s,r,i){if(!e)throw Error("Invalid event type");var o=oi(r)?!!r.capture:!!r,a=bu(t);if(a||(t[Eu]=a=new Ho(t)),n=a.add(e,n,s,o,i),n.proxy)return n;if(s=Nb(),n.proxy=s,s.src=t,s.listener=n,t.addEventListener)Cb||(r=o),r===void 0&&(r=!1),t.addEventListener(e.toString(),s,r);else if(t.attachEvent)t.attachEvent(eg(e.toString()),s);else if(t.addListener&&t.removeListener)t.addListener(s);else throw Error("addEventListener and attachEvent are unavailable.");return n}function Nb(){function t(n){return e.call(t.src,t.listener,n)}var e=Db;return t}function Jp(t,e,n,s,r){if(Array.isArray(e)){for(var i=0;i<e.length;i++)Jp(t,e[i],n,s,r);return null}return n=Tu(n),t&&t[ai]?t.O(e,n,oi(s)?!!s.capture:!!s,r):Yp(t,e,n,!0,s,r)}function Zp(t,e,n,s,r){if(Array.isArray(e))for(var i=0;i<e.length;i++)Zp(t,e[i],n,s,r);else s=oi(s)?!!s.capture:!!s,n=Tu(n),t&&t[ai]?(t=t.i,e=String(e).toString(),e in t.g&&(i=t.g[e],n=yc(i,n,s,r),-1<n&&(jo(i[n]),Array.prototype.splice.call(i,n,1),i.length==0&&(delete t.g[e],t.h--)))):t&&(t=bu(t))&&(e=t.g[e.toString()],t=-1,e&&(t=yc(e,n,s,r)),(n=-1<t?e[t]:null)&&Iu(n))}function Iu(t){if(typeof t!="number"&&t&&!t.ca){var e=t.src;if(e&&e[ai])mc(e.i,t);else{var n=t.type,s=t.proxy;e.removeEventListener?e.removeEventListener(n,s,t.capture):e.detachEvent?e.detachEvent(eg(n),s):e.addListener&&e.removeListener&&e.removeListener(s),(n=bu(e))?(mc(n,t),n.h==0&&(n.src=null,e[Eu]=null)):jo(t)}}}function eg(t){return t in Oa?Oa[t]:Oa[t]="on"+t}function Db(t,e){if(t.ca)t=!0;else{e=new Ur(e,this);var n=t.listener,s=t.ia||t.src;t.fa&&Iu(t),t=n.call(s,e)}return t}function bu(t){return t=t[Eu],t instanceof Ho?t:null}var xa="__closure_events_fn_"+(1e9*Math.random()>>>0);function Tu(t){return typeof t=="function"?t:(t[xa]||(t[xa]=function(e){return t.handleEvent(e)}),t[xa])}function Be(){kn.call(this),this.i=new Ho(this),this.P=this,this.I=null}Qe(Be,kn);Be.prototype[ai]=!0;Be.prototype.removeEventListener=function(t,e,n,s){Zp(this,t,e,n,s)};function We(t,e){var n,s=t.I;if(s)for(n=[];s;s=s.I)n.push(s);if(t=t.P,s=e.type||e,typeof e=="string")e=new Ze(e,t);else if(e instanceof Ze)e.target=e.target||t;else{var r=e;e=new Ze(s,t),zp(e,r)}if(r=!0,n)for(var i=n.length-1;0<=i;i--){var o=e.g=n[i];r=ki(o,s,!0,e)&&r}if(o=e.g=t,r=ki(o,s,!0,e)&&r,r=ki(o,s,!1,e)&&r,n)for(i=0;i<n.length;i++)o=e.g=n[i],r=ki(o,s,!1,e)&&r}Be.prototype.M=function(){if(Be.Z.M.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],s=0;s<n.length;s++)jo(n[s]);delete t.g[e],t.h--}}this.I=null};Be.prototype.N=function(t,e,n,s){return this.i.add(String(t),e,!1,n,s)};Be.prototype.O=function(t,e,n,s){return this.i.add(String(t),e,!0,n,s)};function ki(t,e,n,s){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var r=!0,i=0;i<e.length;++i){var o=e[i];if(o&&!o.ca&&o.capture==n){var a=o.listener,c=o.ia||o.src;o.fa&&mc(t.i,o),r=a.call(c,s)!==!1&&r}}return r&&!s.defaultPrevented}var Su=q.JSON.stringify;function Ob(){var t=ng;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class xb{constructor(){this.h=this.g=null}add(e,n){const s=tg.get();s.set(e,n),this.h?this.h.next=s:this.g=s,this.h=s}}var tg=new class{constructor(t,e){this.i=t,this.j=e,this.h=0,this.g=null}get(){let t;return 0<this.h?(this.h--,t=this.g,this.g=t.next,t.next=null):t=this.i(),t}}(()=>new Pb,t=>t.reset());class Pb{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function Mb(t){q.setTimeout(()=>{throw t},0)}function Cu(t,e){vc||Lb(),_c||(vc(),_c=!0),ng.add(t,e)}var vc;function Lb(){var t=q.Promise.resolve(void 0);vc=function(){t.then(Ub)}}var _c=!1,ng=new xb;function Ub(){for(var t;t=Ob();){try{t.h.call(t.g)}catch(n){Mb(n)}var e=tg;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}_c=!1}function qo(t,e){Be.call(this),this.h=t||1,this.g=e||q,this.j=ze(this.kb,this),this.l=Date.now()}Qe(qo,Be);O=qo.prototype;O.da=!1;O.S=null;O.kb=function(){if(this.da){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.S=this.g.setTimeout(this.j,this.h-t):(this.S&&(this.g.clearTimeout(this.S),this.S=null),We(this,"tick"),this.da&&(Au(this),this.start()))}};O.start=function(){this.da=!0,this.S||(this.S=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function Au(t){t.da=!1,t.S&&(t.g.clearTimeout(t.S),t.S=null)}O.M=function(){qo.Z.M.call(this),Au(this),delete this.g};function ku(t,e,n){if(typeof t=="function")n&&(t=ze(t,n));else if(t&&typeof t.handleEvent=="function")t=ze(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:q.setTimeout(t,e||0)}function sg(t){t.g=ku(()=>{t.g=null,t.i&&(t.i=!1,sg(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class Fb extends kn{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:sg(this)}M(){super.M(),this.g&&(q.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Fr(t){kn.call(this),this.h=t,this.g={}}Qe(Fr,kn);var Vh=[];function rg(t,e,n,s){Array.isArray(n)||(n&&(Vh[0]=n.toString()),n=Vh);for(var r=0;r<n.length;r++){var i=Xp(e,n[r],s||t.handleEvent,!1,t.h||t);if(!i)break;t.g[i.key]=i}}function ig(t){_u(t.g,function(e,n){this.g.hasOwnProperty(n)&&Iu(e)},t),t.g={}}Fr.prototype.M=function(){Fr.Z.M.call(this),ig(this)};Fr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function Ko(){this.g=!0}Ko.prototype.Aa=function(){this.g=!1};function Vb(t,e,n,s,r,i){t.info(function(){if(t.g)if(i)for(var o="",a=i.split("&"),c=0;c<a.length;c++){var u=a[c].split("=");if(1<u.length){var l=u[0];u=u[1];var h=l.split("_");o=2<=h.length&&h[1]=="type"?o+(l+"="+u+"&"):o+(l+"=redacted&")}}else o=null;else o=i;return"XMLHTTP REQ ("+s+") [attempt "+r+"]: "+e+`
`+n+`
`+o})}function $b(t,e,n,s,r,i,o){t.info(function(){return"XMLHTTP RESP ("+s+") [ attempt "+r+"]: "+e+`
`+n+`
`+i+" "+o})}function ys(t,e,n,s){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+jb(t,n)+(s?" "+s:"")})}function Bb(t,e){t.info(function(){return"TIMEOUT: "+e})}Ko.prototype.info=function(){};function jb(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var s=n[t];if(!(2>s.length)){var r=s[1];if(Array.isArray(r)&&!(1>r.length)){var i=r[0];if(i!="noop"&&i!="stop"&&i!="close")for(var o=1;o<r.length;o++)r[o]=""}}}}return Su(n)}catch{return e}}var ns={},$h=null;function zo(){return $h=$h||new Be}ns.Ma="serverreachability";function og(t){Ze.call(this,ns.Ma,t)}Qe(og,Ze);function Vr(t){const e=zo();We(e,new og(e))}ns.STAT_EVENT="statevent";function ag(t,e){Ze.call(this,ns.STAT_EVENT,t),this.stat=e}Qe(ag,Ze);function rt(t){const e=zo();We(e,new ag(e,t))}ns.Na="timingevent";function cg(t,e){Ze.call(this,ns.Na,t),this.size=e}Qe(cg,Ze);function ci(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return q.setTimeout(function(){t()},e)}var Wo={NO_ERROR:0,lb:1,yb:2,xb:3,sb:4,wb:5,zb:6,Ja:7,TIMEOUT:8,Cb:9},ug={qb:"complete",Mb:"success",Ka:"error",Ja:"abort",Eb:"ready",Fb:"readystatechange",TIMEOUT:"timeout",Ab:"incrementaldata",Db:"progress",tb:"downloadprogress",Ub:"uploadprogress"};function Ru(){}Ru.prototype.h=null;function Bh(t){return t.h||(t.h=t.i())}function lg(){}var ui={OPEN:"a",pb:"b",Ka:"c",Bb:"d"};function Nu(){Ze.call(this,"d")}Qe(Nu,Ze);function Du(){Ze.call(this,"c")}Qe(Du,Ze);var wc;function Go(){}Qe(Go,Ru);Go.prototype.g=function(){return new XMLHttpRequest};Go.prototype.i=function(){return{}};wc=new Go;function li(t,e,n,s){this.l=t,this.j=e,this.m=n,this.X=s||1,this.V=new Fr(this),this.P=Hb,t=pc?125:void 0,this.W=new qo(t),this.H=null,this.i=!1,this.s=this.A=this.v=this.K=this.F=this.Y=this.B=null,this.D=[],this.g=null,this.C=0,this.o=this.u=null,this.N=-1,this.I=!1,this.O=0,this.L=null,this.aa=this.J=this.$=this.U=!1,this.h=new hg}function hg(){this.i=null,this.g="",this.h=!1}var Hb=45e3,Ec={},ao={};O=li.prototype;O.setTimeout=function(t){this.P=t};function Ic(t,e,n){t.K=1,t.v=Xo(Zt(e)),t.s=n,t.U=!0,fg(t,null)}function fg(t,e){t.F=Date.now(),hi(t),t.A=Zt(t.v);var n=t.A,s=t.X;Array.isArray(s)||(s=[String(s)]),_g(n.h,"t",s),t.C=0,n=t.l.H,t.h=new hg,t.g=Vg(t.l,n?e:null,!t.s),0<t.O&&(t.L=new Fb(ze(t.Ia,t,t.g),t.O)),rg(t.V,t.g,"readystatechange",t.gb),e=t.H?Kp(t.H):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.ea(t.A,t.u,t.s,e)):(t.u="GET",t.g.ea(t.A,t.u,null,e)),Vr(),Vb(t.j,t.u,t.A,t.m,t.X,t.s)}O.gb=function(t){t=t.target;const e=this.L;e&&zt(t)==3?e.l():this.Ia(t)};O.Ia=function(t){try{if(t==this.g)e:{const l=zt(this.g);var e=this.g.Da();const h=this.g.ba();if(!(3>l)&&(l!=3||pc||this.g&&(this.h.h||this.g.ga()||Kh(this.g)))){this.I||l!=4||e==7||(e==8||0>=h?Vr(3):Vr(2)),Qo(this);var n=this.g.ba();this.N=n;t:if(dg(this)){var s=Kh(this.g);t="";var r=s.length,i=zt(this.g)==4;if(!this.h.i){if(typeof TextDecoder=="undefined"){Un(this),vr(this);var o="";break t}this.h.i=new q.TextDecoder}for(e=0;e<r;e++)this.h.h=!0,t+=this.h.i.decode(s[e],{stream:i&&e==r-1});s.splice(0,r),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.ga();if(this.i=n==200,$b(this.j,this.u,this.A,this.m,this.X,l,n),this.i){if(this.$&&!this.J){t:{if(this.g){var a,c=this.g;if((a=c.g?c.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!io(a)){var u=a;break t}}u=null}if(n=u)ys(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,bc(this,n);else{this.i=!1,this.o=3,rt(12),Un(this),vr(this);break e}}this.U?(pg(this,l,o),pc&&this.i&&l==3&&(rg(this.V,this.W,"tick",this.fb),this.W.start())):(ys(this.j,this.m,o,null),bc(this,o)),l==4&&Un(this),this.i&&!this.I&&(l==4?Mg(this.l,this):(this.i=!1,hi(this)))}else n==400&&0<o.indexOf("Unknown SID")?(this.o=3,rt(12)):(this.o=0,rt(13)),Un(this),vr(this)}}}catch{}finally{}};function dg(t){return t.g?t.u=="GET"&&t.K!=2&&t.l.Ba:!1}function pg(t,e,n){let s=!0,r;for(;!t.I&&t.C<n.length;)if(r=qb(t,n),r==ao){e==4&&(t.o=4,rt(14),s=!1),ys(t.j,t.m,null,"[Incomplete Response]");break}else if(r==Ec){t.o=4,rt(15),ys(t.j,t.m,n,"[Invalid Chunk]"),s=!1;break}else ys(t.j,t.m,r,null),bc(t,r);dg(t)&&r!=ao&&r!=Ec&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,rt(16),s=!1),t.i=t.i&&s,s?0<n.length&&!t.aa&&(t.aa=!0,e=t.l,e.g==t&&e.$&&!e.L&&(e.h.info("Great, no buffering proxy detected. Bytes received: "+n.length),$u(e),e.L=!0,rt(11))):(ys(t.j,t.m,n,"[Invalid Chunked Response]"),Un(t),vr(t))}O.fb=function(){if(this.g){var t=zt(this.g),e=this.g.ga();this.C<e.length&&(Qo(this),pg(this,t,e),this.i&&t!=4&&hi(this))}};function qb(t,e){var n=t.C,s=e.indexOf(`
`,n);return s==-1?ao:(n=Number(e.substring(n,s)),isNaN(n)?Ec:(s+=1,s+n>e.length?ao:(e=e.substr(s,n),t.C=s+n,e)))}O.cancel=function(){this.I=!0,Un(this)};function hi(t){t.Y=Date.now()+t.P,gg(t,t.P)}function gg(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=ci(ze(t.eb,t),e)}function Qo(t){t.B&&(q.clearTimeout(t.B),t.B=null)}O.eb=function(){this.B=null;const t=Date.now();0<=t-this.Y?(Bb(this.j,this.A),this.K!=2&&(Vr(),rt(17)),Un(this),this.o=2,vr(this)):gg(this,this.Y-t)};function vr(t){t.l.G==0||t.I||Mg(t.l,t)}function Un(t){Qo(t);var e=t.L;e&&typeof e.na=="function"&&e.na(),t.L=null,Au(t.W),ig(t.V),t.g&&(e=t.g,t.g=null,e.abort(),e.na())}function bc(t,e){try{var n=t.l;if(n.G!=0&&(n.g==t||Tc(n.i,t))){if(n.I=t.N,!t.J&&Tc(n.i,t)&&n.G==3){try{var s=n.Ca.g.parse(e)}catch{s=null}if(Array.isArray(s)&&s.length==3){var r=s;if(r[0]==0){e:if(!n.u){if(n.g)if(n.g.F+3e3<t.F)ho(n),Zo(n);else break e;Vu(n),rt(18)}}else n.ta=r[1],0<n.ta-n.U&&37500>r[2]&&n.N&&n.A==0&&!n.v&&(n.v=ci(ze(n.ab,n),6e3));if(1>=Ig(n.i)&&n.ka){try{n.ka()}catch{}n.ka=void 0}}else Fn(n,11)}else if((t.J||n.g==t)&&ho(n),!io(e))for(r=n.Ca.g.parse(e),e=0;e<r.length;e++){let u=r[e];if(n.U=u[0],u=u[1],n.G==2)if(u[0]=="c"){n.J=u[1],n.la=u[2];const l=u[3];l!=null&&(n.ma=l,n.h.info("VER="+n.ma));const h=u[4];h!=null&&(n.za=h,n.h.info("SVER="+n.za));const f=u[5];f!=null&&typeof f=="number"&&0<f&&(s=1.5*f,n.K=s,n.h.info("backChannelRequestTimeoutMs_="+s)),s=n;const g=t.g;if(g){const y=g.g?g.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(y){var i=s.i;!i.g&&(nt(y,"spdy")||nt(y,"quic")||nt(y,"h2"))&&(i.j=i.l,i.g=new Set,i.h&&(Pu(i,i.h),i.h=null))}if(s.D){const S=g.g?g.g.getResponseHeader("X-HTTP-Session-Id"):null;S&&(s.sa=S,Ie(s.F,s.D,S))}}n.G=3,n.j&&n.j.xa(),n.$&&(n.O=Date.now()-t.F,n.h.info("Handshake RTT: "+n.O+"ms")),s=n;var o=t;if(s.oa=Fg(s,s.H?s.la:null,s.W),o.J){bg(s.i,o);var a=o,c=s.K;c&&a.setTimeout(c),a.B&&(Qo(a),hi(a)),s.g=o}else xg(s);0<n.l.length&&ea(n)}else u[0]!="stop"&&u[0]!="close"||Fn(n,7);else n.G==3&&(u[0]=="stop"||u[0]=="close"?u[0]=="stop"?Fn(n,7):Fu(n):u[0]!="noop"&&n.j&&n.j.wa(u),n.A=0)}}Vr(4)}catch{}}function Kb(t){if(t.R&&typeof t.R=="function")return t.R();if(typeof t=="string")return t.split("");if(dc(t)){for(var e=[],n=t.length,s=0;s<n;s++)e.push(t[s]);return e}e=[],n=0;for(s in t)e[n++]=t[s];return e}function Ou(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(dc(t)||typeof t=="string")qp(t,e,void 0);else{if(t.T&&typeof t.T=="function")var n=t.T();else if(t.R&&typeof t.R=="function")n=void 0;else if(dc(t)||typeof t=="string"){n=[];for(var s=t.length,r=0;r<s;r++)n.push(r)}else for(r in n=[],s=0,t)n[s++]=r;s=Kb(t),r=s.length;for(var i=0;i<r;i++)e.call(void 0,s[i],n&&n[i],t)}}function Qs(t,e){this.h={},this.g=[],this.i=0;var n=arguments.length;if(1<n){if(n%2)throw Error("Uneven number of arguments");for(var s=0;s<n;s+=2)this.set(arguments[s],arguments[s+1])}else if(t)if(t instanceof Qs)for(n=t.T(),s=0;s<n.length;s++)this.set(n[s],t.get(n[s]));else for(s in t)this.set(s,t[s])}O=Qs.prototype;O.R=function(){xu(this);for(var t=[],e=0;e<this.g.length;e++)t.push(this.h[this.g[e]]);return t};O.T=function(){return xu(this),this.g.concat()};function xu(t){if(t.i!=t.g.length){for(var e=0,n=0;e<t.g.length;){var s=t.g[e];Qn(t.h,s)&&(t.g[n++]=s),e++}t.g.length=n}if(t.i!=t.g.length){var r={};for(n=e=0;e<t.g.length;)s=t.g[e],Qn(r,s)||(t.g[n++]=s,r[s]=1),e++;t.g.length=n}}O.get=function(t,e){return Qn(this.h,t)?this.h[t]:e};O.set=function(t,e){Qn(this.h,t)||(this.i++,this.g.push(t)),this.h[t]=e};O.forEach=function(t,e){for(var n=this.T(),s=0;s<n.length;s++){var r=n[s],i=this.get(r);t.call(e,i,r,this)}};function Qn(t,e){return Object.prototype.hasOwnProperty.call(t,e)}var mg=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^\\/?#]*)@)?([^\\/?#]*?)(?::([0-9]+))?(?=[\\/?#]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;function zb(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var s=t[n].indexOf("="),r=null;if(0<=s){var i=t[n].substring(0,s);r=t[n].substring(s+1)}else i=t[n];e(i,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}function Xn(t,e){if(this.i=this.s=this.j="",this.m=null,this.o=this.l="",this.g=!1,t instanceof Xn){this.g=e!==void 0?e:t.g,co(this,t.j),this.s=t.s,uo(this,t.i),lo(this,t.m),this.l=t.l,e=t.h;var n=new $r;n.i=e.i,e.g&&(n.g=new Qs(e.g),n.h=e.h),jh(this,n),this.o=t.o}else t&&(n=String(t).match(mg))?(this.g=!!e,co(this,n[1]||"",!0),this.s=_r(n[2]||""),uo(this,n[3]||"",!0),lo(this,n[4]),this.l=_r(n[5]||"",!0),jh(this,n[6]||"",!0),this.o=_r(n[7]||"")):(this.g=!!e,this.h=new $r(null,this.g))}Xn.prototype.toString=function(){var t=[],e=this.j;e&&t.push(lr(e,Hh,!0),":");var n=this.i;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(lr(e,Hh,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.i&&n.charAt(0)!="/"&&t.push("/"),t.push(lr(n,n.charAt(0)=="/"?Yb:Xb,!0))),(n=this.h.toString())&&t.push("?",n),(n=this.o)&&t.push("#",lr(n,Zb)),t.join("")};function Zt(t){return new Xn(t)}function co(t,e,n){t.j=n?_r(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function uo(t,e,n){t.i=n?_r(e,!0):e}function lo(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function jh(t,e,n){e instanceof $r?(t.h=e,eT(t.h,t.g)):(n||(e=lr(e,Jb)),t.h=new $r(e,t.g))}function Ie(t,e,n){t.h.set(e,n)}function Xo(t){return Ie(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function Wb(t){return t instanceof Xn?Zt(t):new Xn(t,void 0)}function Gb(t,e,n,s){var r=new Xn(null,void 0);return t&&co(r,t),e&&uo(r,e),n&&lo(r,n),s&&(r.l=s),r}function _r(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function lr(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,Qb),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function Qb(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var Hh=/[#\/\?@]/g,Xb=/[#\?:]/g,Yb=/[#\?]/g,Jb=/[#\?@]/g,Zb=/#/g;function $r(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function Rn(t){t.g||(t.g=new Qs,t.h=0,t.i&&zb(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}O=$r.prototype;O.add=function(t,e){Rn(this),this.i=null,t=Xs(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function yg(t,e){Rn(t),e=Xs(t,e),Qn(t.g.h,e)&&(t.i=null,t.h-=t.g.get(e).length,t=t.g,Qn(t.h,e)&&(delete t.h[e],t.i--,t.g.length>2*t.i&&xu(t)))}function vg(t,e){return Rn(t),e=Xs(t,e),Qn(t.g.h,e)}O.forEach=function(t,e){Rn(this),this.g.forEach(function(n,s){qp(n,function(r){t.call(e,r,s,this)},this)},this)};O.T=function(){Rn(this);for(var t=this.g.R(),e=this.g.T(),n=[],s=0;s<e.length;s++)for(var r=t[s],i=0;i<r.length;i++)n.push(e[s]);return n};O.R=function(t){Rn(this);var e=[];if(typeof t=="string")vg(this,t)&&(e=xh(e,this.g.get(Xs(this,t))));else{t=this.g.R();for(var n=0;n<t.length;n++)e=xh(e,t[n])}return e};O.set=function(t,e){return Rn(this),this.i=null,t=Xs(this,t),vg(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};O.get=function(t,e){return t?(t=this.R(t),0<t.length?String(t[0]):e):e};function _g(t,e,n){yg(t,e),0<n.length&&(t.i=null,t.g.set(Xs(t,e),vu(n)),t.h+=n.length)}O.toString=function(){if(this.i)return this.i;if(!this.g)return"";for(var t=[],e=this.g.T(),n=0;n<e.length;n++){var s=e[n],r=encodeURIComponent(String(s));s=this.R(s);for(var i=0;i<s.length;i++){var o=r;s[i]!==""&&(o+="="+encodeURIComponent(String(s[i]))),t.push(o)}}return this.i=t.join("&")};function Xs(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function eT(t,e){e&&!t.j&&(Rn(t),t.i=null,t.g.forEach(function(n,s){var r=s.toLowerCase();s!=r&&(yg(this,s),_g(this,r,n))},t)),t.j=e}var tT=class{constructor(t,e){this.h=t,this.g=e}};function wg(t){this.l=t||nT,q.PerformanceNavigationTiming?(t=q.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(q.g&&q.g.Ea&&q.g.Ea()&&q.g.Ea().Zb),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var nT=10;function Eg(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function Ig(t){return t.h?1:t.g?t.g.size:0}function Tc(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function Pu(t,e){t.g?t.g.add(e):t.h=e}function bg(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}wg.prototype.cancel=function(){if(this.i=Tg(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function Tg(t){if(t.h!=null)return t.i.concat(t.h.D);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.D);return e}return vu(t.i)}function Mu(){}Mu.prototype.stringify=function(t){return q.JSON.stringify(t,void 0)};Mu.prototype.parse=function(t){return q.JSON.parse(t,void 0)};function sT(){this.g=new Mu}function rT(t,e,n){const s=n||"";try{Ou(t,function(r,i){let o=r;oi(r)&&(o=Su(r)),e.push(s+i+"="+encodeURIComponent(o))})}catch(r){throw e.push(s+"type="+encodeURIComponent("_badmap")),r}}function iT(t,e){const n=new Ko;if(q.Image){const s=new Image;s.onload=Ai(Ri,n,s,"TestLoadImage: loaded",!0,e),s.onerror=Ai(Ri,n,s,"TestLoadImage: error",!1,e),s.onabort=Ai(Ri,n,s,"TestLoadImage: abort",!1,e),s.ontimeout=Ai(Ri,n,s,"TestLoadImage: timeout",!1,e),q.setTimeout(function(){s.ontimeout&&s.ontimeout()},1e4),s.src=t}else e(!1)}function Ri(t,e,n,s,r){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,r(s)}catch{}}function fi(t){this.l=t.$b||null,this.j=t.ib||!1}Qe(fi,Ru);fi.prototype.g=function(){return new Yo(this.l,this.j)};fi.prototype.i=function(t){return function(){return t}}({});function Yo(t,e){Be.call(this),this.D=t,this.u=e,this.m=void 0,this.readyState=Lu,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Qe(Yo,Be);var Lu=0;O=Yo.prototype;O.open=function(t,e){if(this.readyState!=Lu)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,Br(this)};O.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.D||q).fetch(new Request(this.B,e)).then(this.Va.bind(this),this.ha.bind(this))};O.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted."),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,di(this)),this.readyState=Lu};O.Va=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,Br(this)),this.g&&(this.readyState=3,Br(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ta.bind(this),this.ha.bind(this));else if(typeof q.ReadableStream!="undefined"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;Sg(this)}else t.text().then(this.Ua.bind(this),this.ha.bind(this))};function Sg(t){t.j.read().then(t.Sa.bind(t)).catch(t.ha.bind(t))}O.Sa=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?di(this):Br(this),this.readyState==3&&Sg(this)}};O.Ua=function(t){this.g&&(this.response=this.responseText=t,di(this))};O.Ta=function(t){this.g&&(this.response=t,di(this))};O.ha=function(){this.g&&di(this)};function di(t){t.readyState=4,t.l=null,t.j=null,t.A=null,Br(t)}O.setRequestHeader=function(t,e){this.v.append(t,e)};O.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};O.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function Br(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Yo.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var oT=q.JSON.parse;function Ne(t){Be.call(this),this.headers=new Qs,this.u=t||null,this.h=!1,this.C=this.g=null,this.H="",this.m=0,this.j="",this.l=this.F=this.v=this.D=!1,this.B=0,this.A=null,this.J=Cg,this.K=this.L=!1}Qe(Ne,Be);var Cg="",aT=/^https?$/i,cT=["POST","PUT"];O=Ne.prototype;O.ea=function(t,e,n,s){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.H+"; newUri="+t);e=e?e.toUpperCase():"GET",this.H=t,this.j="",this.m=0,this.D=!1,this.h=!0,this.g=this.u?this.u.g():wc.g(),this.C=this.u?Bh(this.u):Bh(wc),this.g.onreadystatechange=ze(this.Fa,this);try{this.F=!0,this.g.open(e,String(t),!0),this.F=!1}catch(i){qh(this,i);return}t=n||"";const r=new Qs(this.headers);s&&Ou(s,function(i,o){r.set(o,i)}),s=_b(r.T()),n=q.FormData&&t instanceof q.FormData,!(0<=Hp(cT,e))||s||n||r.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8"),r.forEach(function(i,o){this.g.setRequestHeader(o,i)},this),this.J&&(this.g.responseType=this.J),"withCredentials"in this.g&&this.g.withCredentials!==this.L&&(this.g.withCredentials=this.L);try{Rg(this),0<this.B&&((this.K=uT(this.g))?(this.g.timeout=this.B,this.g.ontimeout=ze(this.pa,this)):this.A=ku(this.pa,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(i){qh(this,i)}};function uT(t){return xs&&Tb()&&typeof t.timeout=="number"&&t.ontimeout!==void 0}function lT(t){return t.toLowerCase()=="content-type"}O.pa=function(){typeof yu!="undefined"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,We(this,"timeout"),this.abort(8))};function qh(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,Ag(t),Jo(t)}function Ag(t){t.D||(t.D=!0,We(t,"complete"),We(t,"error"))}O.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,We(this,"complete"),We(this,"abort"),Jo(this))};O.M=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Jo(this,!0)),Ne.Z.M.call(this)};O.Fa=function(){this.s||(this.F||this.v||this.l?kg(this):this.cb())};O.cb=function(){kg(this)};function kg(t){if(t.h&&typeof yu!="undefined"&&(!t.C[1]||zt(t)!=4||t.ba()!=2)){if(t.v&&zt(t)==4)ku(t.Fa,0,t);else if(We(t,"readystatechange"),zt(t)==4){t.h=!1;try{const a=t.ba();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var s;if(s=a===0){var r=String(t.H).match(mg)[1]||null;if(!r&&q.self&&q.self.location){var i=q.self.location.protocol;r=i.substr(0,i.length-1)}s=!aT.test(r?r.toLowerCase():"")}n=s}if(n)We(t,"complete"),We(t,"success");else{t.m=6;try{var o=2<zt(t)?t.g.statusText:""}catch{o=""}t.j=o+" ["+t.ba()+"]",Ag(t)}}finally{Jo(t)}}}}function Jo(t,e){if(t.g){Rg(t);const n=t.g,s=t.C[0]?ro:null;t.g=null,t.C=null,e||We(t,"ready");try{n.onreadystatechange=s}catch{}}}function Rg(t){t.g&&t.K&&(t.g.ontimeout=null),t.A&&(q.clearTimeout(t.A),t.A=null)}function zt(t){return t.g?t.g.readyState:0}O.ba=function(){try{return 2<zt(this)?this.g.status:-1}catch{return-1}};O.ga=function(){try{return this.g?this.g.responseText:""}catch{return""}};O.Qa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),oT(e)}};function Kh(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.J){case Cg:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}O.Da=function(){return this.m};O.La=function(){return typeof this.j=="string"?this.j:String(this.j)};function hT(t){let e="";return _u(t,function(n,s){e+=s,e+=":",e+=n,e+=`\r
`}),e}function Uu(t,e,n){e:{for(s in n){var s=!1;break e}s=!0}s||(n=hT(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):Ie(t,e,n))}function ir(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function Ng(t){this.za=0,this.l=[],this.h=new Ko,this.la=this.oa=this.F=this.W=this.g=this.sa=this.D=this.aa=this.o=this.P=this.s=null,this.Za=this.V=0,this.Xa=ir("failFast",!1,t),this.N=this.v=this.u=this.m=this.j=null,this.X=!0,this.I=this.ta=this.U=-1,this.Y=this.A=this.C=0,this.Pa=ir("baseRetryDelayMs",5e3,t),this.$a=ir("retryDelaySeedMs",1e4,t),this.Ya=ir("forwardChannelMaxRetries",2,t),this.ra=ir("forwardChannelRequestTimeoutMs",2e4,t),this.qa=t&&t.xmlHttpFactory||void 0,this.Ba=t&&t.Yb||!1,this.K=void 0,this.H=t&&t.supportsCrossDomainXhr||!1,this.J="",this.i=new wg(t&&t.concurrentRequestLimit),this.Ca=new sT,this.ja=t&&t.fastHandshake||!1,this.Ra=t&&t.Wb||!1,t&&t.Aa&&this.h.Aa(),t&&t.forceLongPolling&&(this.X=!1),this.$=!this.ja&&this.X&&t&&t.detectBufferingProxy||!1,this.ka=void 0,this.O=0,this.L=!1,this.B=null,this.Wa=!t||t.Xb!==!1}O=Ng.prototype;O.ma=8;O.G=1;function Fu(t){if(Dg(t),t.G==3){var e=t.V++,n=Zt(t.F);Ie(n,"SID",t.J),Ie(n,"RID",e),Ie(n,"TYPE","terminate"),pi(t,n),e=new li(t,t.h,e,void 0),e.K=2,e.v=Xo(Zt(n)),n=!1,q.navigator&&q.navigator.sendBeacon&&(n=q.navigator.sendBeacon(e.v.toString(),"")),!n&&q.Image&&(new Image().src=e.v,n=!0),n||(e.g=Vg(e.l,null),e.g.ea(e.v)),e.F=Date.now(),hi(e)}Ug(t)}O.hb=function(t){try{this.h.info("Origin Trials invoked: "+t)}catch{}};function Zo(t){t.g&&($u(t),t.g.cancel(),t.g=null)}function Dg(t){Zo(t),t.u&&(q.clearTimeout(t.u),t.u=null),ho(t),t.i.cancel(),t.m&&(typeof t.m=="number"&&q.clearTimeout(t.m),t.m=null)}function Pa(t,e){t.l.push(new tT(t.Za++,e)),t.G==3&&ea(t)}function ea(t){Eg(t.i)||t.m||(t.m=!0,Cu(t.Ha,t),t.C=0)}function fT(t,e){return Ig(t.i)>=t.i.j-(t.m?1:0)?!1:t.m?(t.l=e.D.concat(t.l),!0):t.G==1||t.G==2||t.C>=(t.Xa?0:t.Ya)?!1:(t.m=ci(ze(t.Ha,t,e),Lg(t,t.C)),t.C++,!0)}O.Ha=function(t){if(this.m)if(this.m=null,this.G==1){if(!t){this.V=Math.floor(1e5*Math.random()),t=this.V++;const r=new li(this,this.h,t,void 0);let i=this.s;if(this.P&&(i?(i=Kp(i),zp(i,this.P)):i=this.P),this.o===null&&(r.H=i),this.ja)e:{for(var e=0,n=0;n<this.l.length;n++){t:{var s=this.l[n];if("__data__"in s.g&&(s=s.g.__data__,typeof s=="string")){s=s.length;break t}s=void 0}if(s===void 0)break;if(e+=s,4096<e){e=n;break e}if(e===4096||n===this.l.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=Og(this,r,e),n=Zt(this.F),Ie(n,"RID",t),Ie(n,"CVER",22),this.D&&Ie(n,"X-HTTP-Session-Id",this.D),pi(this,n),this.o&&i&&Uu(n,this.o,i),Pu(this.i,r),this.Ra&&Ie(n,"TYPE","init"),this.ja?(Ie(n,"$req",e),Ie(n,"SID","null"),r.$=!0,Ic(r,n,null)):Ic(r,n,e),this.G=2}}else this.G==3&&(t?zh(this,t):this.l.length==0||Eg(this.i)||zh(this))};function zh(t,e){var n;e?n=e.m:n=t.V++;const s=Zt(t.F);Ie(s,"SID",t.J),Ie(s,"RID",n),Ie(s,"AID",t.U),pi(t,s),t.o&&t.s&&Uu(s,t.o,t.s),n=new li(t,t.h,n,t.C+1),t.o===null&&(n.H=t.s),e&&(t.l=e.D.concat(t.l)),e=Og(t,n,1e3),n.setTimeout(Math.round(.5*t.ra)+Math.round(.5*t.ra*Math.random())),Pu(t.i,n),Ic(n,s,e)}function pi(t,e){t.j&&Ou({},function(n,s){Ie(e,s,n)})}function Og(t,e,n){n=Math.min(t.l.length,n);var s=t.j?ze(t.j.Oa,t.j,t):null;e:{var r=t.l;let i=-1;for(;;){const o=["count="+n];i==-1?0<n?(i=r[0].h,o.push("ofs="+i)):i=0:o.push("ofs="+i);let a=!0;for(let c=0;c<n;c++){let u=r[c].h;const l=r[c].g;if(u-=i,0>u)i=Math.max(0,r[c].h-100),a=!1;else try{rT(l,o,"req"+u+"_")}catch{s&&s(l)}}if(a){s=o.join("&");break e}}}return t=t.l.splice(0,n),e.D=t,s}function xg(t){t.g||t.u||(t.Y=1,Cu(t.Ga,t),t.A=0)}function Vu(t){return t.g||t.u||3<=t.A?!1:(t.Y++,t.u=ci(ze(t.Ga,t),Lg(t,t.A)),t.A++,!0)}O.Ga=function(){if(this.u=null,Pg(this),this.$&&!(this.L||this.g==null||0>=this.O)){var t=2*this.O;this.h.info("BP detection timer enabled: "+t),this.B=ci(ze(this.bb,this),t)}};O.bb=function(){this.B&&(this.B=null,this.h.info("BP detection timeout reached."),this.h.info("Buffering proxy detected and switch to long-polling!"),this.N=!1,this.L=!0,rt(10),Zo(this),Pg(this))};function $u(t){t.B!=null&&(q.clearTimeout(t.B),t.B=null)}function Pg(t){t.g=new li(t,t.h,"rpc",t.Y),t.o===null&&(t.g.H=t.s),t.g.O=0;var e=Zt(t.oa);Ie(e,"RID","rpc"),Ie(e,"SID",t.J),Ie(e,"CI",t.N?"0":"1"),Ie(e,"AID",t.U),pi(t,e),Ie(e,"TYPE","xmlhttp"),t.o&&t.s&&Uu(e,t.o,t.s),t.K&&t.g.setTimeout(t.K);var n=t.g;t=t.la,n.K=1,n.v=Xo(Zt(e)),n.s=null,n.U=!0,fg(n,t)}O.ab=function(){this.v!=null&&(this.v=null,Zo(this),Vu(this),rt(19))};function ho(t){t.v!=null&&(q.clearTimeout(t.v),t.v=null)}function Mg(t,e){var n=null;if(t.g==e){ho(t),$u(t),t.g=null;var s=2}else if(Tc(t.i,e))n=e.D,bg(t.i,e),s=1;else return;if(t.I=e.N,t.G!=0){if(e.i)if(s==1){n=e.s?e.s.length:0,e=Date.now()-e.F;var r=t.C;s=zo(),We(s,new cg(s,n)),ea(t)}else xg(t);else if(r=e.o,r==3||r==0&&0<t.I||!(s==1&&fT(t,e)||s==2&&Vu(t)))switch(n&&0<n.length&&(e=t.i,e.i=e.i.concat(n)),r){case 1:Fn(t,5);break;case 4:Fn(t,10);break;case 3:Fn(t,6);break;default:Fn(t,2)}}}function Lg(t,e){let n=t.Pa+Math.floor(Math.random()*t.$a);return t.j||(n*=2),n*e}function Fn(t,e){if(t.h.info("Error code "+e),e==2){var n=null;t.j&&(n=null);var s=ze(t.jb,t);n||(n=new Xn("//www.google.com/images/cleardot.gif"),q.location&&q.location.protocol=="http"||co(n,"https"),Xo(n)),iT(n.toString(),s)}else rt(2);t.G=0,t.j&&t.j.va(e),Ug(t),Dg(t)}O.jb=function(t){t?(this.h.info("Successfully pinged google.com"),rt(2)):(this.h.info("Failed to ping google.com"),rt(1))};function Ug(t){t.G=0,t.I=-1,t.j&&((Tg(t.i).length!=0||t.l.length!=0)&&(t.i.i.length=0,vu(t.l),t.l.length=0),t.j.ua())}function Fg(t,e,n){let s=Wb(n);if(s.i!="")e&&uo(s,e+"."+s.i),lo(s,s.m);else{const r=q.location;s=Gb(r.protocol,e?e+"."+r.hostname:r.hostname,+r.port,n)}return t.aa&&_u(t.aa,function(r,i){Ie(s,i,r)}),e=t.D,n=t.sa,e&&n&&Ie(s,e,n),Ie(s,"VER",t.ma),pi(t,s),s}function Vg(t,e,n){if(e&&!t.H)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Ba&&!t.qa?new Ne(new fi({ib:!0})):new Ne(t.qa),e.L=t.H,e}function $g(){}O=$g.prototype;O.xa=function(){};O.wa=function(){};O.va=function(){};O.ua=function(){};O.Oa=function(){};function fo(){if(xs&&!(10<=Number(Sb)))throw Error("Environmental error: no available transport.")}fo.prototype.g=function(t,e){return new pt(t,e)};function pt(t,e){Be.call(this),this.g=new Ng(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.ya&&(t?t["X-WebChannel-Client-Profile"]=e.ya:t={"X-WebChannel-Client-Profile":e.ya}),this.g.P=t,(t=e&&e.httpHeadersOverwriteParam)&&!io(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!io(e)&&(this.g.D=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new Ys(this)}Qe(pt,Be);pt.prototype.m=function(){this.g.j=this.j,this.A&&(this.g.H=!0);var t=this.g,e=this.l,n=this.h||void 0;t.Wa&&(t.h.info("Origin Trials enabled."),Cu(ze(t.hb,t,e))),rt(0),t.W=e,t.aa=n||{},t.N=t.X,t.F=Fg(t,null,t.W),ea(t)};pt.prototype.close=function(){Fu(this.g)};pt.prototype.u=function(t){if(typeof t=="string"){var e={};e.__data__=t,Pa(this.g,e)}else this.v?(e={},e.__data__=Su(t),Pa(this.g,e)):Pa(this.g,t)};pt.prototype.M=function(){this.g.j=null,delete this.j,Fu(this.g),delete this.g,pt.Z.M.call(this)};function Bg(t){Nu.call(this);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Qe(Bg,Nu);function jg(){Du.call(this),this.status=1}Qe(jg,Du);function Ys(t){this.g=t}Qe(Ys,$g);Ys.prototype.xa=function(){We(this.g,"a")};Ys.prototype.wa=function(t){We(this.g,new Bg(t))};Ys.prototype.va=function(t){We(this.g,new jg)};Ys.prototype.ua=function(){We(this.g,"b")};fo.prototype.createWebChannel=fo.prototype.g;pt.prototype.send=pt.prototype.u;pt.prototype.open=pt.prototype.m;pt.prototype.close=pt.prototype.close;Wo.NO_ERROR=0;Wo.TIMEOUT=8;Wo.HTTP_ERROR=6;ug.COMPLETE="complete";lg.EventType=ui;ui.OPEN="a";ui.CLOSE="b";ui.ERROR="c";ui.MESSAGE="d";Be.prototype.listen=Be.prototype.N;Ne.prototype.listenOnce=Ne.prototype.O;Ne.prototype.getLastError=Ne.prototype.La;Ne.prototype.getLastErrorCode=Ne.prototype.Da;Ne.prototype.getStatus=Ne.prototype.ba;Ne.prototype.getResponseJson=Ne.prototype.Qa;Ne.prototype.getResponseText=Ne.prototype.ga;Ne.prototype.send=Ne.prototype.ea;var dT=function(){return new fo},pT=function(){return zo()},Ma=Wo,gT=ug,mT=ns,Wh={rb:0,ub:1,vb:2,Ob:3,Tb:4,Qb:5,Rb:6,Pb:7,Nb:8,Sb:9,PROXY:10,NOPROXY:11,Lb:12,Hb:13,Ib:14,Gb:15,Jb:16,Kb:17,nb:18,mb:19,ob:20},yT=fi,Ni=lg,vT=Ne;const Gh="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gi(t){if(t.code!==T.FAILED_PRECONDITION||t.message!==DT)throw t;U("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yh(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function Zs(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function qg(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kg(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function zg(t){const e=t.mapValue.fields.__previous_value__;return Kg(e)?zg(e):e}function Hr(t){const e=Cn(t.mapValue.fields.__local_write_time__.timestampValue);return new xe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ta(t){return t==null}function po(t){return t===0&&1/t==-1/0}function MT(t){return typeof t=="number"&&Number.isInteger(t)&&!po(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(e,n=null,s=[],r=[],i=null,o="F",a=null,c=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=s,this.filters=r,this.limit=i,this.limitType=o,this.startAt=a,this.endAt=c,this.lt=null,this.ft=null,this.startAt,this.endAt}}function WT(t,e,n,s,r,i,o,a){return new na(t,e,n,s,r,i,o,a)}function zu(t){return new na(t)}function GT(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function QT(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function XT(t){for(const e of t.filters)if(e.ht())return e.field;return null}function YT(t){return t.collectionGroup!==null}function Kr(t){const e=Q(t);if(e.lt===null){e.lt=[];const n=XT(e),s=QT(e);if(n!==null&&s===null)n.isKeyField()||e.lt.push(new Er(n)),e.lt.push(new Er(Ye.keyField(),"asc"));else{let r=!1;for(const i of e.explicitOrderBy)e.lt.push(i),i.field.isKeyField()&&(r=!0);if(!r){const i=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.lt.push(new Er(Ye.keyField(),i))}}}return e.lt}function Zn(t){const e=Q(t);if(!e.ft)if(e.limitType==="F")e.ft=nf(e.path,e.collectionGroup,Kr(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const i of Kr(e)){const o=i.dir==="desc"?"asc":"desc";n.push(new Er(i.field,o))}const s=e.endAt?new go(e.endAt.position,e.endAt.inclusive):null,r=e.startAt?new go(e.startAt.position,e.startAt.inclusive):null;e.ft=nf(e.path,e.collectionGroup,n,e.filters,e.limit,s,r)}return e.ft}function JT(t,e,n){return new na(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function sa(t,e){return Ku(Zn(t),Zn(e))&&t.limitType===e.limitType}function Qg(t){return`${qu(Zn(t))}|lt:${t.limitType}`}function kc(t){return`Query(target=${FT(Zn(t))}; limitType=${t.limitType})`}function Wu(t,e){return e.isFoundDocument()&&function(n,s){const r=s.key.path;return n.collectionGroup!==null?s.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(r):$.isDocumentKey(n.path)?n.path.isEqual(r):n.path.isImmediateParentOf(r)}(t,e)&&function(n,s){for(const r of n.explicitOrderBy)if(!r.field.isKeyField()&&s.data.field(r.field)===null)return!1;return!0}(t,e)&&function(n,s){for(const r of n.filters)if(!r.matches(s))return!1;return!0}(t,e)&&function(n,s){return!(n.startAt&&!function(r,i,o){const a=sf(r,i,o);return r.inclusive?a<=0:a<0}(n.startAt,Kr(n),s)||n.endAt&&!function(r,i,o){const a=sf(r,i,o);return r.inclusive?a>=0:a>0}(n.endAt,Kr(n),s))}(t,e)}function ZT(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Xg(t){return(e,n)=>{let s=!1;for(const r of Kr(t)){const i=eS(r,e,n);if(i!==0)return i;s=s||r.field.isKeyField()}return 0}}function eS(t,e,n){const s=t.field.isKeyField()?$.comparator(e.key,n.key):function(r,i,o){const a=i.data.field(r),c=o.data.field(r);return a!==null&&c!==null?Us(a,c):G()}(t.field,e,n);switch(t.dir){case"asc":return s;case"desc":return-1*s;default:return G()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yg(t,e){if(t.dt){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:po(e)?"-0":e}}function Jg(t){return{integerValue:""+t}}function tS(t,e){return MT(e)?Jg(e):Yg(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ra{constructor(){this._=void 0}}function nS(t,e,n){return t instanceof mo?function(s,r){const i={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return r&&(i.fields.__previous_value__=r),{mapValue:i}}(n,e):t instanceof zr?em(t,e):t instanceof Wr?tm(t,e):function(s,r){const i=Zg(s,r),o=of(i)+of(s._t);return Cc(i)&&Cc(s._t)?Jg(o):Yg(s.wt,o)}(t,e)}function sS(t,e,n){return t instanceof zr?em(t,e):t instanceof Wr?tm(t,e):n}function Zg(t,e){return t instanceof yo?Cc(n=e)||function(s){return!!s&&"doubleValue"in s}(n)?e:{integerValue:0}:null;var n}class mo extends ra{}class zr extends ra{constructor(e){super(),this.elements=e}}function em(t,e){const n=nm(e);for(const s of t.elements)n.some(r=>Bt(r,s))||n.push(s);return{arrayValue:{values:n}}}class Wr extends ra{constructor(e){super(),this.elements=e}}function tm(t,e){let n=nm(e);for(const s of t.elements)n=n.filter(r=>!Bt(r,s));return{arrayValue:{values:n}}}class yo extends ra{constructor(e,n){super(),this.wt=e,this._t=n}}function of(t){return Re(t.integerValue||t.doubleValue)}function nm(t){return Hu(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function rS(t,e){return t.field.isEqual(e.field)&&function(n,s){return n instanceof zr&&s instanceof zr||n instanceof Wr&&s instanceof Wr?Ps(n.elements,s.elements,Bt):n instanceof yo&&s instanceof yo?Bt(n._t,s._t):n instanceof mo&&s instanceof mo}(t.transform,e.transform)}class iS{constructor(e,n){this.version=e,this.transformResults=n}}class Gt{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new Gt}static exists(e){return new Gt(void 0,e)}static updateTime(e){return new Gt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Hi(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class ia{}function sm(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new im(t.key,Gt.none()):new yi(t.key,t.data,Gt.none());{const n=t.data,s=vt.empty();let r=new Pe(Ye.comparator);for(let i of e.fields)if(!r.has(i)){let o=n.field(i);o===null&&i.length>1&&(i=i.popLast(),o=n.field(i)),o===null?s.delete(i):s.set(i,o),r=r.add(i)}return new ss(t.key,s,new Ft(r.toArray()),Gt.none())}}function oS(t,e,n){t instanceof yi?function(s,r,i){const o=s.value.clone(),a=cf(s.fieldTransforms,r,i.transformResults);o.setAll(a),r.convertToFoundDocument(i.version,o).setHasCommittedMutations()}(t,e,n):t instanceof ss?function(s,r,i){if(!Hi(s.precondition,r))return void r.convertToUnknownDocument(i.version);const o=cf(s.fieldTransforms,r,i.transformResults),a=r.data;a.setAll(rm(s)),a.setAll(o),r.convertToFoundDocument(i.version,a).setHasCommittedMutations()}(t,e,n):function(s,r,i){r.convertToNoDocument(i.version).setHasCommittedMutations()}(0,e,n)}function Ir(t,e,n,s){return t instanceof yi?function(r,i,o,a){if(!Hi(r.precondition,i))return o;const c=r.value.clone(),u=uf(r.fieldTransforms,a,i);return c.setAll(u),i.convertToFoundDocument(i.version,c).setHasLocalMutations(),null}(t,e,n,s):t instanceof ss?function(r,i,o,a){if(!Hi(r.precondition,i))return o;const c=uf(r.fieldTransforms,a,i),u=i.data;return u.setAll(rm(r)),u.setAll(c),i.convertToFoundDocument(i.version,u).setHasLocalMutations(),o===null?null:o.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map(l=>l.field))}(t,e,n,s):function(r,i,o){return Hi(r.precondition,i)?(i.convertToNoDocument(i.version).setHasLocalMutations(),null):o}(t,e,n)}function aS(t,e){let n=null;for(const s of t.fieldTransforms){const r=e.data.field(s.field),i=Zg(s.transform,r||null);i!=null&&(n===null&&(n=vt.empty()),n.set(s.field,i))}return n||null}function af(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(n,s){return n===void 0&&s===void 0||!(!n||!s)&&Ps(n,s,(r,i)=>rS(r,i))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class yi extends ia{constructor(e,n,s,r=[]){super(),this.key=e,this.value=n,this.precondition=s,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class ss extends ia{constructor(e,n,s,r,i=[]){super(),this.key=e,this.data=n,this.fieldMask=s,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function rm(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const s=t.data.field(n);e.set(n,s)}}),e}function cf(t,e,n){const s=new Map;_e(t.length===n.length);for(let r=0;r<n.length;r++){const i=t[r],o=i.transform,a=e.data.field(i.field);s.set(i.field,sS(o,a,n[r]))}return s}function uf(t,e,n){const s=new Map;for(const r of t){const i=r.transform,o=n.data.field(r.field);s.set(r.field,nS(i,o,e))}return s}class im extends ia{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class cS extends ia{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(e,n){this.mapKeyFn=e,this.equalsFn=n,this.inner={},this.innerSize=0}get(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s!==void 0){for(const[r,i]of s)if(this.equalsFn(r,e))return i}}has(e){return this.get(e)!==void 0}set(e,n){const s=this.mapKeyFn(e),r=this.inner[s];if(r===void 0)return this.inner[s]=[[e,n]],void this.innerSize++;for(let i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return void(r[i]=[e,n]);r.push([e,n]),this.innerSize++}delete(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s===void 0)return!1;for(let r=0;r<s.length;r++)if(this.equalsFn(s[r][0],e))return s.length===1?delete this.inner[n]:s.splice(r,1),this.innerSize--,!0;return!1}forEach(e){Zs(this.inner,(n,s)=>{for(const[r,i]of s)e(r,i)})}isEmpty(){return qg(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hS=new Le($.comparator);function en(){return hS}const am=new Le($.comparator);function hr(...t){let e=am;for(const n of t)e=e.insert(n.key,n);return e}function cm(t){let e=am;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Vn(){return br()}function um(){return br()}function br(){return new er(t=>t.toString(),(t,e)=>t.isEqual(e))}const fS=new Le($.comparator),dS=new Pe($.comparator);function ne(...t){let e=dS;for(const n of t)e=e.add(n);return e}const pS=new Pe(ce);function lm(){return pS}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa{constructor(e,n,s,r,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n){const s=new Map;return s.set(e,vi.createSynthesizedTargetChangeForCurrentChange(e,n)),new oa(Z.min(),s,lm(),en(),ne())}}class vi{constructor(e,n,s,r,i){this.resumeToken=e,this.current=n,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n){return new vi(Ge.EMPTY_BYTE_STRING,n,ne(),ne(),ne())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mS=(()=>({asc:"ASCENDING",desc:"DESCENDING"}))(),yS=(()=>({"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"}))();class vS{constructor(e,n){this.databaseId=e,this.dt=n}}function vo(t,e){return t.dt?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function dm(t,e){return t.dt?e.toBase64():e.toUint8Array()}function _S(t,e){return vo(t,e.toTimestamp())}function Qt(t){return _e(!!t),Z.fromTimestamp(function(e){const n=Cn(e);return new xe(n.seconds,n.nanos)}(t))}function Gu(t,e){return function(n){return new Se(["projects",n.projectId,"databases",n.database])}(t).child("documents").child(e).canonicalString()}function pm(t){const e=Se.fromString(t);return _e(ym(e)),e}function Rc(t,e){return Gu(t.databaseId,e.path)}function La(t,e){const n=pm(e);if(n.get(1)!==t.databaseId.projectId)throw new B(T.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+t.databaseId.projectId);if(n.get(3)!==t.databaseId.database)throw new B(T.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+t.databaseId.database);return new $(gm(n))}function Nc(t,e){return Gu(t.databaseId,e)}function wS(t){const e=pm(t);return e.length===4?Se.emptyPath():gm(e)}function Dc(t){return new Se(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function gm(t){return _e(t.length>4&&t.get(4)==="documents"),t.popFirst(5)}function df(t,e,n){return{name:Rc(t,e),fields:n.value.mapValue.fields}}function ES(t,e){let n;if("targetChange"in e){e.targetChange;const s=function(c){return c==="NO_CHANGE"?0:c==="ADD"?1:c==="REMOVE"?2:c==="CURRENT"?3:c==="RESET"?4:G()}(e.targetChange.targetChangeType||"NO_CHANGE"),r=e.targetChange.targetIds||[],i=function(c,u){return c.dt?(_e(u===void 0||typeof u=="string"),Ge.fromBase64String(u||"")):(_e(u===void 0||u instanceof Uint8Array),Ge.fromUint8Array(u||new Uint8Array))}(t,e.targetChange.resumeToken),o=e.targetChange.cause,a=o&&function(c){const u=c.code===void 0?T.UNKNOWN:om(c.code);return new B(u,c.message||"")}(o);n=new fm(s,r,i,a||null)}else if("documentChange"in e){e.documentChange;const s=e.documentChange;s.document,s.document.name,s.document.updateTime;const r=La(t,s.document.name),i=Qt(s.document.updateTime),o=new vt({mapValue:{fields:s.document.fields}}),a=Ke.newFoundDocument(r,i,o),c=s.targetIds||[],u=s.removedTargetIds||[];n=new qi(c,u,a.key,a)}else if("documentDelete"in e){e.documentDelete;const s=e.documentDelete;s.document;const r=La(t,s.document),i=s.readTime?Qt(s.readTime):Z.min(),o=Ke.newNoDocument(r,i),a=s.removedTargetIds||[];n=new qi([],a,o.key,o)}else if("documentRemove"in e){e.documentRemove;const s=e.documentRemove;s.document;const r=La(t,s.document),i=s.removedTargetIds||[];n=new qi([],i,r,null)}else{if(!("filter"in e))return G();{e.filter;const s=e.filter;s.targetId;const r=s.count||0,i=new uS(r),o=s.targetId;n=new hm(o,i)}}return n}function IS(t,e){let n;if(e instanceof yi)n={update:df(t,e.key,e.value)};else if(e instanceof im)n={delete:Rc(t,e.key)};else if(e instanceof ss)n={update:df(t,e.key,e.data),updateMask:OS(e.fieldMask)};else{if(!(e instanceof cS))return G();n={verify:Rc(t,e.key)}}return e.fieldTransforms.length>0&&(n.updateTransforms=e.fieldTransforms.map(s=>function(r,i){const o=i.transform;if(o instanceof mo)return{fieldPath:i.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(o instanceof zr)return{fieldPath:i.field.canonicalString(),appendMissingElements:{values:o.elements}};if(o instanceof Wr)return{fieldPath:i.field.canonicalString(),removeAllFromArray:{values:o.elements}};if(o instanceof yo)return{fieldPath:i.field.canonicalString(),increment:o._t};throw G()}(0,s))),e.precondition.isNone||(n.currentDocument=function(s,r){return r.updateTime!==void 0?{updateTime:_S(s,r.updateTime)}:r.exists!==void 0?{exists:r.exists}:G()}(t,e.precondition)),n}function bS(t,e){return t&&t.length>0?(_e(e!==void 0),t.map(n=>function(s,r){let i=s.updateTime?Qt(s.updateTime):Qt(r);return i.isEqual(Z.min())&&(i=Qt(r)),new iS(i,s.transformResults||[])}(n,e))):[]}function TS(t,e){return{documents:[Nc(t,e.path)]}}function SS(t,e){const n={structuredQuery:{}},s=e.path;e.collectionGroup!==null?(n.parent=Nc(t,s),n.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(n.parent=Nc(t,s.popLast()),n.structuredQuery.from=[{collectionId:s.lastSegment()}]);const r=function(c){if(c.length===0)return;const u=c.map(l=>function(h){if(h.op==="=="){if(tf(h.value))return{unaryFilter:{field:hs(h.field),op:"IS_NAN"}};if(ef(h.value))return{unaryFilter:{field:hs(h.field),op:"IS_NULL"}}}else if(h.op==="!="){if(tf(h.value))return{unaryFilter:{field:hs(h.field),op:"IS_NOT_NAN"}};if(ef(h.value))return{unaryFilter:{field:hs(h.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:hs(h.field),op:RS(h.op),value:h.value}}}(l));return u.length===1?u[0]:{compositeFilter:{op:"AND",filters:u}}}(e.filters);r&&(n.structuredQuery.where=r);const i=function(c){if(c.length!==0)return c.map(u=>function(l){return{field:hs(l.field),direction:kS(l.dir)}}(u))}(e.orderBy);i&&(n.structuredQuery.orderBy=i);const o=function(c,u){return c.dt||ta(u)?u:{value:u}}(t,e.limit);var a;return o!==null&&(n.structuredQuery.limit=o),e.startAt&&(n.structuredQuery.startAt={before:(a=e.startAt).inclusive,values:a.position}),e.endAt&&(n.structuredQuery.endAt=function(c){return{before:!c.inclusive,values:c.position}}(e.endAt)),n}function CS(t){let e=wS(t.parent);const n=t.structuredQuery,s=n.from?n.from.length:0;let r=null;if(s>0){_e(s===1);const l=n.from[0];l.allDescendants?r=l.collectionId:e=e.child(l.collectionId)}let i=[];n.where&&(i=mm(n.where));let o=[];n.orderBy&&(o=n.orderBy.map(l=>function(h){return new Er(vs(h.field),function(f){switch(f){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(h.direction))}(l)));let a=null;n.limit&&(a=function(l){let h;return h=typeof l=="object"?l.value:l,ta(h)?null:h}(n.limit));let c=null;n.startAt&&(c=function(l){const h=!!l.before,f=l.values||[];return new go(f,h)}(n.startAt));let u=null;return n.endAt&&(u=function(l){const h=!l.before,f=l.values||[];return new go(f,h)}(n.endAt)),WT(e,r,o,i,a,"F",c,u)}function AS(t,e){const n=function(s,r){switch(r){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return G()}}(0,e.purpose);return n==null?null:{"goog-listen-tags":n}}function mm(t){return t?t.unaryFilter!==void 0?[DS(t)]:t.fieldFilter!==void 0?[NS(t)]:t.compositeFilter!==void 0?t.compositeFilter.filters.map(e=>mm(e)).reduce((e,n)=>e.concat(n)):G():[]}function kS(t){return mS[t]}function RS(t){return yS[t]}function hs(t){return{fieldPath:t.canonicalString()}}function vs(t){return Ye.fromServerFormat(t.fieldPath)}function NS(t){return ct.create(vs(t.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return G()}}(t.fieldFilter.op),t.fieldFilter.value)}function DS(t){switch(t.unaryFilter.op){case"IS_NAN":const e=vs(t.unaryFilter.field);return ct.create(e,"==",{doubleValue:NaN});case"IS_NULL":const n=vs(t.unaryFilter.field);return ct.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=vs(t.unaryFilter.field);return ct.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const r=vs(t.unaryFilter.field);return ct.create(r,"!=",{nullValue:"NULL_VALUE"});default:return G()}}function OS(t){const e=[];return t.fields.forEach(n=>e.push(n.canonicalString())),{fieldPaths:e}}function ym(t){return t.length>=4&&t.get(0)==="projects"&&t.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VS{constructor(){this.changes=new er(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,Ke.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?b.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pC{constructor(e,n,s,r,i){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.au=[],this.hu=new Map,this.lu=new Set,this.fu=[],this.du=i,this.du.Br(o=>{s.enqueueAndForget(async()=>{rs(this)&&(U("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=Q(a);c.lu.add(4),await _i(c),c._u.set("Unknown"),c.lu.delete(4),await ca(c)}(this))})}),this._u=new dC(s,r)}}async function ca(t){if(rs(t))for(const e of t.fu)await e(!0)}async function _i(t){for(const e of t.fu)await e(!1)}function Im(t,e){const n=Q(t);n.hu.has(e.targetId)||(n.hu.set(e.targetId,e),tl(n)?el(n):tr(n).Co()&&Zu(n,e))}function bm(t,e){const n=Q(t),s=tr(n);n.hu.delete(e),s.Co()&&Tm(n,e),n.hu.size===0&&(s.Co()?s.ko():rs(n)&&n._u.set("Unknown"))}function Zu(t,e){t.wu.Nt(e.targetId),tr(t).Qo(e)}function Tm(t,e){t.wu.Nt(e),tr(t).jo(e)}function el(t){t.wu=new gS({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),te:e=>t.hu.get(e)||null}),tr(t).start(),t._u.iu()}function tl(t){return rs(t)&&!tr(t).Do()&&t.hu.size>0}function rs(t){return Q(t).lu.size===0}function Sm(t){t.wu=void 0}async function gC(t){t.hu.forEach((e,n)=>{Zu(t,e)})}async function mC(t,e){Sm(t),tl(t)?(t._u.uu(e),el(t)):t._u.set("Unknown")}async function yC(t,e,n){if(t._u.set("Online"),e instanceof fm&&e.state===2&&e.cause)try{await async function(s,r){const i=r.cause;for(const o of r.targetIds)s.hu.has(o)&&(await s.remoteSyncer.rejectListen(o,i),s.hu.delete(o),s.wu.removeTarget(o))}(t,e)}catch(s){U("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),s),await _o(t,s)}else if(e instanceof qi?t.wu.Ut(e):e instanceof hm?t.wu.zt(e):t.wu.Gt(e),!n.isEqual(Z.min()))try{const s=await _m(t.localStore);n.compareTo(s)>=0&&await function(r,i){const o=r.wu.Yt(i);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const u=r.hu.get(c);u&&r.hu.set(c,u.withResumeToken(a.resumeToken,i))}}),o.targetMismatches.forEach(a=>{const c=r.hu.get(a);if(!c)return;r.hu.set(a,c.withResumeToken(Ge.EMPTY_BYTE_STRING,c.snapshotVersion)),Tm(r,a);const u=new qn(c.target,a,1,c.sequenceNumber);Zu(r,u)}),r.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(s){U("RemoteStore","Failed to raise snapshot:",s),await _o(t,s)}}async function _o(t,e,n){if(!mi(e))throw e;t.lu.add(1),await _i(t),t._u.set("Offline"),n||(n=()=>_m(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{U("RemoteStore","Retrying IndexedDB access"),await n(),t.lu.delete(1),await ca(t)})}function Cm(t,e){return e().catch(n=>_o(t,n,e))}async function ua(t){const e=Q(t),n=An(e);let s=e.au.length>0?e.au[e.au.length-1].batchId:-1;for(;vC(e);)try{const r=await nC(e.localStore,s);if(r===null){e.au.length===0&&n.ko();break}s=r.batchId,_C(e,r)}catch(r){await _o(e,r)}Am(e)&&km(e)}function vC(t){return rs(t)&&t.au.length<10}function _C(t,e){t.au.push(e);const n=An(t);n.Co()&&n.zo&&n.Ho(e.mutations)}function Am(t){return rs(t)&&!An(t).Do()&&t.au.length>0}function km(t){An(t).start()}async function wC(t){An(t).Xo()}async function EC(t){const e=An(t);for(const n of t.au)e.Ho(n.mutations)}async function IC(t,e,n){const s=t.au.shift(),r=Qu.from(s,e,n);await Cm(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),await ua(t)}async function bC(t,e){e&&An(t).zo&&await async function(n,s){if(r=s.code,lS(r)&&r!==T.ABORTED){const i=n.au.shift();An(n).No(),await Cm(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await ua(n)}var r}(t,e),Am(t)&&km(t)}async function yf(t,e){const n=Q(t);n.asyncQueue.verifyOperationInProgress(),U("RemoteStore","RemoteStore received new credentials");const s=rs(n);n.lu.add(3),await _i(n),s&&n._u.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.lu.delete(3),await ca(n)}async function TC(t,e){const n=Q(t);e?(n.lu.delete(2),await ca(n)):e||(n.lu.add(2),await _i(n),n._u.set("Unknown"))}function tr(t){return t.mu||(t.mu=function(e,n,s){const r=Q(e);return r.tu(),new lC(n,r.bo,r.authCredentials,r.appCheckCredentials,r.wt,s)}(t.datastore,t.asyncQueue,{zr:gC.bind(null,t),Jr:mC.bind(null,t),Go:yC.bind(null,t)}),t.fu.push(async e=>{e?(t.mu.No(),tl(t)?el(t):t._u.set("Unknown")):(await t.mu.stop(),Sm(t))})),t.mu}function An(t){return t.gu||(t.gu=function(e,n,s){const r=Q(e);return r.tu(),new hC(n,r.bo,r.authCredentials,r.appCheckCredentials,r.wt,s)}(t.datastore,t.asyncQueue,{zr:wC.bind(null,t),Jr:bC.bind(null,t),Yo:EC.bind(null,t),Jo:IC.bind(null,t)}),t.fu.push(async e=>{e?(t.gu.No(),await ua(t)):(await t.gu.stop(),t.au.length>0&&(U("RemoteStore",`Stopping write stream with ${t.au.length} pending writes`),t.au=[]))})),t.gu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cA=/^__.*__$/;class uA{constructor(e,n,s){this.data=e,this.fieldMask=n,this.fieldTransforms=s}toMutation(e,n){return this.fieldMask!==null?new ss(e,this.data,this.fieldMask,n,this.fieldTransforms):new yi(e,this.data,n,this.fieldTransforms)}}function $m(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw G()}}class hl{constructor(e,n,s,r,i,o){this.settings=e,this.databaseId=n,this.wt=s,this.ignoreUndefinedProperties=r,i===void 0&&this.Xc(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Zc(){return this.settings.Zc}ta(e){return new hl(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.wt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ea(e){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(e),r=this.ta({path:s,na:!1});return r.sa(e),r}ia(e){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(e),r=this.ta({path:s,na:!1});return r.Xc(),r}ra(e){return this.ta({path:void 0,na:!0})}oa(e){return Eo(e,this.settings.methodName,this.settings.ua||!1,this.path,this.settings.ca)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}Xc(){if(this.path)for(let e=0;e<this.path.length;e++)this.sa(this.path.get(e))}sa(e){if(e.length===0)throw this.oa("Document fields must not be empty");if($m(this.Zc)&&cA.test(e))throw this.oa('Document fields cannot begin and end with "__"')}}class lA{constructor(e,n,s){this.databaseId=e,this.ignoreUndefinedProperties=n,this.wt=s||aa(e)}aa(e,n,s,r=!1){return new hl({Zc:e,methodName:n,ca:s,path:Ye.emptyPath(),na:!1,ua:r},this.databaseId,this.wt,this.ignoreUndefinedProperties)}}function hA(t){const e=t._freezeSettings(),n=aa(t._databaseId);return new lA(t._databaseId,!!e.ignoreUndefinedProperties,n)}function fA(t,e,n,s,r,i={}){const o=t.aa(i.merge||i.mergeFields?2:0,e,n,r);qm("Data must be an object, but it was:",o,s);const a=jm(s,o);let c,u;if(i.merge)c=new Ft(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const l=[];for(const h of i.mergeFields){const f=dA(e,h,n);if(!o.contains(f))throw new B(T.INVALID_ARGUMENT,`Field '${f}' is specified in your field mask but missing from your input data.`);gA(l,f)||l.push(f)}c=new Ft(l),u=o.fieldTransforms.filter(h=>c.covers(h.field))}else c=null,u=o.fieldTransforms;return new uA(new vt(a),c,u)}function Bm(t,e){if(Hm(t=$t(t)))return qm("Unsupported field value:",e,t),jm(t,e);if(t instanceof Vm)return function(n,s){if(!$m(s.Zc))throw s.oa(`${n._methodName}() can only be used with update() and set()`);if(!s.path)throw s.oa(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(s);r&&s.fieldTransforms.push(r)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.na&&e.Zc!==4)throw e.oa("Nested arrays are not supported");return function(n,s){const r=[];let i=0;for(const o of n){let a=Bm(o,s.ra(i));a==null&&(a={nullValue:"NULL_VALUE"}),r.push(a),i++}return{arrayValue:{values:r}}}(t,e)}return function(n,s){if((n=$t(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return tS(s.wt,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=xe.fromDate(n);return{timestampValue:vo(s.wt,r)}}if(n instanceof xe){const r=new xe(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:vo(s.wt,r)}}if(n instanceof ll)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Bs)return{bytesValue:dm(s.wt,n._byteString)};if(n instanceof Et){const r=s.databaseId,i=n.firestore._databaseId;if(!i.isEqual(r))throw s.oa(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:Gu(n.firestore._databaseId||s.databaseId,n._key.path)}}throw s.oa(`Unsupported field value: ${ol(n)}`)}(t,e)}function jm(t,e){const n={};return qg(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Zs(t,(s,r)=>{const i=Bm(r,e.ea(s));i!=null&&(n[s]=i)}),{mapValue:{fields:n}}}function Hm(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof xe||t instanceof ll||t instanceof Bs||t instanceof Et||t instanceof Vm)}function qm(t,e,n){if(!Hm(n)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(n)){const s=ol(n);throw s==="an object"?e.oa(t+" a custom object"):e.oa(t+" "+s)}}function dA(t,e,n){if((e=$t(e))instanceof ul)return e._internalPath;if(typeof e=="string")return Km(t,e);throw Eo("Field path arguments must be of type string or ",t,!1,void 0,n)}const pA=new RegExp("[~\\*/\\[\\]]");function Km(t,e,n){if(e.search(pA)>=0)throw Eo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new ul(...e.split("."))._internalPath}catch{throw Eo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Eo(t,e,n,s,r){const i=s&&!s.isEmpty(),o=r!==void 0;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${s}`),o&&(c+=` in document ${r}`),c+=")"),new B(T.INVALID_ARGUMENT,a+t+c)}function gA(t,e){return t.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yA{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Gm extends zm{constructor(e,n,s,r,i,o){super(e,n,s,r,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new vA(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(Wm("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}}class vA extends Gm{data(e={}){return super.data(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wn(Fk,Vk,"app");const $k={apiKey:"AIzaSyCl0uq9NcTjSvcFUvf8pLkX3PubtlukP9A",authDomain:"feynman-s-pr.firebaseapp.com",projectId:"feynman-s-pr",storageBucket:"feynman-s-pr.appspot.com",messagingSenderId:"60527738925",appId:"1:60527738925:web:6cdbd10c5dd12ede40b8a4",measurementId:"G-GYJDZ09MPD"},Bk=c0($k),js=aA(Bk),jk=!0,Hk="serviceWorker"in navigator&&jk;Hk&&navigator.serviceWorker.register("/sw.js").then(()=>{console.log("Service Worker Registered!")});const dl=__(Xw),qk=K_({state:Pk,mutations:Mk,actions:Lk,getters:Uk});dl.use(Xm);dl.use(qk);dl.mount("#app");
