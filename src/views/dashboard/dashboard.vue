...
export default {
  ...
  methods: {
    ...
    addCommonData() {
      ...
      // console.log('getAuth().currentUser', getAuth().currentUser);
      // const userUid = getAuth().currentUser.uid;
      setDoc(doc(db, "common", "Routines"), {
        'Morning Routine' : [
          'Rise, Rinse & Meditate',
          'Plan the Day\'s Task & Take Resolution of the Day',
          'Read on something unrelated to day to day work.',
          'Breakfast'
        ],
        "Evening Routine": [
          'Put things in their places',
          'Music, Diversion, Conversations',
