<template>
  <div class="addnewactivity wrapper">
...
export default {
  ...
  created(){
    this.activities[0] = this.currentRoutine.routineName;
    console.log('2222222222', this.currentRoutine);
  },
  computed: {
    ...mapState([
      'currentActivity',
  ...
  methods: {
    ...
    add() {
      ...
      this.appUserDataLocal.data[this.currentRoutineIndex].activities.push({activityName: this.newSuggestion, suggestions: []})
...
<style src="./addnewactivity.scss" lang="scss" scoped>
</style>